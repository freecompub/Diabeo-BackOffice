...
| [US-2660](../UserStory/insulinotherapie-edition/US-2660-application-groupee-dose-basale-stylo.md) | **Application groupée** de la dose basale **stylo** (MDI) à l'acceptation médecin (écriture `dailyDose`/`morningDose`/`eveningDose`, compare-and-swap + fail-closed) | back/iOS | 2659 | M | 🔴 **À FAIRE** — follow-up US-2659 (retire `styloBasalApplyNotSupported`). **Priorité HAUTE** : sans ça, une proposition basale stylo acceptée n'écrit rien (ajustement manuel médecin). |
