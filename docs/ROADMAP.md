...
| [US-2661](../UserStory/insulinotherapie-edition/US-2661-flag-predinner-dedie-lien-proposition.md) | Flag de revue **dédié « pré-dîner »** (basale stylo matin, enum+i18n FR/EN/AR) + lien flag Somogyi ↔ proposition à la revue | back/i18n/front | 2659 | S | 🟡 **À FAIRE** — follow-up US-2659 (lisibilité/traçabilité revue ; le split réutilise aujourd'hui `nocturnalHypoHighFasting`, libellé impropre). |
