...
| [US-2662](../UserStory/insulinotherapie-edition/US-2662-affinements-titration-basale-mdi.md) | Affinements titration basale MDI (groupé) : câblage `MDI_BASAL_WARN_U`, cooldown **dégludec 96 h** (V2, dépend molécule), refacto DRY générateur | back | 2659 | S | 🟢 **À FAIRE** — follow-up US-2659 (dette technique + affinement PK non bloquants). |
