...
|----|-------|-----------|-----------|--------|--------|
| US-2645 | **EPIC** — Édition insulinothérapie multi-mode (fiche + self-service, propose→valide) | front/back/migration | — | XL | 🟡 EN COURS — 2646→2652 livrés ; **auto-application retirée** (2026-07-10, ADR #28, #714 — toute édition patient = proposition médecin) ; reste la **dé-escalade active** multi-levier (2653) + reliquats (flag mode-c `observance`, activation cron prod) |
