...
| US-2076-UI | Messagerie inbox pro (2-column threads + viewer, badge sidebar, polling 60s, read receipts, optimistic UI, FCM consume) — livré en 5 itérations PR #440 (foundation) + #441 (thread list) + #443 (viewer + composer) + #444 (new thread modal + FCM) + #447 (polish + E2E) | 13 | [#429](https://github.com/freecompub/Diabeo-BackOffice/issues/429) | [docs](../UserStory/pro-user-stories/08-messagerie-notifs/US-2076-UI-messagerie-inbox-pro.md) | V1.5 | ✅ DONE |
