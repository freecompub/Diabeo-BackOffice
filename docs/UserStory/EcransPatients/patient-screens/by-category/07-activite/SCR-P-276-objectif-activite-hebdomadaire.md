# SCR-P-276 — Objectif activité hebdomadaire

> 🟡 Priorité **V2** · 📄 Type **PAGE** · Catégorie **07-Activite** · 📱🖥️ Toutes plateformes
...
| **Nom** | Objectif activité hebdomadaire |
| **Type** | PAGE |
| **Priorité** | **V2** |
...
Goal-setting + progression semaine en cours
...
### Composants
```
ActivityGoalSetter, ProgressTracker
```
