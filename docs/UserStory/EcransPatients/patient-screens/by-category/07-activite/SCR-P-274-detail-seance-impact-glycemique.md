# SCR-P-274 — Détail séance + impact glycémique

> 🔵 Priorité **V1** · 💬 Type **MODAL** · Catégorie **07-Activite** · 📱🖥️ Toutes plateformes
...
| **Nom** | Détail séance + impact glycémique |
| **Type** | MODAL |
| **Priorité** | **V1** |
...
Détails séance, glycémies avant/pendant/après, recommandations
