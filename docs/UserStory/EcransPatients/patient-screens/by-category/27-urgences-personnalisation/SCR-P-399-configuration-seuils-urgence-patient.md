# SCR-P-399 — Configuration seuils urgence patient

> 🟢 Priorité **MVP** · 📄 Type **PAGE** · Catégorie **27-Urgences-Personnalisation** · 📱🖥️ Toutes plateformes
...
Cibles + seuils alertes hypo/hyper/cétones — validés médecin
...
- **Langage** : Swift 5.9+
- **Frameworks** : `SwiftUI`, `Combine`, `CoreBluetooth`, `UserNotifications`, `CoreLocation`
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, `Nordic BLE Library`, `Firebase Cloud Messaging (FCM)`, `FusedLocationProviderClient`
...
- Pairing Bluetooth — Web Bluetooth API limitée Chrome/Edge, pas Safari/Firefox
- Pas d'appel téléphonique direct — lien `tel:` uniquement

### Stratégies de fallback
- Lecture seule des données ingérées par l'app mobile
