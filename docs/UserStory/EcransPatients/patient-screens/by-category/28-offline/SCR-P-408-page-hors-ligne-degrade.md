# SCR-P-408 — Page hors-ligne (dégradé)

> 🟢 Priorité **MVP** · 📄 Type **PAGE** · Catégorie **28-Offline** · 📱🖥️ Toutes plateformes
...
|---|---|
| **ID** | `SCR-P-408` |
| **Catégorie** | 28-Offline |
| **Nom** | Page hors-ligne (dégradé) |
| **Type** | PAGE |
| **Priorité** | **MVP** |
...
Message clair, fonctions vitales accessibles, attente reconnexion
...
### APIs web utilisées
- Service Worker + IndexedDB (Web Crypto API)
