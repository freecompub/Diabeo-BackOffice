# SCR-P-407 — Indicateur état réseau (banner)

> 🟢 Priorité **MVP** · 🧩 Type **COMPONENT** · Catégorie **28-Offline** · 📱🖥️ Toutes plateformes
...
| **Nom** | Indicateur état réseau (banner) |
| **Type** | COMPONENT |
| **Priorité** | **MVP** |
...
Bandeau non bloquant, mode dégradé visuel
