# SCR-P-409 — File de synchronisation (drawer)

> 🔵 Priorité **V1** · 📋 Type **DRAWER** · Catégorie **28-Offline** · 📱🖥️ Toutes plateformes
...
| **Nom** | File de synchronisation (drawer) |
| **Type** | DRAWER |
| **Priorité** | **V1** |
...
Liste opérations en attente, retry manuel, info dernière sync OK
