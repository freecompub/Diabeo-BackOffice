# SCR-P-416 — FAB central (Floating Action Button)
...
| **ID** | `SCR-P-416` |
| **Catégorie** | 30-Layout |
| **Nom** | FAB central (Floating Action Button) |
| **Type** | COMPONENT |
| **Priorité** | **MVP** |
...
FAB principal au centre du bottom nav, ouvre menu rapide actions fréquentes
