# SCR-P-414 — 🍎 iOS — Layout principal authentifié

> 🟢 Priorité **MVP** · 🏗️ Type **LAYOUT** · Catégorie **30-Layout** · 📱🖥️ Toutes plateformes
...
| **Différences plateforme matérielles** | ✅ OUI — Bottom nav iOS (TabView) ≠ BottomNavigationView Android ≠ web header |
...
Bottom nav (Home / Glycémie / Journal / Profil) + FAB central
...
> **Bottom nav iOS (TabView) ≠ BottomNavigationView Android ≠ web header**
...
### Composants
```
AppShell, BottomNav, Fab
```


### 🔗 Voir aussi (autres plateformes)

- [`SCR-P-414-android`](./SCR-P-414-layout-principal-authentifie-android.md) — version Android
- [`SCR-P-414-web`](./SCR-P-414-layout-principal-authentifie-web.md) — version Web
---
