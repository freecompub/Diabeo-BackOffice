# SCR-P-351 — Configuration niveaux de partage

> 🔵 Priorité **V1** · 💬 Type **MODAL** · Catégorie **19-Aidants** · 📱🖥️ Toutes plateformes
...
| **Nom** | Configuration niveaux de partage |
| **Type** | MODAL |
| **Priorité** | **V1** |
...
Granulaire : glycémie / repas / urgences / tout. Toggle par catégorie.
