# SCR-P-349 — Liste aidants déclarés (vue patient)

> 🔵 Priorité **V1** · 📄 Type **PAGE** · Catégorie **19-Aidants** · 📱🖥️ Toutes plateformes
...
|---|---|
| **ID** | `SCR-P-349` |
| **Catégorie** | 19-Aidants |
| **Nom** | Liste aidants déclarés (vue patient) |
| **Type** | PAGE |
| **Priorité** | **V1** |
...
Liste personnes ayant accès, niveau de partage, révocation possible
