# SCR-P-317 — Demande renouvellement ordonnance

> 🔵 Priorité **V1** · 💬 Type **MODAL** · Catégorie **13-Documents** · 📱🖥️ Toutes plateformes
...
| **Nom** | Demande renouvellement ordonnance |
| **Type** | MODAL |
| **Priorité** | **V1** |
...
### Vient de (parents)
Liste documents / Détail ordonnance
...
Sélection ordonnance à renouveler, message au médecin, attente validation
