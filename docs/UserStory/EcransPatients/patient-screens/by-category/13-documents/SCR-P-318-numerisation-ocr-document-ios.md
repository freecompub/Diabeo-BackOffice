# SCR-P-318 — 🍎 iOS — Numérisation OCR document

> 🟡 Priorité **V2** · 📄 Type **PAGE** · Catégorie **13-Documents** · 📱 Mobile (iOS + Android)
...
|---|---|
| **ID** | `SCR-P-318` |
| **Catégorie** | 13-Documents |
| **Nom** | Numérisation OCR document |
| **Type** | PAGE |
| **Priorité** | **V2** |
| **Plateformes cibles** | 📱 Mobile (iOS + Android) |
| **Différences plateforme matérielles** | ✅ OUI — Caméra + OCR — Vision iOS / ML Kit Android / non disponible web |
...
Capture photo + OCR, indexation full-text
...
> **Caméra + OCR — Vision iOS / ML Kit Android / non disponible web**
...
- [`SCR-P-318-android`](./SCR-P-318-numerisation-ocr-document-android.md) — version Android
---
