# SCR-P-316 — Réception ordonnance numérique (V4)

> 🔴 Priorité **V4** · 📄 Type **PAGE** · Catégorie **13-Documents** · 📱🖥️ Toutes plateformes
...
Ordonnance électronique signée, envoi pharmacie via QR/2D-Doc
...
### Composants
```
PrescriptionViewer, QrCodeBlock
```
...
- Scan code-barres — `BarcodeDetector` API non supportée Safari/Firefox
