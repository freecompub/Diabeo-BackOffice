# SCR-P-314 — Liste documents

> 🔵 Priorité **V1** · 📄 Type **PAGE** · Catégorie **13-Documents** · 📱🖥️ Toutes plateformes
...
### Vient de (parents)
Tab profil / Tab documents

### Mène vers (enfants)
Détail document, Upload
...
Liste catégorisée : ordonnances, examens, CR, vaccinations
...
### Composants
```
DocumentsList, DocCard, CategoryFilter
```
