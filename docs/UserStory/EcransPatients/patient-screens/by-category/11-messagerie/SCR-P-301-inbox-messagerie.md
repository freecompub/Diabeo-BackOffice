...
### Vient de (parents)
Tab messagerie / Notif push

### Mène vers (enfants)
`SCR-P-302` — Thread détail
...
Liste threads avec aperçu dernier message, indicateur non lu, recherche
