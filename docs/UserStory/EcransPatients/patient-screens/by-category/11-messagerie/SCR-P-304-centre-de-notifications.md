# SCR-P-304 — Centre de notifications

> 🔵 Priorité **V1** · 📄 Type **PAGE** · Catégorie **11-Messagerie** · 📱🖥️ Toutes plateformes
...
Liste chronologique notifications, filtres (urgences, messages, système)
...
### Composants
```
NotificationsCenter, NotificationItem
```
