# SCR-P-372 — Modification consentements

> 🟢 Priorité **MVP** · 💬 Type **MODAL** · Catégorie **24-Rgpd** · 📱🖥️ Toutes plateformes
...
| **ID** | `SCR-P-372` |
| **Catégorie** | 24-Rgpd |
| **Nom** | Modification consentements |
| **Type** | MODAL |
| **Priorité** | **MVP** |
...
Granulaire par finalité, audit lourd
