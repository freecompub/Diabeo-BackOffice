# SCR-P-344 — Gestion multi-aidants
...
Liste aidants (parent 2, école, nounou) avec niveaux droits
...
### Composants
```
AidantsManagement, RightsMatrix
```
