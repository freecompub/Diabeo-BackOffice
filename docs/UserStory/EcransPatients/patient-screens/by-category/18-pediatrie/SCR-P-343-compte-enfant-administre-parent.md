# SCR-P-343 — Compte enfant administré parent

> 🔵 Priorité **V1** · 📄 Type **PAGE** · Catégorie **18-Pediatrie** · 📱🖥️ Toutes plateformes
...
Liste enfants gérés, ajouter un nouveau, switcher de profil
...
### Composants
```
PediatricChildrenList, ProfileSwitcher
```
