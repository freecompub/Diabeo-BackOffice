# SCR-P-222 — Sessions actives & révocation

> 🔵 Priorité **V1** · 📄 Type **PAGE** · Catégorie **02-Auth** · 📱🖥️ Toutes plateformes
...
| **ID** | `SCR-P-222` |
| **Catégorie** | 02-Auth |
| **Nom** | Sessions actives & révocation |
| **Type** | PAGE |
| **Priorité** | **V1** |
...
Liste appareils connectés, dernière activité, bouton 'Déconnecter cet appareil' / 'Tout déconnecter'
