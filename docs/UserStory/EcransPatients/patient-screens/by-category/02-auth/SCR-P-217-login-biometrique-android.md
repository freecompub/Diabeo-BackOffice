# SCR-P-217 — 🤖 Android — Login biométrique

> 🟢 Priorité **MVP** · 💬 Type **MODAL** · Catégorie **02-Auth** · 📱 Mobile (iOS + Android)
...
| **ID** | `SCR-P-217` |
| **Catégorie** | 02-Auth |
| **Nom** | Login biométrique |
| **Type** | MODAL |
| **Priorité** | **MVP** |
| **Plateformes cibles** | 📱 Mobile (iOS + Android) |
| **Différences plateforme matérielles** | ✅ OUI — iOS LocalAuthentication / Android BiometricPrompt / WebAuthn — fondamentalement différents |
...
Prompt système Face ID / Touch ID / BiometricPrompt. Fallback PIN si refus.
...
> **iOS LocalAuthentication / Android BiometricPrompt / WebAuthn — fondamentalement différents**
...
- [`SCR-P-217-ios`](./SCR-P-217-login-biometrique-ios.md) — version iOS
---
