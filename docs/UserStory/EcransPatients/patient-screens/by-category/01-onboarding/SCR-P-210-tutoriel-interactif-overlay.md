# SCR-P-210 — Tutoriel interactif (overlay)

> 🔵 Priorité **V1** · 💬 Type **MODAL** · Catégorie **01-Onboarding** · 📱🖥️ Toutes plateformes
...
| **Nom** | Tutoriel interactif (overlay) |
| **Type** | MODAL |
| **Priorité** | **V1** |
...
Overlay tooltips successifs guidant la 1ère utilisation, animations Lottie
...
### Composants
```
InteractiveTour, TooltipStep, Lottie
```
