# SCR-P-215 — Onboarding aidant/parent

> 🟡 Priorité **V2** · 📄 Type **PAGE** · Catégorie **01-Onboarding** · 📱🖥️ Toutes plateformes
...
Workflow différent : qui je suis, qui j'aide, niveau de droits demandés
...
### Composants
```
AidantOnboarding, RelationshipPicker
```
