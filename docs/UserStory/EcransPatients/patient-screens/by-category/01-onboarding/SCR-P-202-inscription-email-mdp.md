# SCR-P-202 — Inscription email/mdp
...
### Mène vers (enfants)
`SCR-P-204` — Vérification email, Wizard profil
...
Champs email + mdp + confirmation, indicateur force mdp, acceptation CGU lien
...
### Composants
```
SignupForm, PasswordStrength, EmailField
```
