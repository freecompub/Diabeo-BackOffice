# SCR-P-201 — Choix méthode (créer / invitation)
...
### Mène vers (enfants)
Inscription, Saisie code médecin
...
2 boutons clairs : 'Créer un compte' (autonome) ou 'J'ai un code médecin' (workflow privilégié)
