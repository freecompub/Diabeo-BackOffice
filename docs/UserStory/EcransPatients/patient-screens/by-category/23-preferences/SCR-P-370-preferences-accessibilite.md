# SCR-P-370 — Préférences accessibilité

> 🔵 Priorité **V1** · 📄 Type **PAGE** · Catégorie **23-Preferences** · 📱🖥️ Toutes plateformes
...
Taille texte (Dynamic Type), contraste, daltonisme, lecteur d'écran
