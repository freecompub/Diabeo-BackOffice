# SCR-P-325 — Tableau de bord journalier ⭐

> 🟢 Priorité **MVP** · 📄 Type **PAGE** · Catégorie **15-Suivi** · 📱🖥️ Toutes plateformes
...
| **ID** | `SCR-P-325` |
| **Catégorie** | 15-Suivi |
| **Nom** | Tableau de bord journalier ⭐ |
| **Type** | PAGE |
| **Priorité** | **MVP** |
...
Hub central de l'app : glycémie live, prochain repas, dernier bolus, raccourcis FAB
...
### Composants
```
DashboardLayout, GlucoseLiveCard, NextMealCard, QuickActions, EmergencyBanner
```
