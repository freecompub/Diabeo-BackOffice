# SCR-P-326 — Définition objectifs personnels

> 🔵 Priorité **V1** · 📄 Type **PAGE** · Catégorie **15-Suivi** · 📱🖥️ Toutes plateformes
...
| **ID** | `SCR-P-326` |
| **Catégorie** | 15-Suivi |
| **Nom** | Définition objectifs personnels |
| **Type** | PAGE |
| **Priorité** | **V1** |
...
HbA1c cible, TIR cible, poids, activité hebdo
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, `Nordic BLE Library`, `Health Connect (Android 14+)`
