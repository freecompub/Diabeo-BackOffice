# SCR-P-329 — Streaks / Badges progression

> 🟡 Priorité **V2** · 📄 Type **PAGE** · Catégorie **15-Suivi** · 📱🖥️ Toutes plateformes
...
| **ID** | `SCR-P-329` |
| **Catégorie** | 15-Suivi |
| **Nom** | Streaks / Badges progression |
| **Type** | PAGE |
| **Priorité** | **V2** |
...
Reconnaissance non-pression : jours consécutifs saisies, paliers atteints
