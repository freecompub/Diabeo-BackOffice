# SCR-P-411 — 🍎 iOS — Mode mains libres pendant hypo
...
- **Langage** : Swift 5.9+
- **Frameworks** : `SwiftUI`, `Combine`, `UserNotifications`, `Speech + AVAudioEngine + App Intents`
...
- [`SCR-P-411-android`](./SCR-P-411-mode-mains-libres-pendant-hypo-android.md) — version Android
---
