# SCR-P-413 — Préférences accessibilité étendues

> 🟡 Priorité **V2** · 📄 Type **PAGE** · Catégorie **29-Accessibilite** · 📱🖥️ Toutes plateformes
...
Sous-titres vidéos, audio-description, navigation vocale complète
...
- **Langage** : Swift 5.9+
- **Frameworks** : `SwiftUI`, `Combine`, `Speech + AVAudioEngine + App Intents`
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, `SpeechRecognizer + App Shortcuts`
