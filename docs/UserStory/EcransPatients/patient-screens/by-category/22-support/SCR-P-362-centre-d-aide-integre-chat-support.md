# SCR-P-362 — Centre d'aide intégré (chat support)

> 🔵 Priorité **V1** · 📄 Type **PAGE** · Catégorie **22-Support** · 📱🖥️ Toutes plateformes
...
| **Nom** | Centre d'aide intégré (chat support) |
| **Type** | PAGE |
| **Priorité** | **V1** |
...
Chat support technique, intégration Crisp / Intercom
