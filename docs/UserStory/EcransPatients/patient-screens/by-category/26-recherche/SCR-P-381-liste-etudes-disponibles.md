# SCR-P-381 — Liste études disponibles

> 🟠 Priorité **V3** · 📄 Type **PAGE** · Catégorie **26-Recherche** · 📱🖥️ Toutes plateformes
...
|---|---|
| **ID** | `SCR-P-381` |
| **Catégorie** | 26-Recherche |
| **Nom** | Liste études disponibles |
| **Type** | PAGE |
| **Priorité** | **V3** |
...
Études cliniques ouvertes auxquelles le patient peut participer
