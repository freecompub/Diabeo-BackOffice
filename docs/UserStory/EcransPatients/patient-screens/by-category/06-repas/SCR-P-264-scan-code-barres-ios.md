# SCR-P-264 — 🍎 iOS — Scan code-barres

> 🔵 Priorité **V1** · 📄 Type **PAGE** · Catégorie **06-Repas** · 📱 Mobile (iOS + Android)
...
| **ID** | `SCR-P-264` |
| **Catégorie** | 06-Repas |
| **Nom** | Scan code-barres |
| **Type** | PAGE |
| **Priorité** | **V1** |
| **Plateformes cibles** | 📱 Mobile (iOS + Android) |
| **Différences plateforme matérielles** | ✅ OUI — Caméra fondamentalement différente : Vision iOS / ML Kit Android / BarcodeDetector API web (limitée) |
| **Story points (par plateforme)** | 8 |
| **Route** | `/meals/barcode-scan` |
...
Caméra fullscreen, viseur, retour vibration sur succès
...
> **Caméra fondamentalement différente : Vision iOS / ML Kit Android / BarcodeDetector API web (limitée)**
...
### Composants
```
BarcodeScanner, CameraView
```


### 🔗 Voir aussi (autres plateformes)

- [`SCR-P-264-android`](./SCR-P-264-scan-code-barres-android.md) — version Android
---
