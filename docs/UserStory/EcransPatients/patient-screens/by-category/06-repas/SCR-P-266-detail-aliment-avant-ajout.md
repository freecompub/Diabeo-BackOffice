# SCR-P-266 — Détail aliment (avant ajout)

> 🔵 Priorité **V1** · 💬 Type **MODAL** · Catégorie **06-Repas** · 📱🖥️ Toutes plateformes
...
| **ID** | `SCR-P-266` |
| **Catégorie** | 06-Repas |
| **Nom** | Détail aliment (avant ajout) |
| **Type** | MODAL |
| **Priorité** | **V1** |
...
Infos nutritionnelles, choix portion (grammes/portions/UM), photo
