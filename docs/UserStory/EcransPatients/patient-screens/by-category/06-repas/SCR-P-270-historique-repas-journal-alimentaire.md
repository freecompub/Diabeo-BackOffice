# SCR-P-270 — Historique repas / Journal alimentaire

> 🔵 Priorité **V1** · 📄 Type **PAGE** · Catégorie **06-Repas** · 📱🖥️ Toutes plateformes
...
| **ID** | `SCR-P-270` |
| **Catégorie** | 06-Repas |
| **Nom** | Historique repas / Journal alimentaire |
| **Type** | PAGE |
| **Priorité** | **V1** |
...
Timeline repas, photos miniatures, glycémie pré/post-prandiale visible
