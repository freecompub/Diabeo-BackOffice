# SCR-P-263 — Recherche aliments (bibliothèque)
...
| **ID** | `SCR-P-263` |
| **Catégorie** | 06-Repas |
| **Nom** | Recherche aliments (bibliothèque) |
| **Type** | PAGE |
| **Priorité** | **V1** |
...
Search bar, filtres (catégorie, marque), résultats CIQUAL/OFF
