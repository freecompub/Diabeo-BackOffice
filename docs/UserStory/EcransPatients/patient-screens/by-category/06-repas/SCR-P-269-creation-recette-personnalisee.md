# SCR-P-269 — Création recette personnalisée

> 🟡 Priorité **V2** · 📄 Type **PAGE** · Catégorie **06-Repas** · 📱🖥️ Toutes plateformes
...
Composition d'une recette maison (multi-ingrédients), partage cabinet
