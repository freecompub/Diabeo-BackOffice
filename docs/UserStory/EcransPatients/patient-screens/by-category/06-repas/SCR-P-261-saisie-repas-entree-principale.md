# SCR-P-261 — Saisie repas (entrée principale)

> 🟢 Priorité **MVP** · 📄 Type **PAGE** · Catégorie **06-Repas** · 📱🖥️ Toutes plateformes
...
| **ID** | `SCR-P-261` |
| **Catégorie** | 06-Repas |
| **Nom** | Saisie repas (entrée principale) |
| **Type** | PAGE |
| **Priorité** | **MVP** |
...
### Vient de (parents)
Dashboard FAB / Tab journal

### Mène vers (enfants)
Saisie texte / Recherche / Scan / Photo / Calcul bolus
...
Hub central avec 4 options : texte libre, recherche aliments, scan code-barres, photo IA
