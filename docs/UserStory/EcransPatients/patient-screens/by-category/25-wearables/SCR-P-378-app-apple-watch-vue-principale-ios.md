# SCR-P-378 — 🍎 iOS — App Apple Watch (vue principale)

> 🟡 Priorité **V2** · 📄 Type **PAGE** · Catégorie **25-Wearables** · 🍎 iOS uniquement
...
|---|---|
| **ID** | `SCR-P-378` |
| **Catégorie** | 25-Wearables |
| **Nom** | App Apple Watch (vue principale) |
| **Type** | PAGE |
| **Priorité** | **V2** |
...
Glycémie + tendance + bouton bolus rapide + saisie événement
...
> **Spécifique iOS WatchKit, pas de variante**
...
- **Langage** : Swift 5.9+
- **Frameworks** : `SwiftUI`, `Combine`, `WatchKit + watchOS app companion`
