# SCR-P-380 — 🤖 Android — App Wear OS (vue principale)

> 🟡 Priorité **V2** · 📄 Type **PAGE** · Catégorie **25-Wearables** · 🤖 Android uniquement
...
| **Nom** | App Wear OS (vue principale) |
| **Type** | PAGE |
| **Priorité** | **V2** |
| **Plateformes cibles** | 🤖 Android uniquement |
...
Équivalent Wear OS, design Material
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, `Wear OS Compose`
