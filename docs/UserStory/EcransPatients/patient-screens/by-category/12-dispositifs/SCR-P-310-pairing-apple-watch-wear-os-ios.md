# SCR-P-310 — 🍎 iOS — Pairing Apple Watch / Wear OS

> 🔵 Priorité **V1** · 🧙 Type **WIZARD_STEP** · Catégorie **12-Dispositifs** · 📱 Mobile (iOS + Android)
...
| **Nom** | Pairing Apple Watch / Wear OS |
| **Type** | WIZARD_STEP |
| **Priorité** | **V1** |
| **Plateformes cibles** | 📱 Mobile (iOS + Android) |
| **Différences plateforme matérielles** | ✅ OUI — Apple Watch (WatchKit) ≠ Wear OS (Wear OS) — apps companion différentes |
| **Story points (par plateforme)** | 5 |
| **Route** | `/devices/watch-pairing` |
...
Pairing watch via app companion native
...
> **Apple Watch (WatchKit) ≠ Wear OS (Wear OS) — apps companion différentes**
...
- [`SCR-P-310-android`](./SCR-P-310-pairing-apple-watch-wear-os-android.md) — version Android
---
