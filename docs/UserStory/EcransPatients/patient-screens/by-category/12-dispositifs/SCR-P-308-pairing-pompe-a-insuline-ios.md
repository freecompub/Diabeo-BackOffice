# SCR-P-308 — 🍎 iOS — Pairing pompe à insuline
...
| **Nom** | Pairing pompe à insuline |
| **Type** | WIZARD_STEP |
| **Priorité** | **V1** |
| **Plateformes cibles** | 📱 Mobile (iOS + Android) |
| **Différences plateforme matérielles** | ✅ OUI — BLE + protocoles fabricants spécifiques iOS/Android |
| **Story points (par plateforme)** | 8 |
| **Route** | `/devices/pump-pairing` |
...
Wizard pairing pompes (Tandem, Medtronic, Insulet)
...
> **BLE + protocoles fabricants spécifiques iOS/Android**
...
- [`SCR-P-308-android`](./SCR-P-308-pairing-pompe-a-insuline-android.md) — version Android
---
