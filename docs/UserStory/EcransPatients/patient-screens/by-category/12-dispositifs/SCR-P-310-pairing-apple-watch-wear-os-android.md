# SCR-P-310 — 🤖 Android — Pairing Apple Watch / Wear OS
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, `Nordic BLE Library`, `Wear OS Compose`
...
- [`SCR-P-310-ios`](./SCR-P-310-pairing-apple-watch-wear-os-ios.md) — version iOS
---
