# SCR-P-255 — Calculateur bolus correction (sans repas)
...
| **Nom** | Calculateur bolus correction (sans repas) |
| **Type** | MODAL |
| **Priorité** | **MVP** |
...
### Vient de (parents)
Calculateur bolus / Procédure hyper
...
Mode correction pure : glycémie actuelle + suggestion dose correction
