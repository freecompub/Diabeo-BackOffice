# SCR-P-259 — Site d'injection (rotation visuelle)

> 🔵 Priorité **V1** · 📄 Type **PAGE** · Catégorie **05-Insuline** · 📱🖥️ Toutes plateformes
...
Schéma corporel interactif, points d'injection récents, alertes lipodystrophies
...
### Composants
```
InjectionSitesMap, RotationGuide
```
