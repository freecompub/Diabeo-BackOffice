# SCR-P-253 — Visualisation schéma insuline

> 🟢 Priorité **MVP** · 📄 Type **PAGE** · Catégorie **05-Insuline** · 📱🖥️ Toutes plateformes
...
| **Nom** | Visualisation schéma insuline |
| **Type** | PAGE |
| **Priorité** | **MVP** |
...
Schéma actuel : basale (timeline 24h), IC/FS par tranche horaire
...
### Composants
```
InsulinSchema, BasalTimeline, RatioByHour
```
