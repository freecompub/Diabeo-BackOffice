# SCR-P-342 — Bascule post-partum

> 🔵 Priorité **V1** · 📄 Type **PAGE** · Catégorie **17-ModeGrossesse** · 📱🖥️ Toutes plateformes
...
Retour cibles standards, mode allaitement (vigilance hypo accrue)
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, `Nordic BLE Library`, `Firebase Cloud Messaging (FCM)`
