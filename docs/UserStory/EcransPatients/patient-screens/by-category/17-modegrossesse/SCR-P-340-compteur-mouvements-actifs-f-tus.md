# SCR-P-340 — Compteur mouvements actifs fœtus

> 🔵 Priorité **V1** · 💬 Type **MODAL** · Catégorie **17-ModeGrossesse** · 📱🖥️ Toutes plateformes
...
| **Nom** | Compteur mouvements actifs fœtus |
| **Type** | MODAL |
| **Priorité** | **V1** |
...
Bouton 'mouvement détecté', compteur quotidien, alerte si chute
