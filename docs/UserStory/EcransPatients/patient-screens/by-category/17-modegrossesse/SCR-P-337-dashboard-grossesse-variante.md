# SCR-P-337 — Dashboard grossesse (variante)
...
| **Nom** | Dashboard grossesse (variante) |
| **Type** | PAGE |
| **Priorité** | **MVP** |
...
Variante du dashboard principal avec : SA, courbe poids, examens à venir
...
### Composants
```
PregnancyDashboard, PregnancyHeader
```
