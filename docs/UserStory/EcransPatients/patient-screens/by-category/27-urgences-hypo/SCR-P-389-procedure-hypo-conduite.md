# SCR-P-389 — Procédure hypo conduite

> 🔵 Priorité **V1** · 📄 Type **PAGE** · Catégorie **27-Urgences-Hypo** · 📱🖥️ Toutes plateformes
...
### Vient de (parents)
Détection en mouvement (vitesse)
...
Alerte 'Vous semblez conduire' → garez-vous, instructions sécurité
