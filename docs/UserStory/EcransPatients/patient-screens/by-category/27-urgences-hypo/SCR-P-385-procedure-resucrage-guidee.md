# SCR-P-385 — Procédure resucrage guidée
...
### Vient de (parents)
Notif hypo / FAB / Manuel

### Mène vers (enfants)
`SCR-P-386` — Compte à rebours règle des 15
...
Étapes pas-à-pas avec instructions visuelles, choix resucrage perso
