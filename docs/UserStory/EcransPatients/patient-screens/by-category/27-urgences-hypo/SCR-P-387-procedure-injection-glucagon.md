# SCR-P-387 — Procédure injection glucagon

> 🟢 Priorité **MVP** · 📄 Type **PAGE** · Catégorie **27-Urgences-Hypo** · 📱🖥️ Toutes plateformes
...
### Vient de (parents)
Procédure resucrage (hypo sévère)

### Mène vers (enfants)
Compte-rendu auto médecin
...
Vidéo + étapes texte, choix produit (Baqsimi/GlucaGen/Gvoke), urgence SAMU
