# SCR-P-355 — 🍎 iOS — Mode ambulance (lock screen)

> 🔵 Priorité **V1** · 🧩 Type **COMPONENT** · Catégorie **20-Urgences** · 📱 Mobile (iOS + Android)
...
| **Nom** | Mode ambulance (lock screen) |
| **Type** | COMPONENT |
| **Priorité** | **V1** |
| **Plateformes cibles** | 📱 Mobile (iOS + Android) |
| **Différences plateforme matérielles** | ✅ OUI — Medical ID iOS / Emergency Information Android — APIs OS distinctes |
...
Infos vitales accessibles depuis l'écran de verrouillage
...
> **Medical ID iOS / Emergency Information Android — APIs OS distinctes**
...
- **Langage** : Swift 5.9+
- **Frameworks** : `SwiftUI`, `Combine`, `CoreBluetooth`, `WidgetKit`
...
### Composants
```
LockScreenMedicalInfo
```


### 🔗 Voir aussi (autres plateformes)

- [`SCR-P-355-android`](./SCR-P-355-mode-ambulance-lock-screen-android.md) — version Android
---
