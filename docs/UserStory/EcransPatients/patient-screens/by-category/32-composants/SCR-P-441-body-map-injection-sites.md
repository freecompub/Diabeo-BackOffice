# SCR-P-441 — Body map injection sites

> 🔵 Priorité **V1** · 🧩 Type **COMPONENT** · Catégorie **32-Composants** · 📱🖥️ Toutes plateformes
...
Schéma corporel interactif, points d'injection récents
