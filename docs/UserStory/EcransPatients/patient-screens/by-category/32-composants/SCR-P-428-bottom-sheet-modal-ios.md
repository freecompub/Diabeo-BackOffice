# SCR-P-428 — 🍎 iOS — Bottom sheet / Modal
...
| **Nom** | Bottom sheet / Modal |
| **Type** | COMPONENT |
| **Priorité** | **MVP** |
| **Plateformes cibles** | 📱🖥️ Toutes plateformes |
| **Différences plateforme matérielles** | ✅ OUI — BottomSheet UX très différente mobile vs web (modal centré) |
...
Bottom sheet mobile (drag), modal centrée web
...
> **BottomSheet UX très différente mobile vs web (modal centré)**
...
- [`SCR-P-428-android`](./SCR-P-428-bottom-sheet-modal-android.md) — version Android
- [`SCR-P-428-web`](./SCR-P-428-bottom-sheet-modal-web.md) — version Web
---
