# SCR-P-426 — 🍎 iOS — Sélecteur (Picker)
...
| **Nom** | Sélecteur (Picker) |
| **Type** | COMPONENT |
| **Priorité** | **MVP** |
| **Plateformes cibles** | 📱🖥️ Toutes plateformes |
| **Différences plateforme matérielles** | ✅ OUI — Picker natif iOS (UIPickerView) ≠ Spinner Android ≠ Select web |
...
Native picker iOS / Android, custom web. Recherche optionnelle.
...
> **Picker natif iOS (UIPickerView) ≠ Spinner Android ≠ Select web**
...
- [`SCR-P-426-android`](./SCR-P-426-selecteur-picker-android.md) — version Android
- [`SCR-P-426-web`](./SCR-P-426-selecteur-picker-web.md) — version Web
---
