# SCR-P-288 — Demande de précision avant acceptation

> 🔵 Priorité **V1** · 💬 Type **MODAL** · Catégorie **09-Propositions** · 📱🖥️ Toutes plateformes
...
| **Nom** | Demande de précision avant acceptation |
| **Type** | MODAL |
| **Priorité** | **V1** |
...
Question libre, génère un message au médecin
