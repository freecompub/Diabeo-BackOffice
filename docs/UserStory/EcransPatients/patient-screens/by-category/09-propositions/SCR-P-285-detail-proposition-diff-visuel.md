# SCR-P-285 — Détail proposition + diff visuel

> 🟢 Priorité **MVP** · 📄 Type **PAGE** · Catégorie **09-Propositions** · 📱🖥️ Toutes plateformes
...
|---|---|
| **ID** | `SCR-P-285` |
| **Catégorie** | 09-Propositions |
| **Nom** | Détail proposition + diff visuel |
| **Type** | PAGE |
| **Priorité** | **MVP** |
...
Avant/après visuel, justification médecin, boutons accepter/refuser/préciser
...
### Composants
```
ProposalDetail, BeforeAfterDiff, RationaleBlock
```
