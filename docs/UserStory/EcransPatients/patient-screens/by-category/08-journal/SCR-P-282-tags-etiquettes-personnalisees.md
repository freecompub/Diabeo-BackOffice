# SCR-P-282 — Tags / étiquettes personnalisées

> 🔵 Priorité **V1** · 📄 Type **PAGE** · Catégorie **08-Journal** · 📱🖥️ Toutes plateformes
...
| **Nom** | Tags / étiquettes personnalisées |
| **Type** | PAGE |
| **Priorité** | **V1** |
...
Création tags perso (ex: 'soirée', 'travail intense'), couleurs
