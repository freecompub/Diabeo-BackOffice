# SCR-P-280 — Journal chronologique

> 🟢 Priorité **MVP** · 📄 Type **PAGE** · Catégorie **08-Journal** · 📱🖥️ Toutes plateformes
...
|---|---|
| **ID** | `SCR-P-280` |
| **Catégorie** | 08-Journal |
| **Nom** | Journal chronologique |
| **Type** | PAGE |
| **Priorité** | **MVP** |
...
Toutes saisies confondues : glycémies, repas, bolus, événements, activité
...
### Composants
```
ChronologicalJournal, JournalEntry
```
