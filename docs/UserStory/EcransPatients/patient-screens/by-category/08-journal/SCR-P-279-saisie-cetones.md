# SCR-P-279 — Saisie cétones

> 🟢 Priorité **MVP** · 💬 Type **MODAL** · Catégorie **08-Journal** · 📱🖥️ Toutes plateformes
...
### Vient de (parents)
Procédure urgence / FAB

### Mène vers (enfants)
Procédure DKA si seuil
...
Cétonémie ou cétonurie, déclenche stratification DKA si élevé
