# SCR-P-238 — Saisie manuelle glycémie

> 🟢 Priorité **MVP** · 💬 Type **MODAL** · Catégorie **04-Glycemie** · 📱🖥️ Toutes plateformes
...
Saisie rapide : valeur + heure (auto par défaut) + tag (avant/après repas, etc.)
