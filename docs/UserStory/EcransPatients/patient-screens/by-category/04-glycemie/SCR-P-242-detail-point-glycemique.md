# SCR-P-242 — Détail point glycémique

> 🔵 Priorité **V1** · 💬 Type **MODAL** · Catégorie **04-Glycemie** · 📱🖥️ Toutes plateformes
...
Valeur exacte, heure, événements à proximité (repas, bolus, sport)
...
### Composants
```
GlucosePointDetail, ContextEvents
```
