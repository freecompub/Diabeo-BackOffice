# SCR-P-251 — 🍎 iOS — Apple Watch complication / Wear OS tile

> 🟡 Priorité **V2** · 🧩 Type **COMPONENT** · Catégorie **04-Glycemie** · 🍎 iOS uniquement
...
| **Nom** | Apple Watch complication / Wear OS tile |
| **Type** | COMPONENT |
| **Priorité** | **V2** |
| **Plateformes cibles** | 🍎 iOS uniquement |
| **Différences plateforme matérielles** | ✅ OUI — Apple Watch (WatchKit) ≠ Wear OS (Compose) — apps différentes |
...
Glycémie au poignet, complication multi-tailles
...
> **Apple Watch (WatchKit) ≠ Wear OS (Compose) — apps différentes**
...
- **Langage** : Swift 5.9+
- **Frameworks** : `SwiftUI`, `Combine`, `WidgetKit`, `WatchKit + watchOS app companion`
...
### Composants
```
GlucoseComplication, GlucoseTile
```


### 🔗 Voir aussi (autres plateformes)

_Cet écran est exclusif à cette plateforme._
---
