# SCR-P-241 — Dashboard glycémie temps réel

> 🟢 Priorité **MVP** · 📄 Type **PAGE** · Catégorie **04-Glycemie** · 📱🖥️ Toutes plateformes
...
| **Nom** | Dashboard glycémie temps réel |
| **Type** | PAGE |
| **Priorité** | **MVP** |
...
### Vient de (parents)
Dashboard / Tab glycémie

### Mène vers (enfants)
Détail point, AGP, Saisie
...
Grosse valeur actuelle + flèche tendance + courbe 6h. Très lisible.
...
### Composants
```
GlucoseLive, BigNumber, TrendArrow, Last6h
```
