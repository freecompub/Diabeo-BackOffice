# SCR-P-250 — 🤖 Android — Widget Lock Screen / Home Screen glycémie
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, `Jetpack Glance`
- **Architecture** : MVVM + Hilt

### APIs et capacités spécifiques
- Widget Home Screen via Jetpack Glance (Android 12+)
...
- [`SCR-P-250-ios`](./SCR-P-250-widget-lock-screen-home-screen-glycemie-ios.md) — version iOS
---
