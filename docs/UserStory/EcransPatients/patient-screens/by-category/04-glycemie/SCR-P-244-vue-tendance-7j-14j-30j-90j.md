# SCR-P-244 — Vue tendance (7j/14j/30j/90j)
...
Sélecteur période, courbe complète, statistiques (TIR, GMI, CV)
...
### Composants
```
TrendsView, PeriodSelector, MetricsBar
```
