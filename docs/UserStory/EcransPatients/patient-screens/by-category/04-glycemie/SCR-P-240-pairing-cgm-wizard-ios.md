# SCR-P-240 — 🍎 iOS — Pairing CGM (wizard)

> 🟢 Priorité **MVP** · 🧙 Type **WIZARD_STEP** · Catégorie **04-Glycemie** · 📱 Mobile (iOS + Android)
...
| **Nom** | Pairing CGM (wizard) |
| **Type** | WIZARD_STEP |
| **Priorité** | **MVP** |
| **Plateformes cibles** | 📱 Mobile (iOS + Android) |
| **Différences plateforme matérielles** | ✅ OUI — BLE / Bluetooth fondamentalement différent iOS (CoreBluetooth) vs Android (BluetoothLE) vs Web (Web Bluetooth API très limitée) |
| **Story points (par plateforme)** | 8 |
| **Route** | `/devices/cgm-pairing` |
...
Wizard avec animation, recherche BLE temps réel, instructions selon CGM
...
> **BLE / Bluetooth fondamentalement différent iOS (CoreBluetooth) vs Android (BluetoothLE) vs Web (Web Bluetooth API très limitée)**
...
### Composants
```
CgmPairingWizard, BleScanner
```


### 🔗 Voir aussi (autres plateformes)

- [`SCR-P-240-android`](./SCR-P-240-pairing-cgm-wizard-android.md) — version Android
---
