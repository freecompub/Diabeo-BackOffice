# SCR-P-294 — Modification / Annulation RDV

> 🔵 Priorité **V1** · 💬 Type **MODAL** · Catégorie **10-Teleconsult** · 📱🖥️ Toutes plateformes
...
| **Nom** | Modification / Annulation RDV |
| **Type** | MODAL |
| **Priorité** | **V1** |
...
Choix : modifier date / annuler. Annulation = motif obligatoire.
