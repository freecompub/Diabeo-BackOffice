# SCR-P-300 — Évaluation post-consultation

> 🟡 Priorité **V2** · 💬 Type **MODAL** · Catégorie **10-Teleconsult** · 📱🖥️ Toutes plateformes
...
| **Nom** | Évaluation post-consultation |
| **Type** | MODAL |
| **Priorité** | **V2** |
...
Note 5 étoiles + commentaire optionnel, anonyme côté médecin
