# SCR-P-229 — Édition allergies & intolérances
...
| **ID** | `SCR-P-229` |
| **Catégorie** | 03-Profil |
| **Nom** | Édition allergies & intolérances |
| **Type** | PAGE |
| **Priorité** | **MVP** |
...
Liste structurée, recherche autocomplete, sévérité par allergie
...
### Composants
```
AllergiesEditor, SeverityPicker
```
