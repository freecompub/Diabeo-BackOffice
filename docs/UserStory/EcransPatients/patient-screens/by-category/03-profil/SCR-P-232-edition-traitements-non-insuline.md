# SCR-P-232 — Édition traitements (non insuline)
...
| **ID** | `SCR-P-232` |
| **Catégorie** | 03-Profil |
| **Nom** | Édition traitements (non insuline) |
| **Type** | PAGE |
| **Priorité** | **V1** |
...
Médicaments en cours, posologie, début. Recherche BdM (FR/DZ).
...
### Composants
```
MedicationsEditor, BdmSearchField
```
