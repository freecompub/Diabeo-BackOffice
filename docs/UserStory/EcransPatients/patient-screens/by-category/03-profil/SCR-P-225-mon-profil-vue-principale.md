# SCR-P-225 — Mon profil (vue principale)

> 🟢 Priorité **MVP** · 📄 Type **PAGE** · Catégorie **03-Profil** · 📱🖥️ Toutes plateformes
...
### Vient de (parents)
Tab profil bottom nav

### Mène vers (enfants)
Édition de chaque section
...
Photo + nom, sections collapsibles : identité, médical, traitements, contacts
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, `Nordic BLE Library`, `CameraX + Google ML Kit`
