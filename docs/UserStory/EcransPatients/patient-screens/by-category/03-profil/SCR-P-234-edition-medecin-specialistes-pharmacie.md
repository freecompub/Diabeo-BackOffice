# SCR-P-234 — Édition médecin/spécialistes/pharmacie

> 🔵 Priorité **V1** · 📄 Type **PAGE** · Catégorie **03-Profil** · 📱🖥️ Toutes plateformes
...
| **ID** | `SCR-P-234` |
| **Catégorie** | 03-Profil |
| **Nom** | Édition médecin/spécialistes/pharmacie |
| **Type** | PAGE |
| **Priorité** | **V1** |
...
Médecin traitant + spécialistes + pharmacie référente. Annuaire ANS (FR).
