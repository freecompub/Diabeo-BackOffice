# SCR-P-226 — 🍎 iOS — Édition photo de profil

> 🔵 Priorité **V1** · 💬 Type **MODAL** · Catégorie **03-Profil** · 📱 Mobile (iOS + Android)
...
| **ID** | `SCR-P-226` |
| **Catégorie** | 03-Profil |
| **Nom** | Édition photo de profil |
| **Type** | MODAL |
| **Priorité** | **V1** |
| **Plateformes cibles** | 📱 Mobile (iOS + Android) |
| **Différences plateforme matérielles** | ✅ OUI — Caméra et bibliothèque photos OS-spécifiques |
...
Choix entre 'Prendre photo' / 'Bibliothèque' / 'Supprimer'
...
> **Caméra et bibliothèque photos OS-spécifiques**
...
### Composants
```
AvatarEditor, ImageCropper
```


### 🔗 Voir aussi (autres plateformes)

- [`SCR-P-226-android`](./SCR-P-226-edition-photo-de-profil-android.md) — version Android
---
