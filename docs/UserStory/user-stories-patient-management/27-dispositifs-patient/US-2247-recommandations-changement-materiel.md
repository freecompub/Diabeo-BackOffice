# US-2247 — Recommandations changement matériel
...
Suggestions automatiques au médecin : capteur en fin de vie, batterie pompe faible, accessoires à renouveler. Pré-remplit la prochaine ordonnance.
...
Quand il tente d'accéder à « Recommandations changement matériel »
...
```gherkin
Étant donné Une action sur « Recommandations changement matériel » est effectuée
...
```
POST   /api/orchestrations/recommandations-changement-materiel     Déclenchement manuel
GET    /api/orchestrations/recommandations-changement-materiel/log Logs récents
PATCH  /api/orchestrations/recommandations-changement-materiel/preferences  Préférences cabinet
```
...
### Validation Zod
Schémas Zod stricts sur tous les inputs. Voir `src/lib/services/recommandations-changement-materiel.service.ts`.
