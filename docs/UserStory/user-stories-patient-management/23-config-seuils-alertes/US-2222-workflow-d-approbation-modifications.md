# US-2222 — Workflow d'approbation modifications

> 📌 **23. Configuration seuils & alertes patient** · Priorité **V2**
...
|---|---|
| **ID** | `US-2222` |
| **Domaine** | 23. Configuration seuils & alertes patient |
...
Pour les modifications sensibles (cibles glycémiques, seuils urgence), workflow optionnel d'approbation par un second médecin (selon politique cabinet).
...
Quand il tente d'accéder à « Workflow d'approbation modifications »
...
```gherkin
Étant donné Une action sur « Workflow d'approbation modifications » est effectuée
...
```
POST   /api/patients/[patientId]/workflows/workflow-d-approbation-modifications     Initier workflow
...
### Validation Zod
Schémas Zod stricts sur tous les inputs. Voir `src/lib/services/workflow-d-approbation-modifications.service.ts`.
