# US-2221 — Historique versionné des configurations
...
Toute modification des seuils ou cibles d'un patient crée une nouvelle version. Vue chronologique avec qui, quand, quoi a changé. Possibilité de restaurer une version antérieure.
...
Quand il tente d'accéder à « Historique versionné des configurations »
...
```gherkin
Étant donné Une action sur « Historique versionné des configurations » est effectuée
...
```
GET    /api/admin/audit/historique-versionne-des-configurations        Lecture (filtres)
POST   /api/admin/audit/historique-versionne-des-configurations/export Demande export
...
### Validation Zod
Schémas Zod stricts sur tous les inputs. Voir `src/lib/services/historique-versionne-des-configurations.service.ts`.
