# US-2263 — Coordination multi-soignants sur patient
...
Fil de discussion interne soignants (médecin référent, IDE, diététicien, psychologue) lié à un patient. Annotations privées non visibles du patient.
...
Quand il tente d'accéder à « Coordination multi-soignants sur patient »
...
```gherkin
Étant donné Une action sur « Coordination multi-soignants sur patient » est effectuée
...
```
POST   /api/orchestrations/coordination-multi-soignants-sur-patient     Déclenchement manuel
GET    /api/orchestrations/coordination-multi-soignants-sur-patient/log Logs récents
PATCH  /api/orchestrations/coordination-multi-soignants-sur-patient/preferences  Préférences cabinet
```
...
### Validation Zod
Schémas Zod stricts sur tous les inputs. Voir `src/lib/services/coordination-multi-soignants-sur-patient.service.ts`.
