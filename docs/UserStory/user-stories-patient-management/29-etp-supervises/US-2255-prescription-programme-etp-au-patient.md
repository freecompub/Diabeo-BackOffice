# US-2255 — Prescription programme ETP au patient

> 📌 **29. Programmes ETP supervisés** · Priorité **V2**
...
|---|---|
| **ID** | `US-2255` |
| **Domaine** | 29. Programmes ETP supervisés |
...
Le médecin prescrit un programme à un patient avec date de début, durée, validation contractuelle. Le programme s'active dans l'app patient.
...
Quand il tente d'accéder à « Prescription programme ETP au patient »
...
```gherkin
Étant donné Une action sur « Prescription programme ETP au patient » est effectuée
...
```
POST   /api/patients/[patientId]/workflows/prescription-programme-etp-au-patient     Initier workflow
...
### Validation Zod
Schémas Zod stricts sur tous les inputs. Voir `src/lib/services/prescription-programme-etp-au-patient.service.ts`.
