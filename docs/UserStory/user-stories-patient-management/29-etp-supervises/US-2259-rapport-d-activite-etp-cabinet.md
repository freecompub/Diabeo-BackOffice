# US-2259 — Rapport d'activité ETP cabinet
...
Statistiques cabinet : nombre patients en programme, taux complétion, score satisfaction, indicateurs HAS. Export pour rapports d'activité ARS/HAS.
...
Quand il tente d'accéder à « Rapport d'activité ETP cabinet »
...
```gherkin
Étant donné Une action sur « Rapport d'activité ETP cabinet » est effectuée
...
```
GET    /api/cohort/rapport-d-activite-etp-cabinet            Vue cohorte (cabinet)
GET    /api/patients/[patientId]/rapport-d-activite-etp-cabinet    Vue détaillée patient
POST   /api/patients/[patientId]/rapport-d-activite-etp-cabinet/refresh    Force refresh
```
...
### Validation Zod
Schémas Zod stricts sur tous les inputs. Voir `src/lib/services/rapport-d-activite-etp-cabinet.service.ts`.
