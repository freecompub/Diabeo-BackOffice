# US-2257 — Évaluation acquis post-programme

> 📌 **29. Programmes ETP supervisés** · Priorité **V3**
...
Évaluation finale pour valider l'acquisition des compétences : quiz, mises en situation, auto-évaluation patient + évaluation médecin.
...
Quand il tente d'accéder à « Évaluation acquis post-programme »
...
```gherkin
Étant donné Une action sur « Évaluation acquis post-programme » est effectuée
...
```
POST   /api/patients/[patientId]/workflows/evaluation-acquis-post-programme     Initier workflow
...
### Validation Zod
Schémas Zod stricts sur tous les inputs. Voir `src/lib/services/evaluation-acquis-post-programme.service.ts`.
