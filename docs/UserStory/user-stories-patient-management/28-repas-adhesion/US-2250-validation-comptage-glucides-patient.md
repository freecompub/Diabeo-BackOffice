# US-2250 — Validation comptage glucides patient
...
| **Statut** | 🆕 À démarrer |
| **Dépendances** | US-2001 (Login JWT), US-2011 (Audit log immuable), US-2012 (RBAC 4 rôles), US-2018 (Fiche patient), Miroir app patient : US-3075 (comptage glucides assisté) |
...
Le médecin/diététicien peut commenter et corriger le comptage glucides du patient pour des repas types. Devient un guide pour les futurs repas similaires.
...
**US miroir patient** : US-3075 (comptage glucides assisté)
...
Quand il tente d'accéder à « Validation comptage glucides patient »
...
```gherkin
Étant donné Une action sur « Validation comptage glucides patient » est effectuée
...
```
POST   /api/patients/[patientId]/workflows/validation-comptage-glucides-patient     Initier workflow
...
### Validation Zod
Schémas Zod stricts sur tous les inputs. Voir `src/lib/services/validation-comptage-glucides-patient.service.ts`.
...
- **Miroir app patient** : US-3075 (comptage glucides assisté)
