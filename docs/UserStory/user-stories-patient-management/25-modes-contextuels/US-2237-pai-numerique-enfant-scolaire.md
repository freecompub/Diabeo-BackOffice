# US-2237 — PAI numérique enfant scolaire
...
| **Statut** | 🆕 À démarrer |
| **Dépendances** | US-2001 (Login JWT), US-2011 (Audit log immuable), US-2012 (RBAC 4 rôles), US-2018 (Fiche patient), Miroir app patient : US-3203 (PAI patient) |
...
Génération du Projet d'Accueil Individualisé conforme cadre HAS : protocole d'urgence, contacts, autorisation médicaments, signature numérique parents+école+médecin.
...
**US miroir patient** : US-3203 (PAI patient)
...
Quand il tente d'accéder à « PAI numérique enfant scolaire »
...
```gherkin
Étant donné Une action sur « PAI numérique enfant scolaire » est effectuée
...
```
POST   /api/patients/[patientId]/workflows/pai-numerique-enfant-scolaire     Initier workflow
...
### Validation Zod
Schémas Zod stricts sur tous les inputs. Voir `src/lib/services/pai-numerique-enfant-scolaire.service.ts`.
...
- **Miroir app patient** : US-3203 (PAI patient)
