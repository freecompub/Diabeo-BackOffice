# US-2239 — Audit partages temporaires
...
| **Statut** | 🆕 À démarrer |
| **Dépendances** | US-2001 (Login JWT), US-2011 (Audit log immuable), US-2012 (RBAC 4 rôles), US-2018 (Fiche patient), Miroir app patient : US-3036 (partage temporaire courbe) |
...
Liste des partages temporaires actifs : lien généré, destinataire, contenu partagé, date d'expiration. Vue permettant de révoquer en cas de doute.
...
**US miroir patient** : US-3036 (partage temporaire courbe)
...
Quand il tente d'accéder à « Audit partages temporaires »
...
```gherkin
Étant donné Une action sur « Audit partages temporaires » est effectuée
...
```
GET    /api/admin/audit/audit-partages-temporaires        Lecture (filtres)
POST   /api/admin/audit/audit-partages-temporaires/export Demande export
...
### Validation Zod
Schémas Zod stricts sur tous les inputs. Voir `src/lib/services/audit-partages-temporaires.service.ts`.
...
- **Miroir app patient** : US-3036 (partage temporaire courbe)
