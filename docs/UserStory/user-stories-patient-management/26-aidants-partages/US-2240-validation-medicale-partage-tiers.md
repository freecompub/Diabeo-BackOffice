# US-2240 — Validation médicale partage tiers

> 📌 **26. Gestion aidants & partages** · Priorité **V2**
...
|---|---|
| **ID** | `US-2240` |
| **Domaine** | 26. Gestion aidants & partages |
...
Pour les partages institutionnels (école, EHPAD), workflow de validation médicale : le médecin co-signe le partage avec le patient, traçable dans l'audit.
...
Quand il tente d'accéder à « Validation médicale partage tiers »
...
```gherkin
Étant donné Une action sur « Validation médicale partage tiers » est effectuée
...
```
POST   /api/patients/[patientId]/workflows/validation-medicale-partage-tiers     Initier workflow
...
### Validation Zod
Schémas Zod stricts sur tous les inputs. Voir `src/lib/services/validation-medicale-partage-tiers.service.ts`.
