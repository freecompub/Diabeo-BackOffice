# US-3211 — Conseils saisonniers/contextuels

> 📌 **16. ETP** · Priorité **V2** · Plateforme **📱🖥️**

> 💬 **Note inventaire** : Ramadan critique pour DZ
...
La fonctionnalité « Conseils saisonniers/contextuels » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Conseils saisonniers/contextuels » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Conseils saisonniers/contextuels » est optimisée pour :
...
- **Lettre médicale multilingue** disponible avec la fonctionnalité (Conseils saisonniers/contextuels) si pertinent (douanes, urgences à l'étranger)
...
Quand il accède à la fonctionnalité « Conseils saisonniers/contextuels »
...
### AC-3 — Mode Ramadan : adaptation aux périodes de jeûne

```gherkin
Étant donné Le mode Ramadan est activé avec horaires Sahur/Iftar configurés
Quand « Conseils saisonniers/contextuels » s'exécute pendant la journée de jeûne
