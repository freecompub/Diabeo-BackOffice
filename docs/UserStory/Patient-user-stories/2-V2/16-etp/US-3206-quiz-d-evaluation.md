...
La fonctionnalité « Quiz d'évaluation » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Quiz d'évaluation » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Quiz d'évaluation » est optimisée pour :
...
Quand il accède à la fonctionnalité « Quiz d'évaluation »
