...
|---|---|
| **ID** | `US-3210` |
| **Référence inventaire** | `FNP-210` |
| **Domaine** | 16. ETP |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (contenus) |
...
La fonctionnalité « Recettes adaptées » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Recettes adaptées » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Recettes adaptées » est optimisée pour :
...
Quand il accède à la fonctionnalité « Recettes adaptées »
