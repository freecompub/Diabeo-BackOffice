...
|---|---|
| **ID** | `US-3204` |
| **Référence inventaire** | `FNP-204` |
| **Domaine** | 16. ETP |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (CMS) ou partenaire ETP |
...
La fonctionnalité « Bibliothèque contenus » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Bibliothèque contenus » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Bibliothèque contenus » est optimisée pour :
...
Quand il accède à la fonctionnalité « Bibliothèque contenus »
