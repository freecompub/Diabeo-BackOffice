# US-3150 — Évaluation post-consult

> 📌 **10. Téléconsultation** · Priorité **V2** · Plateforme **📱🖥️**
...
La fonctionnalité « Évaluation post-consult » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Évaluation post-consult » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Évaluation post-consult » est optimisée pour :
...
Quand il accède à la fonctionnalité « Évaluation post-consult »
