# US-3014 — Onboarding accompagnant/aidant

> 📌 **1. Onboarding** · Priorité **V2** · Plateforme **📱🖥️**
...
La fonctionnalité « Onboarding accompagnant/aidant » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Onboarding accompagnant/aidant » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Onboarding accompagnant/aidant » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Onboarding accompagnant/aidant) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Onboarding accompagnant/aidant »
...
Quand un événement Onboarding accompagnant/aidant se produit
