# US-3088 — Compteur stylos restants
...
La fonctionnalité « Compteur stylos restants » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Compteur stylos restants » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Compteur stylos restants » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Compteur stylos restants) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Compteur stylos restants »
...
Quand un événement Compteur stylos restants se produit
