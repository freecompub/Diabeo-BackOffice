# US-3201 — Streaks/gamification douce

> 📌 **15. Suivi & objectifs** · Priorité **V2** · Plateforme **📱**

> 💬 **Note inventaire** : Attention pas culpabilisant
...
|---|---|
| **ID** | `US-3201` |
| **Référence inventaire** | `FNP-201` |
| **Domaine** | 15. Suivi & objectifs |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱 |
...
La fonctionnalité « Streaks/gamification douce » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Streaks/gamification douce » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Streaks/gamification douce » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Streaks/gamification douce) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Streaks/gamification douce »
...
Quand un événement Streaks/gamification douce se produit
