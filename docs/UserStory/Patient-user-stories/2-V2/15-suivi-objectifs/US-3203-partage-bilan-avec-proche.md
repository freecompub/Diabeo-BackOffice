# US-3203 — Partage bilan avec proche

> 📌 **15. Suivi & objectifs** · Priorité **V2** · Plateforme **📱➡️🖥️**
...
La fonctionnalité « Partage bilan avec proche » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Partage bilan avec proche » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Partage bilan avec proche » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Partage bilan avec proche) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Partage bilan avec proche »
...
Quand un événement Partage bilan avec proche se produit
