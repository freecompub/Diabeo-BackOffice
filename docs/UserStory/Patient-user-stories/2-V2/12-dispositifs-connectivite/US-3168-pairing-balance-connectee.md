# US-3168 — Pairing balance connectée

> 📌 **12. Dispositifs & connectivité** · Priorité **V2** · Plateforme **📱**
...
|---|---|
| **ID** | `US-3168` |
| **Référence inventaire** | `FNP-168` |
| **Domaine** | 12. Dispositifs & connectivité |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | API fabricant ou HealthKit |
...
- **Langage** : Swift 5.9+
- **Frameworks** : `SwiftUI`, `Combine`, `CoreBluetooth`, `HealthKit`
...
La fonctionnalité « Pairing balance connectée » est exposée selon les conventions iOS :
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, `Nordic BLE Library (recommandé) ou Android BluetoothLE`, `Health Connect (Android 14+) + Google Fit fallback`
...
### Comportement utilisateur
La fonctionnalité « Pairing balance connectée » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Pairing balance connectée » est optimisée pour :
...
Quand il accède à la fonctionnalité « Pairing balance connectée »
...
```gherkin
Étant donné Le service « API fabricant ou HealthKit » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « API fabricant ou HealthKit » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **API fabricant ou HealthKit** (à valider en kick-off)
