...
|---|---|
| **ID** | `US-3169` |
| **Référence inventaire** | `FNP-169` |
| **Domaine** | 12. Dispositifs & connectivité |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | Withings / Omron / HealthKit |
...
La fonctionnalité « Pairing tensiomètre » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Pairing tensiomètre » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Pairing tensiomètre » est optimisée pour :
...
Quand il accède à la fonctionnalité « Pairing tensiomètre »
...
```gherkin
Étant donné Le service « Withings / Omron / HealthKit » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Withings / Omron / HealthKit » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Withings / Omron / HealthKit** (à valider en kick-off)
