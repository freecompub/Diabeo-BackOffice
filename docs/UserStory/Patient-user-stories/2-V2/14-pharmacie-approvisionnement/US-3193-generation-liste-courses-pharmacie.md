# US-3193 — Génération liste courses pharmacie

> 📌 **14. Pharmacie & approvisionnement** · Priorité **V2** · Plateforme **📱🖥️**
...
La fonctionnalité « Génération liste courses pharmacie » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Génération liste courses pharmacie » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Génération liste courses pharmacie » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Génération liste courses pharmacie) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Génération liste courses pharmacie »
...
Quand un événement Génération liste courses pharmacie se produit
