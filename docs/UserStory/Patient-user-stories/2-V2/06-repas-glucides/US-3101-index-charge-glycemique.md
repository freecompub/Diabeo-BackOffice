# US-3101 — Index/charge glycémique
...
|---|---|
| **ID** | `US-3101` |
| **Référence inventaire** | `FNP-101` |
| **Domaine** | 6. Repas & glucides |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Partiel |
| **Service / Standard** | Référentiel scientifique (libre) |
...
La fonctionnalité « Index/charge glycémique » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Index/charge glycémique » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Index/charge glycémique » est optimisée pour :
...
Quand il accède à la fonctionnalité « Index/charge glycémique »
...
```gherkin
Étant donné Le service « Référentiel scientifique (libre) » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Référentiel scientifique (libre) » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Référentiel scientifique (libre)** (à valider en kick-off)
