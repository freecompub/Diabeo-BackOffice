# US-3241 — Adaptation décalage horaire
...
|---|---|
| **ID** | `US-3241` |
| **Référence inventaire** | `FNP-241` |
| **Domaine** | 21. Voyages |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (validation médicale) |
...
La fonctionnalité « Adaptation décalage horaire » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Adaptation décalage horaire » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Adaptation décalage horaire » est optimisée pour :
...
- **Lettre médicale multilingue** disponible avec la fonctionnalité (Adaptation décalage horaire) si pertinent (douanes, urgences à l'étranger)
...
Quand il accède à la fonctionnalité « Adaptation décalage horaire »
