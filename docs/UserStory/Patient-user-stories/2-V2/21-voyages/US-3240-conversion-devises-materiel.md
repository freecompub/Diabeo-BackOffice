# US-3240 — Conversion devises matériel

> 📌 **21. Voyages** · Priorité **V2** · Plateforme **📱**
...
|---|---|
| **ID** | `US-3240` |
| **Référence inventaire** | `FNP-240` |
| **Domaine** | 21. Voyages |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | ECB / fixer.io / OpenExchangeRates |
...
La fonctionnalité « Conversion devises matériel » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Conversion devises matériel » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Conversion devises matériel » est optimisée pour :
...
- **Lettre médicale multilingue** disponible avec la fonctionnalité (Conversion devises matériel) si pertinent (douanes, urgences à l'étranger)
...
Quand il accède à la fonctionnalité « Conversion devises matériel »
...
```gherkin
Étant donné Le service « ECB / fixer.io / OpenExchangeRates » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « ECB / fixer.io / OpenExchangeRates » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **ECB / fixer.io / OpenExchangeRates** (à valider en kick-off)
