# US-3351 — Sous-titres vidéos ETP
...
|---|---|
| **ID** | `US-3351` |
| **Référence inventaire** | `FNP-351` |
| **Domaine** | 30. Accessibilité avancée |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (whisper) ou manuel |
| **Modèle économique** | Interne / Payant |
...
La fonctionnalité « Sous-titres vidéos ETP » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Sous-titres vidéos ETP » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Sous-titres vidéos ETP » est optimisée pour :
...
Quand il accède à la fonctionnalité « Sous-titres vidéos ETP »
