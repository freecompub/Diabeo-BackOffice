# US-3348 — Mode mains libres pendant hypo

> 📌 **30. Accessibilité avancée** · Priorité **V2** · Plateforme **📱**

> 💬 **Note inventaire** : Critique pour hypo
...
|---|---|
| **ID** | `US-3348` |
| **Référence inventaire** | `FNP-348` |
| **Domaine** | 30. Accessibilité avancée |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | TTS OS natif |
...
La fonctionnalité « Mode mains libres pendant hypo » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Mode mains libres pendant hypo » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Mode mains libres pendant hypo » est optimisée pour :
...
Quand il accède à la fonctionnalité « Mode mains libres pendant hypo »
...
```gherkin
Étant donné Le service « TTS OS natif » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « TTS OS natif » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **TTS OS natif** (à valider en kick-off)
