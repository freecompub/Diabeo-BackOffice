# US-3347 — Navigation vocale complète

> 📌 **30. Accessibilité avancée** · Priorité **V2** · Plateforme **📱**
...
|---|---|
| **ID** | `US-3347` |
| **Référence inventaire** | `FNP-347` |
| **Domaine** | 30. Accessibilité avancée |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | Apple Speech / Android SpeechRecognizer |
...
- **Langage** : Swift 5.9+
- **Frameworks** : `SwiftUI`, `Combine`, `Speech + AVAudioEngine`
...
La fonctionnalité « Navigation vocale complète » est exposée selon les conventions iOS :
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, `SpeechRecognizer + App Shortcuts pour Google Assistant`
...
### Comportement utilisateur
La fonctionnalité « Navigation vocale complète » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Navigation vocale complète » est optimisée pour :
...
Quand il accède à la fonctionnalité « Navigation vocale complète »
...
```gherkin
Étant donné Le service « Apple Speech / Android SpeechRecognizer » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Apple Speech / Android SpeechRecognizer » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Apple Speech / Android SpeechRecognizer** (à valider en kick-off)
