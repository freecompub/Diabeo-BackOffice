# US-3354 — Conformité RGAA / WCAG 2.1 AA

> 📌 **30. Accessibilité avancée** · Priorité **V2** · Plateforme **📱🖥️**

> 💬 **Note inventaire** : RGAA = obligation FR
...
|---|---|
| **ID** | `US-3354` |
| **Référence inventaire** | `FNP-354` |
| **Domaine** | 30. Accessibilité avancée |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Oui |
| **Service / Standard** | Cabinet d'audit accessibilité |
| **Modèle économique** | Payant audit |
| **Coût estimé** | 5-15 k€/audit |
...
La fonctionnalité « Conformité RGAA / WCAG 2.1 AA » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Conformité RGAA / WCAG 2.1 AA » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Conformité RGAA / WCAG 2.1 AA » est optimisée pour :
...
Quand il accède à la fonctionnalité « Conformité RGAA / WCAG 2.1 AA »
...
```gherkin
Étant donné Le service « Cabinet d'audit accessibilité » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Cabinet d'audit accessibilité » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Cabinet d'audit accessibilité** (à valider en kick-off)
