# US-3231 — Multi-administrateurs dépendants

> 📌 **19. Famille & aidants** · Priorité **V2** · Plateforme **📱🖥️**
...
La fonctionnalité « Multi-administrateurs dépendants » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Multi-administrateurs dépendants » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Multi-administrateurs dépendants » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Multi-administrateurs dépendants) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Multi-administrateurs dépendants »
...
Quand un événement Multi-administrateurs dépendants se produit
