# US-3321 — Détection signaux faibles détresse mentale

> 📌 **28. Procédures d'urgence** · Priorité **V2** · Plateforme **📱**

> 💬 **Note inventaire** : Sensible — opt-in patient
...
|---|---|
| **ID** | `US-3321` |
| **Référence inventaire** | `FNP-321` |
| **Domaine** | 28. Procédures d'urgence |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (heuristique + IA) |
...
La fonctionnalité « Détection signaux faibles détresse mentale » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Détection signaux faibles détresse mentale » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Détection signaux faibles détresse mentale » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Détection signaux faibles détresse mentale) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Détection signaux faibles détresse mentale »
...
```gherkin
Étant donné La fonctionnalité « Détection signaux faibles détresse mentale » est déclenchée (auto ou manuel)
...
Quand un événement Détection signaux faibles détresse mentale se produit
