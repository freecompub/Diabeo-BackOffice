# US-3328 — Procédure catastrophe / coupure élec
...
La fonctionnalité « Procédure catastrophe / coupure élec » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Procédure catastrophe / coupure élec » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Procédure catastrophe / coupure élec » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Procédure catastrophe / coupure élec) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Procédure catastrophe / coupure élec »
...
```gherkin
Étant donné La fonctionnalité « Procédure catastrophe / coupure élec » est déclenchée (auto ou manuel)
...
Quand un événement Procédure catastrophe / coupure élec se produit
