# US-3323 — Activation discrète détresse
...
La fonctionnalité « Activation discrète détresse » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Activation discrète détresse » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Activation discrète détresse » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Activation discrète détresse) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Activation discrète détresse »
...
```gherkin
Étant donné La fonctionnalité « Activation discrète détresse » est déclenchée (auto ou manuel)
...
Quand un événement Activation discrète détresse se produit
...
Quand elle utilise « Activation discrète détresse »
...
Quand « Activation discrète détresse » s'exécute pendant la journée de jeûne
