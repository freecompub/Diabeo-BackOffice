# US-3333 — Auto-formation périodique procédures
...
La fonctionnalité « Auto-formation périodique procédures » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Auto-formation périodique procédures » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Auto-formation périodique procédures » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Auto-formation périodique procédures) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Auto-formation périodique procédures »
...
```gherkin
Étant donné La fonctionnalité « Auto-formation périodique procédures » est déclenchée (auto ou manuel)
...
Quand un événement Auto-formation périodique procédures se produit
