# US-3320 — Procédure rotation forcée sites
...
La fonctionnalité « Procédure rotation forcée sites » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Procédure rotation forcée sites » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Procédure rotation forcée sites » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Procédure rotation forcée sites) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Procédure rotation forcée sites »
...
```gherkin
Étant donné La fonctionnalité « Procédure rotation forcée sites » est déclenchée (auto ou manuel)
...
Quand un événement Procédure rotation forcée sites se produit
...
Quand elle utilise « Procédure rotation forcée sites »
