# US-3327 — Procédure perte/vol matériel à l'étranger

> 📌 **28. Procédures d'urgence** · Priorité **V2** · Plateforme **📱**
...
|---|---|
| **ID** | `US-3327` |
| **Référence inventaire** | `FNP-327` |
| **Domaine** | 28. Procédures d'urgence |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Partiel |
| **Service / Standard** | Annuaires partenaires assurance |
| **Modèle économique** | Selon partenariat |
| **Coût estimé** | Variable |
| **Faisabilité France** | Direct |
| **Faisabilité Algérie** | Direct |
| **Story points (3 plateformes)** | iOS 2 · Android 2 · Web 1 |
| **Statut** | 🆕 À démarrer |
...
La fonctionnalité « Procédure perte/vol matériel à l'étranger » est exposée selon les conventions iOS :
...
### Effort estimé
**2 story points** (Fibonacci) sur la plateforme iOS
...
### Comportement utilisateur
La fonctionnalité « Procédure perte/vol matériel à l'étranger » suit les Material Design 3 guidelines :
...
### Effort estimé
**2 story points** (Fibonacci) sur la plateforme Android
...
### Comportement utilisateur
La version web de « Procédure perte/vol matériel à l'étranger » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Procédure perte/vol matériel à l'étranger) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Procédure perte/vol matériel à l'étranger »
...
```gherkin
Étant donné Le service « Annuaires partenaires assurance » est indisponible
...
```gherkin
Étant donné La fonctionnalité « Procédure perte/vol matériel à l'étranger » est déclenchée (auto ou manuel)
...
Quand un événement Procédure perte/vol matériel à l'étranger se produit
...
- **RM-6 : Aucun secret du fournisseur « Annuaires partenaires assurance » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Annuaires partenaires assurance** (à valider en kick-off)
