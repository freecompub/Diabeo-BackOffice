# US-3154 — Messages prédéfinis

> 📌 **11. Messagerie & notifs** · Priorité **V2** · Plateforme **📱🖥️**
...
La fonctionnalité « Messages prédéfinis » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Messages prédéfinis » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Messages prédéfinis » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Messages prédéfinis) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Messages prédéfinis »
...
Quand un événement Messages prédéfinis se produit
