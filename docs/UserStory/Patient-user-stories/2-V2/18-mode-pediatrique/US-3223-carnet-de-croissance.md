...
|---|---|
| **ID** | `US-3223` |
| **Référence inventaire** | `FNP-223` |
| **Domaine** | 18. Mode pédiatrique |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (référentiels OMS) |
| **Modèle économique** | Interne (open data) |
| **Coût estimé** | — |
...
La fonctionnalité « Carnet de croissance » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Carnet de croissance » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Carnet de croissance » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Carnet de croissance) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Carnet de croissance »
...
Quand un événement Carnet de croissance se produit
