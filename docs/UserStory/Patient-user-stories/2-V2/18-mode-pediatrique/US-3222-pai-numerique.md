# US-3222 — PAI numérique

> 📌 **18. Mode pédiatrique** · Priorité **V2** · Plateforme **📱🖥️**

> 💬 **Note inventaire** : FR: cadre PAI officiel
...
|---|---|
| **ID** | `US-3222` |
| **Référence inventaire** | `FNP-222` |
| **Domaine** | 18. Mode pédiatrique |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (template HAS) |
...
La fonctionnalité « PAI numérique » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « PAI numérique » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « PAI numérique » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (PAI numérique) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « PAI numérique »
...
Quand un événement PAI numérique se produit
