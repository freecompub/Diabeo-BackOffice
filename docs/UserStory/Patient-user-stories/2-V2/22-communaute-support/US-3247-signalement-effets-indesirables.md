# US-3247 — Signalement effets indésirables

> 📌 **22. Communauté & support** · Priorité **V2** · Plateforme **📱🖥️**

> 💬 **Note inventaire** : DZ: PCDPH
...
|---|---|
| **ID** | `US-3247` |
| **Référence inventaire** | `FNP-247` |
| **Domaine** | 22. Communauté & support |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱🖥️ |
...
La fonctionnalité « Signalement effets indésirables » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Signalement effets indésirables » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Signalement effets indésirables » est optimisée pour :
...
Quand il accède à la fonctionnalité « Signalement effets indésirables »
...
```gherkin
Étant donné Le service « Portail ANSM eRefMed » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Portail ANSM eRefMed » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Portail ANSM eRefMed** (à valider en kick-off)
