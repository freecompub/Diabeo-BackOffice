# US-3039 — Groupe sanguin

> 📌 **3. Profil patient** · Priorité **V2** · Plateforme **📱🖥️**
...
La fonctionnalité « Groupe sanguin » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Groupe sanguin » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Groupe sanguin » est optimisée pour :
...
Quand il accède à la fonctionnalité « Groupe sanguin »
