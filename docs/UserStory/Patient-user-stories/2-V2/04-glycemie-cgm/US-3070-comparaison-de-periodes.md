# US-3070 — Comparaison de périodes

> 📌 **4. Glycémie & CGM** · Priorité **V2** · Plateforme **📱🖥️**
...
La fonctionnalité « Comparaison de périodes » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Comparaison de périodes » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Comparaison de périodes » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Comparaison de périodes) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Comparaison de périodes »
...
Quand un événement Comparaison de périodes se produit
