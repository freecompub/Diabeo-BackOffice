# US-3071 — Partage temporaire courbe

> 📌 **4. Glycémie & CGM** · Priorité **V2** · Plateforme **📱➡️🖥️**
...
La fonctionnalité « Partage temporaire courbe » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Partage temporaire courbe » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Partage temporaire courbe » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Partage temporaire courbe) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Partage temporaire courbe »
...
Quand un événement Partage temporaire courbe se produit
