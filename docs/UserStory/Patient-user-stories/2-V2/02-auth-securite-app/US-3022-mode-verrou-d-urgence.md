# US-3022 — Mode verrou d'urgence

> 📌 **2. Auth & sécurité app** · Priorité **V2** · Plateforme **📱**

> 💬 **Note inventaire** : Sécurité personnelle (violences conjugales)
...
La fonctionnalité « Mode verrou d'urgence » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Mode verrou d'urgence » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Mode verrou d'urgence » est optimisée pour :
...
Quand il accède à la fonctionnalité « Mode verrou d'urgence »
