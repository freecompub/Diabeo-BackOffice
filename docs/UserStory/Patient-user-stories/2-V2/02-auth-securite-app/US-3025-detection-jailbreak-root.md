# US-3025 — Détection jailbreak/root
...
|---|---|
| **ID** | `US-3025` |
| **Référence inventaire** | `FNP-025` |
| **Domaine** | 2. Auth & sécurité app |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | DTTJailbreakDetection / RootBeer |
...
La fonctionnalité « Détection jailbreak/root » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Détection jailbreak/root » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Détection jailbreak/root » est optimisée pour :
...
Quand il accède à la fonctionnalité « Détection jailbreak/root »
...
```gherkin
Étant donné Le service « DTTJailbreakDetection / RootBeer » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « DTTJailbreakDetection / RootBeer » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **DTTJailbreakDetection / RootBeer** (à valider en kick-off)
