# US-3185 — CR hospitalisation

> 📌 **13. Documents & ordonnances** · Priorité **V2** · Plateforme **📱🖥️**
...
|---|---|
| **ID** | `US-3185` |
| **Référence inventaire** | `FNP-185` |
| **Domaine** | 13. Documents & ordonnances |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Partiel |
| **Service / Standard** | DMP (FR), manuel (DZ) |
...
La fonctionnalité « CR hospitalisation » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « CR hospitalisation » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « CR hospitalisation » est optimisée pour :
...
Quand il accède à la fonctionnalité « CR hospitalisation »
...
```gherkin
Étant donné Le service « DMP (FR), manuel (DZ) » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « DMP (FR), manuel (DZ) » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **DMP (FR), manuel (DZ)** (à valider en kick-off)
