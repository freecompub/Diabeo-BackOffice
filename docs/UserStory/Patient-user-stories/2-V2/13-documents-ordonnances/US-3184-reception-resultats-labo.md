# US-3184 — Réception résultats labo
...
|---|---|
| **ID** | `US-3184` |
| **Référence inventaire** | `FNP-184` |
| **Domaine** | 13. Documents & ordonnances |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Oui |
| **Service / Standard** | DMP/MES (FR), partenariat labo (DZ) |
...
La fonctionnalité « Réception résultats labo » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Réception résultats labo » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Réception résultats labo » est optimisée pour :
...
Quand il accède à la fonctionnalité « Réception résultats labo »
...
```gherkin
Étant donné Le service « DMP/MES (FR), partenariat labo (DZ) » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « DMP/MES (FR), partenariat labo (DZ) » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **DMP/MES (FR), partenariat labo (DZ)** (à valider en kick-off)
