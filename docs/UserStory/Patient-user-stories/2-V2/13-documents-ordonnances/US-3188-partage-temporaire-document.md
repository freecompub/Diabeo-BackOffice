# US-3188 — Partage temporaire document
...
|---|---|
| **ID** | `US-3188` |
| **Référence inventaire** | `FNP-188` |
| **Domaine** | 13. Documents & ordonnances |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (signed URL) |
...
La fonctionnalité « Partage temporaire document » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Partage temporaire document » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Partage temporaire document » est optimisée pour :
...
Quand il accède à la fonctionnalité « Partage temporaire document »
