# US-3187 — Numérisation papier OCR

> 📌 **13. Documents & ordonnances** · Priorité **V2** · Plateforme **📱**
...
|---|---|
| **ID** | `US-3187` |
| **Référence inventaire** | `FNP-187` |
| **Domaine** | 13. Documents & ordonnances |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | Caméra OS + Tesseract / Vision |
...
La fonctionnalité « Numérisation papier OCR » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Numérisation papier OCR » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Numérisation papier OCR » est optimisée pour :
...
Quand il accède à la fonctionnalité « Numérisation papier OCR »
...
```gherkin
Étant donné Le service « Caméra OS + Tesseract / Vision » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Caméra OS + Tesseract / Vision » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Caméra OS + Tesseract / Vision** (à valider en kick-off)
