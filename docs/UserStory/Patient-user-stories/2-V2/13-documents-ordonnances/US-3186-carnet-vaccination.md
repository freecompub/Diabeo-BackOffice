...
La fonctionnalité « Carnet vaccination » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Carnet vaccination » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Carnet vaccination » est optimisée pour :
...
Quand il accède à la fonctionnalité « Carnet vaccination »
