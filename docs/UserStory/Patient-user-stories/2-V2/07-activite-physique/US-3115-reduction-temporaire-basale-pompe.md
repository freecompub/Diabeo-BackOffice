# US-3115 — Réduction temporaire basale pompe
...
|---|---|
| **ID** | `US-3115` |
| **Référence inventaire** | `FNP-115` |
| **Domaine** | 7. Activité physique |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (validation médecin) |
...
La fonctionnalité « Réduction temporaire basale pompe » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Réduction temporaire basale pompe » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Réduction temporaire basale pompe » est optimisée pour :
...
Quand il accède à la fonctionnalité « Réduction temporaire basale pompe »
