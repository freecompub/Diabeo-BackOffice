# US-3112 — Détection auto activité
...
|---|---|
| **ID** | `US-3112` |
| **Référence inventaire** | `FNP-112` |
| **Domaine** | 7. Activité physique |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | HealthKit / Health Connect |
...
La fonctionnalité « Détection auto activité » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Détection auto activité » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Détection auto activité » est optimisée pour :
...
Quand il accède à la fonctionnalité « Détection auto activité »
...
```gherkin
Étant donné Le service « HealthKit / Health Connect » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « HealthKit / Health Connect » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **HealthKit / Health Connect** (à valider en kick-off)
