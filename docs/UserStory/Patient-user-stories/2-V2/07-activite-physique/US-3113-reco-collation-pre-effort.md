# US-3113 — Reco collation pré-effort
...
|---|---|
| **ID** | `US-3113` |
| **Référence inventaire** | `FNP-113` |
| **Domaine** | 7. Activité physique |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (algo + profil) |
...
La fonctionnalité « Reco collation pré-effort » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Reco collation pré-effort » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Reco collation pré-effort » est optimisée pour :
...
Quand il accède à la fonctionnalité « Reco collation pré-effort »
