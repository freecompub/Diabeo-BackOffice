# US-3271 — App native Apple Watch

> 📌 **26. Wearables étendus** · Priorité **V2** · Plateforme **📱**
...
|---|---|
| **ID** | `US-3271` |
| **Référence inventaire** | `FNP-271` |
| **Domaine** | 26. Wearables étendus |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | Apple WatchKit |
...
La fonctionnalité « App native Apple Watch » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « App native Apple Watch » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « App native Apple Watch » est optimisée pour :
...
Quand il accède à la fonctionnalité « App native Apple Watch »
...
```gherkin
Étant donné Le service « Apple WatchKit » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Apple WatchKit » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Apple WatchKit** (à valider en kick-off)
