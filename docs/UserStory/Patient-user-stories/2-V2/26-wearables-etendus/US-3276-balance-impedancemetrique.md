# US-3276 — Balance impédancemétrique
...
|---|---|
| **ID** | `US-3276` |
| **Référence inventaire** | `FNP-276` |
| **Domaine** | 26. Wearables étendus |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | Withings / Garmin |
...
La fonctionnalité « Balance impédancemétrique » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Balance impédancemétrique » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Balance impédancemétrique » est optimisée pour :
...
Quand il accède à la fonctionnalité « Balance impédancemétrique »
...
```gherkin
Étant donné Le service « Withings / Garmin » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Withings / Garmin » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Withings / Garmin** (à valider en kick-off)
