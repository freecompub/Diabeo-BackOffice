# US-3272 — App Wear OS / Watch Android
...
|---|---|
| **ID** | `US-3272` |
| **Référence inventaire** | `FNP-272` |
| **Domaine** | 26. Wearables étendus |
| **Priorité** | **V2** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | Wear OS SDK |
...
La fonctionnalité « App Wear OS / Watch Android » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « App Wear OS / Watch Android » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « App Wear OS / Watch Android » est optimisée pour :
...
Quand il accède à la fonctionnalité « App Wear OS / Watch Android »
...
```gherkin
Étant donné Le service « Wear OS SDK » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Wear OS SDK » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Wear OS SDK** (à valider en kick-off)
