# US-3207 — Programmes ETP structurés

> 📌 **16. ETP** · Priorité **V3** · Plateforme **📱🖥️**

> 💬 **Note inventaire** : FR: cadre HAS officiel
...
|---|---|
| **ID** | `US-3207` |
| **Référence inventaire** | `FNP-207` |
| **Domaine** | 16. ETP |
| **Priorité** | **V3** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (cadre HAS) |
...
La fonctionnalité « Programmes ETP structurés » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Programmes ETP structurés » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Programmes ETP structurés » est optimisée pour :
...
Quand il accède à la fonctionnalité « Programmes ETP structurés »
