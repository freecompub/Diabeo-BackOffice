# US-3194 — Commande directe en officine

> 📌 **14. Pharmacie & approvisionnement** · Priorité **V3** · Plateforme **📱**
...
|---|---|
| **ID** | `US-3194` |
| **Référence inventaire** | `FNP-194` |
| **Domaine** | 14. Pharmacie & approvisionnement |
| **Priorité** | **V3** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | Lifen / Pharmacie Connecté / API officine |
...
La fonctionnalité « Commande directe en officine » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Commande directe en officine » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Commande directe en officine » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Commande directe en officine) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Commande directe en officine »
...
```gherkin
Étant donné Le service « Lifen / Pharmacie Connecté / API officine » est indisponible
...
Quand un événement Commande directe en officine se produit
...
- **RM-6 : Aucun secret du fournisseur « Lifen / Pharmacie Connecté / API officine » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Lifen / Pharmacie Connecté / API officine** (à valider en kick-off)
