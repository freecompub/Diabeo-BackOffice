...
|---|---|
| **ID** | `US-3246` |
| **Référence inventaire** | `FNP-246` |
| **Domaine** | 22. Communauté & support |
| **Priorité** | **V3** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Partiel |
| **Service / Standard** | Discourse / interne |
...
La fonctionnalité « Groupes thématiques » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Groupes thématiques » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Groupes thématiques » est optimisée pour :
...
Quand il accède à la fonctionnalité « Groupes thématiques »
...
```gherkin
Étant donné Le service « Discourse / interne » est indisponible
...
Quand elle utilise « Groupes thématiques »
...
- **RM-6 : Aucun secret du fournisseur « Discourse / interne » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Discourse / interne** (à valider en kick-off)
