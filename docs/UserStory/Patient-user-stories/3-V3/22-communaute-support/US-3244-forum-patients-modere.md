# US-3244 — Forum patients modéré

> 📌 **22. Communauté & support** · Priorité **V3** · Plateforme **📱🖥️**
...
|---|---|
| **ID** | `US-3244` |
| **Référence inventaire** | `FNP-244` |
| **Domaine** | 22. Communauté & support |
| **Priorité** | **V3** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Partiel |
| **Service / Standard** | Discourse OSS / Circle / interne |
...
La fonctionnalité « Forum patients modéré » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Forum patients modéré » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Forum patients modéré » est optimisée pour :
...
Quand il accède à la fonctionnalité « Forum patients modéré »
...
```gherkin
Étant donné Le service « Discourse OSS / Circle / interne » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Discourse OSS / Circle / interne » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Discourse OSS / Circle / interne** (à valider en kick-off)
