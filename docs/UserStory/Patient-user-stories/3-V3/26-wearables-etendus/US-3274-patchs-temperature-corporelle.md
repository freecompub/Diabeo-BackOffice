# US-3274 — Patchs température corporelle

> 📌 **26. Wearables étendus** · Priorité **V3** · Plateforme **📱**
...
|---|---|
| **ID** | `US-3274` |
| **Référence inventaire** | `FNP-274` |
| **Domaine** | 26. Wearables étendus |
| **Priorité** | **V3** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | Tempdrop / partenariat |
...
La fonctionnalité « Patchs température corporelle » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Patchs température corporelle » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Patchs température corporelle » est optimisée pour :
...
Quand il accède à la fonctionnalité « Patchs température corporelle »
...
```gherkin
Étant donné Le service « Tempdrop / partenariat » est indisponible
...
Quand elle utilise « Patchs température corporelle »
...
- **RM-6 : Aucun secret du fournisseur « Tempdrop / partenariat » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Tempdrop / partenariat** (à valider en kick-off)
