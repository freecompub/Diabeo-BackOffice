# US-3273 — Anneaux connectés (Oura, Ultrahuman)
...
|---|---|
| **ID** | `US-3273` |
| **Référence inventaire** | `FNP-273` |
| **Domaine** | 26. Wearables étendus |
| **Priorité** | **V3** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | Oura API / Ultrahuman API |
...
La fonctionnalité « Anneaux connectés (Oura, Ultrahuman) » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Anneaux connectés (Oura, Ultrahuman) » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Anneaux connectés (Oura, Ultrahuman) » est optimisée pour :
...
Quand il accède à la fonctionnalité « Anneaux connectés (Oura, Ultrahuman) »
...
```gherkin
Étant donné Le service « Oura API / Ultrahuman API » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Oura API / Ultrahuman API » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Oura API / Ultrahuman API** (à valider en kick-off)
