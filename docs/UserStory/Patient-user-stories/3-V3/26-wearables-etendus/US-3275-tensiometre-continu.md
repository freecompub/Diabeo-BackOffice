...
|---|---|
| **ID** | `US-3275` |
| **Référence inventaire** | `FNP-275` |
| **Domaine** | 26. Wearables étendus |
| **Priorité** | **V3** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | Aktiia / Withings BPM Core |
...
La fonctionnalité « Tensiomètre continu » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Tensiomètre continu » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Tensiomètre continu » est optimisée pour :
...
Quand il accède à la fonctionnalité « Tensiomètre continu »
...
```gherkin
Étant donné Le service « Aktiia / Withings BPM Core » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Aktiia / Withings BPM Core » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Aktiia / Withings BPM Core** (à valider en kick-off)
