# US-3277 — Glucomètre non invasif (futur)

> 📌 **26. Wearables étendus** · Priorité **V3** · Plateforme **📱**

> 💬 **Note inventaire** : Marché émergent
...
|---|---|
| **ID** | `US-3277` |
| **Référence inventaire** | `FNP-277` |
| **Domaine** | 26. Wearables étendus |
| **Priorité** | **V3** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | À surveiller (DiaMonTech, GlucoTrack) |
...
La fonctionnalité « Glucomètre non invasif (futur) » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Glucomètre non invasif (futur) » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Glucomètre non invasif (futur) » est optimisée pour :
...
Quand il accède à la fonctionnalité « Glucomètre non invasif (futur) »
...
```gherkin
Étant donné Le service « À surveiller (DiaMonTech, GlucoTrack) » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « À surveiller (DiaMonTech, GlucoTrack) » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **À surveiller (DiaMonTech, GlucoTrack)** (à valider en kick-off)
