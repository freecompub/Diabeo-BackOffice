# US-3352 — Audio-description vidéos

> 📌 **30. Accessibilité avancée** · Priorité **V3** · Plateforme **📱🖥️**
...
|---|---|
| **ID** | `US-3352` |
| **Référence inventaire** | `FNP-352` |
| **Domaine** | 30. Accessibilité avancée |
| **Priorité** | **V3** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne / partenaire |
...
La fonctionnalité « Audio-description vidéos » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Audio-description vidéos » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Audio-description vidéos » est optimisée pour :
...
Quand il accède à la fonctionnalité « Audio-description vidéos »
