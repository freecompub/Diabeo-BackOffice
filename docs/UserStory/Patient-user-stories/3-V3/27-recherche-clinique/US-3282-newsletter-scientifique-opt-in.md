# US-3282 — Newsletter scientifique opt-in

> 📌 **27. Recherche clinique** · Priorité **V3** · Plateforme **📱🖥️**
...
|---|---|
| **ID** | `US-3282` |
| **Référence inventaire** | `FNP-282` |
| **Domaine** | 27. Recherche clinique |
| **Priorité** | **V3** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Oui |
| **Service / Standard** | Mailjet / Brevo / interne |
...
La fonctionnalité « Newsletter scientifique opt-in » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Newsletter scientifique opt-in » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Newsletter scientifique opt-in » est optimisée pour :
...
Quand il accède à la fonctionnalité « Newsletter scientifique opt-in »
...
```gherkin
Étant donné Le service « Mailjet / Brevo / interne » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Mailjet / Brevo / interne » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Mailjet / Brevo / interne** (à valider en kick-off)
