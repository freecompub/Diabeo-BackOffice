# US-3280 — Anonymisation données recherche
...
La fonctionnalité « Anonymisation données recherche » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Anonymisation données recherche » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Anonymisation données recherche » est optimisée pour :
...
Quand il accède à la fonctionnalité « Anonymisation données recherche »
