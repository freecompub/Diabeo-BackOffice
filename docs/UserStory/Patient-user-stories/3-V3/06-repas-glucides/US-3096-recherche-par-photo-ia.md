# US-3096 — Recherche par photo IA

> 📌 **6. Repas & glucides** · Priorité **V3** · Plateforme **📱**
...
|---|---|
| **ID** | `US-3096` |
| **Référence inventaire** | `FNP-096` |
| **Domaine** | 6. Repas & glucides |
| **Priorité** | **V3** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | Foodvisor / LogMeal / API maison |
| **Modèle économique** | Payant |
| **Coût estimé** | 0.01-0.05€/image |
...
La fonctionnalité « Recherche par photo IA » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Recherche par photo IA » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Recherche par photo IA » est optimisée pour :
...
Quand il accède à la fonctionnalité « Recherche par photo IA »
...
```gherkin
Étant donné Le service « Foodvisor / LogMeal / API maison » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Foodvisor / LogMeal / API maison » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Foodvisor / LogMeal / API maison** (à valider en kick-off)
