# US-3149 — Accès compte-rendu post-consult

> 📌 **10. Téléconsultation** · Priorité **V1** · Plateforme **📱🖥️**
...
La fonctionnalité « Accès compte-rendu post-consult » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Accès compte-rendu post-consult » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Accès compte-rendu post-consult » est optimisée pour :
...
Quand il accède à la fonctionnalité « Accès compte-rendu post-consult »
