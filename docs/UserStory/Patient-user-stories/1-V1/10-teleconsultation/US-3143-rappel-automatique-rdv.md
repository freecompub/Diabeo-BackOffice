# US-3143 — Rappel automatique RDV

> 📌 **10. Téléconsultation** · Priorité **V1** · Plateforme **📱**
...
|---|---|
| **ID** | `US-3143` |
| **Référence inventaire** | `FNP-143` |
| **Domaine** | 10. Téléconsultation |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | FCM / APNs + SMS optionnel |
...
La fonctionnalité « Rappel automatique RDV » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Rappel automatique RDV » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Rappel automatique RDV » est optimisée pour :
...
Quand il accède à la fonctionnalité « Rappel automatique RDV »
...
```gherkin
Étant donné Le service « FCM / APNs + SMS optionnel » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « FCM / APNs + SMS optionnel » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **FCM / APNs + SMS optionnel** (à valider en kick-off)
