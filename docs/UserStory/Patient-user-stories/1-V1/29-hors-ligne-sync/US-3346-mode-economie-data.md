# US-3346 — Mode économie data

> 📌 **29. Hors-ligne & sync** · Priorité **V1** · Plateforme **📱**

> 💬 **Note inventaire** : Important DZ (data coûteuse)
...
La fonctionnalité « Mode économie data » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Mode économie data » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Mode économie data » est optimisée pour :
...
Quand il accède à la fonctionnalité « Mode économie data »
...
Quand il utilise « Mode économie data »
