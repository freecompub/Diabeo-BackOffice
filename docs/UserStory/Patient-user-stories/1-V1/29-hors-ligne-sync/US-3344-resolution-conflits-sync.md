# US-3344 — Résolution conflits sync

> 📌 **29. Hors-ligne & sync** · Priorité **V1** · Plateforme **📱**
...
|---|---|
| **ID** | `US-3344` |
| **Référence inventaire** | `FNP-344` |
| **Domaine** | 29. Hors-ligne & sync |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (CRDT ou LWW) |
...
La fonctionnalité « Résolution conflits sync » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Résolution conflits sync » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Résolution conflits sync » est optimisée pour :
...
Quand il accède à la fonctionnalité « Résolution conflits sync »
...
Quand il utilise « Résolution conflits sync »
