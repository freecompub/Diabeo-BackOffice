# US-3252 — Taille de police

> 📌 **23. Préférences & perso** · Priorité **V1** · Plateforme **📱🖥️**
...
|---|---|
| **ID** | `US-3252` |
| **Référence inventaire** | `FNP-252` |
| **Domaine** | 23. Préférences & perso |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (Dynamic Type iOS) |
...
La fonctionnalité « Taille de police » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Taille de police » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Taille de police » est optimisée pour :
...
Quand il accède à la fonctionnalité « Taille de police »
