# US-3349 — Gros boutons mode urgence

> 📌 **30. Accessibilité avancée** · Priorité **V1** · Plateforme **📱**
...
La fonctionnalité « Gros boutons mode urgence » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Gros boutons mode urgence » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Gros boutons mode urgence » est optimisée pour :
...
Quand il accède à la fonctionnalité « Gros boutons mode urgence »
