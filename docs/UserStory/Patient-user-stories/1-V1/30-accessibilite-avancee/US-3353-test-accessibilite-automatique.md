# US-3353 — Test accessibilité automatique

> 📌 **30. Accessibilité avancée** · Priorité **V1** · Plateforme **🖥️**
...
|---|---|
| **ID** | `US-3353` |
| **Référence inventaire** | `FNP-353` |
| **Domaine** | 30. Accessibilité avancée |
| **Priorité** | **V1** |
| **Plateforme cible** | 🖥️ |
| **Intégration externe** | Oui |
| **Service / Standard** | axe-core OSS |
...
axe-core, Accessibility Inspector
...
La fonctionnalité « Test accessibilité automatique » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Test accessibilité automatique » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Test accessibilité automatique » est optimisée pour :
...
Quand il accède à la fonctionnalité « Test accessibilité automatique »
...
```gherkin
Étant donné Le service « axe-core OSS » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « axe-core OSS » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **axe-core OSS** (à valider en kick-off)
