# US-3226 — Invitation proche aidant
...
La fonctionnalité « Invitation proche aidant » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Invitation proche aidant » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Invitation proche aidant » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Invitation proche aidant) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Invitation proche aidant »
...
Quand un événement Invitation proche aidant se produit
