# US-3229 — Consentement explicite patient
...
La fonctionnalité « Consentement explicite patient » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Consentement explicite patient » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Consentement explicite patient » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Consentement explicite patient) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Consentement explicite patient »
...
Quand un événement Consentement explicite patient se produit
