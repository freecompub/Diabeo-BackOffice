# US-3227 — Niveaux de partage granulaires

> 📌 **19. Famille & aidants** · Priorité **V1** · Plateforme **📱🖥️**
...
La fonctionnalité « Niveaux de partage granulaires » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Niveaux de partage granulaires » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Niveaux de partage granulaires » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Niveaux de partage granulaires) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Niveaux de partage granulaires »
...
Quand un événement Niveaux de partage granulaires se produit
...
Quand elle utilise « Niveaux de partage granulaires »
