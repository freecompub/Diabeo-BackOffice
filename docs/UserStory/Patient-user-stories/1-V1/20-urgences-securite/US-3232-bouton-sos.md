...
|---|---|
| **ID** | `US-3232` |
| **Référence inventaire** | `FNP-232` |
| **Domaine** | 20. Urgences & sécurité |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | Téléphonie OS + GPS |
| **Modèle économique** | Gratuit (OS) |
| **Coût estimé** | Frais SMS optionnel |
...
La fonctionnalité « Bouton SOS » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Bouton SOS » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Bouton SOS » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Bouton SOS) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Bouton SOS »
...
```gherkin
Étant donné Le service « Téléphonie OS + GPS » est indisponible
...
Quand un événement Bouton SOS se produit
...
- **RM-6 : Aucun secret du fournisseur « Téléphonie OS + GPS » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Téléphonie OS + GPS** (à valider en kick-off)
