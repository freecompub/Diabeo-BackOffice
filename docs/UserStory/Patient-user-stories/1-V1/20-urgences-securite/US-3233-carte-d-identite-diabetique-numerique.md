# US-3233 — Carte d'identité diabétique numérique
...
La fonctionnalité « Carte d'identité diabétique numérique » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Carte d'identité diabétique numérique » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Carte d'identité diabétique numérique » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Carte d'identité diabétique numérique) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Carte d'identité diabétique numérique »
...
Quand un événement Carte d'identité diabétique numérique se produit
Alors les deux parents reçoivent la notification (push + email selon préférences) avec accusé de lecture
```

### AC-4 — Données chiffrées en local et en transit
