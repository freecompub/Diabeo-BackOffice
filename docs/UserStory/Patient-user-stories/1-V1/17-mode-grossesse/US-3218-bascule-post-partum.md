...
La fonctionnalité « Bascule post-partum » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Bascule post-partum » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Bascule post-partum » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Bascule post-partum) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Bascule post-partum »
...
Quand un événement Bascule post-partum se produit
...
Quand elle utilise « Bascule post-partum »
