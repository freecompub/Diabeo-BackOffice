# US-3238 — Lettre médicale type douanes

> 📌 **21. Voyages** · Priorité **V1** · Plateforme **📱➡️🖥️**
...
|---|---|
| **ID** | `US-3238` |
| **Référence inventaire** | `FNP-238` |
| **Domaine** | 21. Voyages |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱➡️🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (template multilingue) |
...
La fonctionnalité « Lettre médicale type douanes » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Lettre médicale type douanes » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Lettre médicale type douanes » est optimisée pour :
...
- **Lettre médicale multilingue** disponible avec la fonctionnalité (Lettre médicale type douanes) si pertinent (douanes, urgences à l'étranger)
...
Quand il accède à la fonctionnalité « Lettre médicale type douanes »
