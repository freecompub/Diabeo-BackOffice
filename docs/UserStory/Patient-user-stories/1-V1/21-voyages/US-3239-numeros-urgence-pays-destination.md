# US-3239 — Numéros urgence pays destination

> 📌 **21. Voyages** · Priorité **V1** · Plateforme **📱**
...
|---|---|
| **ID** | `US-3239` |
| **Référence inventaire** | `FNP-239` |
| **Domaine** | 21. Voyages |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Partiel |
| **Service / Standard** | Référentiel public (gratuit) |
...
La fonctionnalité « Numéros urgence pays destination » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Numéros urgence pays destination » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Numéros urgence pays destination » est optimisée pour :
...
- **Lettre médicale multilingue** disponible avec la fonctionnalité (Numéros urgence pays destination) si pertinent (douanes, urgences à l'étranger)
...
Quand il accède à la fonctionnalité « Numéros urgence pays destination »
...
```gherkin
Étant donné Le service « Référentiel public (gratuit) » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Référentiel public (gratuit) » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Référentiel public (gratuit)** (à valider en kick-off)
