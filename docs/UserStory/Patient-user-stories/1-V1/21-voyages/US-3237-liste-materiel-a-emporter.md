# US-3237 — Liste matériel à emporter

> 📌 **21. Voyages** · Priorité **V1** · Plateforme **📱🖥️**
...
La fonctionnalité « Liste matériel à emporter » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Liste matériel à emporter » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Liste matériel à emporter » est optimisée pour :
...
- **Lettre médicale multilingue** disponible avec la fonctionnalité (Liste matériel à emporter) si pertinent (douanes, urgences à l'étranger)
...
Quand il accède à la fonctionnalité « Liste matériel à emporter »
