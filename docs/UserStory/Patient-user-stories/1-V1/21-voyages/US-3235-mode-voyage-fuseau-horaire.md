# US-3235 — Mode voyage (fuseau horaire)
...
La fonctionnalité « Mode voyage (fuseau horaire) » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Mode voyage (fuseau horaire) » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Mode voyage (fuseau horaire) » est optimisée pour :
...
- **Lettre médicale multilingue** disponible avec la fonctionnalité (Mode voyage (fuseau horaire)) si pertinent (douanes, urgences à l'étranger)
...
Quand il accède à la fonctionnalité « Mode voyage (fuseau horaire) »
