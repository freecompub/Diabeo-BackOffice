# US-3004 — Vérification SMS

> 📌 **1. Onboarding** · Priorité **V1** · Plateforme **📱🖥️**

> 💬 **Note inventaire** : DZ: opérateurs locaux Djezzy/Mobilis/Ooredoo
...
|---|---|
| **ID** | `US-3004` |
| **Référence inventaire** | `FNP-004` |
| **Domaine** | 1. Onboarding |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Oui |
| **Service / Standard** | Twilio / OVH SMS / Vonage |
| **Modèle économique** | Payant unitaire |
| **Coût estimé** | 0.04-0.10€/SMS |
...
La fonctionnalité « Vérification SMS » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Vérification SMS » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Vérification SMS » est optimisée pour :
...
Quand il accède à la fonctionnalité « Vérification SMS »
...
```gherkin
Étant donné Le service « Twilio / OVH SMS / Vonage » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Twilio / OVH SMS / Vonage » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Twilio / OVH SMS / Vonage** (à valider en kick-off)
