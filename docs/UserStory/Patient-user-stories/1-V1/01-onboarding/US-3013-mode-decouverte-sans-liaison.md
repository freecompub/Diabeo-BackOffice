# US-3013 — Mode découverte sans liaison
...
La fonctionnalité « Mode découverte sans liaison » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Mode découverte sans liaison » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Mode découverte sans liaison » est optimisée pour :
...
Quand il accède à la fonctionnalité « Mode découverte sans liaison »
