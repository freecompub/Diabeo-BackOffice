# US-3009 — Tutoriel interactif premier usage

> 📌 **1. Onboarding** · Priorité **V1** · Plateforme **📱**
...
|---|---|
| **ID** | `US-3009` |
| **Référence inventaire** | `FNP-009` |
| **Domaine** | 1. Onboarding |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (Lottie) |
...
La fonctionnalité « Tutoriel interactif premier usage » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Tutoriel interactif premier usage » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Tutoriel interactif premier usage » est optimisée pour :
...
Quand il accède à la fonctionnalité « Tutoriel interactif premier usage »
