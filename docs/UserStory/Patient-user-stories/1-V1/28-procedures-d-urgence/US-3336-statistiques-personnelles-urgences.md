# US-3336 — Statistiques personnelles urgences
...
La fonctionnalité « Statistiques personnelles urgences » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Statistiques personnelles urgences » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Statistiques personnelles urgences » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Statistiques personnelles urgences) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Statistiques personnelles urgences »
...
```gherkin
Étant donné La fonctionnalité « Statistiques personnelles urgences » est déclenchée (auto ou manuel)
...
Quand un événement Statistiques personnelles urgences se produit
