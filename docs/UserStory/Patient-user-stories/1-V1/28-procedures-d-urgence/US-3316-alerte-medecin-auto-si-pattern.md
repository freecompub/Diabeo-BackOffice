# US-3316 — Alerte médecin auto si pattern
...
La fonctionnalité « Alerte médecin auto si pattern » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Alerte médecin auto si pattern » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Alerte médecin auto si pattern » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Alerte médecin auto si pattern) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Alerte médecin auto si pattern »
...
```gherkin
Étant donné La fonctionnalité « Alerte médecin auto si pattern » est déclenchée (auto ou manuel)
...
Quand un événement Alerte médecin auto si pattern se produit
...
Quand elle utilise « Alerte médecin auto si pattern »
...
Quand « Alerte médecin auto si pattern » s'exécute pendant la journée de jeûne
