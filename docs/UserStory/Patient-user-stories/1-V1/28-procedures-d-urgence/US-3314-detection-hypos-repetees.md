# US-3314 — Détection hypos répétées
...
|---|---|
| **ID** | `US-3314` |
| **Référence inventaire** | `FNP-314` |
| **Domaine** | 28. Procédures d'urgence |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (algo) |
...
La fonctionnalité « Détection hypos répétées » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Détection hypos répétées » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Détection hypos répétées » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Détection hypos répétées) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Détection hypos répétées »
...
```gherkin
Étant donné La fonctionnalité « Détection hypos répétées » est déclenchée (auto ou manuel)
...
Quand un événement Détection hypos répétées se produit
...
Quand elle utilise « Détection hypos répétées »
