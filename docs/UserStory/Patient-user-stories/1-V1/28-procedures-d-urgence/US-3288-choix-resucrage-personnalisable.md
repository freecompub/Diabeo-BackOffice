# US-3288 — Choix resucrage personnalisable
...
La fonctionnalité « Choix resucrage personnalisable » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Choix resucrage personnalisable » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Choix resucrage personnalisable » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Choix resucrage personnalisable) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Choix resucrage personnalisable »
...
```gherkin
Étant donné La fonctionnalité « Choix resucrage personnalisable » est déclenchée (auto ou manuel)
...
Quand un événement Choix resucrage personnalisable se produit
