# US-3300 — Reco hydratation forcée
...
La fonctionnalité « Reco hydratation forcée » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Reco hydratation forcée » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Reco hydratation forcée » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Reco hydratation forcée) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Reco hydratation forcée »
...
```gherkin
Étant donné La fonctionnalité « Reco hydratation forcée » est déclenchée (auto ou manuel)
...
Quand un événement Reco hydratation forcée se produit
