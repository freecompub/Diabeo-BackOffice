# US-3315 — Détection hypers répétées
...
La fonctionnalité « Détection hypers répétées » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Détection hypers répétées » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Détection hypers répétées » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Détection hypers répétées) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Détection hypers répétées »
...
```gherkin
Étant donné La fonctionnalité « Détection hypers répétées » est déclenchée (auto ou manuel)
...
Quand un événement Détection hypers répétées se produit
...
Quand elle utilise « Détection hypers répétées »
