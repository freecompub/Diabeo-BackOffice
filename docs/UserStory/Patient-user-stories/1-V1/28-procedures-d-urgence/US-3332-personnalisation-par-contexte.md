# US-3332 — Personnalisation par contexte

> 📌 **28. Procédures d'urgence** · Priorité **V1** · Plateforme **📱🖥️**
...
| **Story points (3 plateformes)** | iOS 1 · Android 1 · Web 1 |
| **Statut** | 🆕 À démarrer |
...
École/travail/sport/voyage/Ramadan
...
La fonctionnalité « Personnalisation par contexte » est exposée selon les conventions iOS :
...
### Effort estimé
**1 story points** (Fibonacci) sur la plateforme iOS
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, `Health Connect (Android 14+) + Google Fit fallback`
...
- `android.permission.health.READ_NUTRITION` (selon usage)

### Comportement utilisateur
La fonctionnalité « Personnalisation par contexte » suit les Material Design 3 guidelines :
...
### Effort estimé
**1 story points** (Fibonacci) sur la plateforme Android
...
- Pas d'équivalent HealthKit/Health Connect en web — données disponibles via backend uniquement

### Stratégies de fallback
- Aucun fallback nécessaire — fonctionnalité native web

### Comportement utilisateur
La version web de « Personnalisation par contexte » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Personnalisation par contexte) est envoyée simultanément au parent administrateur ET au parent secondaire
...
### ✈️ Mode voyage
- **Adaptation au fuseau horaire** : si décalage > 3h, recalcul progressif des schémas insuliniques (basale notamment pour pompes)
- **Lettre médicale multilingue** disponible avec la fonctionnalité (Personnalisation par contexte) si pertinent (douanes, urgences à l'étranger)
- **Numéros d'urgence locaux** affichés selon pays détecté
- **Mode "économie data"** automatique en roaming : sync moins fréquente
...
Quand il accède à la fonctionnalité « Personnalisation par contexte »
...
### AC-3 — Procédure d'urgence guidée pas-à-pas

```gherkin
Étant donné La fonctionnalité « Personnalisation par contexte » est déclenchée (auto ou manuel)
...
### AC-4 — Journal d'urgence immuable
