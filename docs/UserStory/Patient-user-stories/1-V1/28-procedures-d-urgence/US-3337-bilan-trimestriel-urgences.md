# US-3337 — Bilan trimestriel urgences

> 📌 **28. Procédures d'urgence** · Priorité **V1** · Plateforme **📱➡️🖥️**
...
|---|---|
| **ID** | `US-3337` |
| **Référence inventaire** | `FNP-337` |
| **Domaine** | 28. Procédures d'urgence |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱➡️🖥️ |
...
La fonctionnalité « Bilan trimestriel urgences » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Bilan trimestriel urgences » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Bilan trimestriel urgences » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Bilan trimestriel urgences) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Bilan trimestriel urgences »
...
```gherkin
Étant donné La fonctionnalité « Bilan trimestriel urgences » est déclenchée (auto ou manuel)
...
Quand un événement Bilan trimestriel urgences se produit
