# US-3301 — Reco activité physique légère
...
La fonctionnalité « Reco activité physique légère » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Reco activité physique légère » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Reco activité physique légère » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Reco activité physique légère) est envoyée simultanément au parent administrateur ET au parent secondaire
...
### 🏃 Mode sport / activité physique
- **Risque d'hypo post-effort** : la fonctionnalité doit prendre en compte une fenêtre de vigilance de 6-12h après une activité prolongée
- **Adaptation des cibles temporaires** : durant et après l'effort, seuils d'alerte ajustés
- **Reduction temporaire de basale** (utilisateurs pompe) : suggestion proactive avant un effort planifié
- **Recommandation collation pré-effort** : intégrée si glycémie pré-sport sous-optimale
...
Quand il accède à la fonctionnalité « Reco activité physique légère »
...
```gherkin
Étant donné La fonctionnalité « Reco activité physique légère » est déclenchée (auto ou manuel)
...
Quand un événement Reco activité physique légère se produit
