# US-3322 — Ressources crise mentale
...
|---|---|
| **ID** | `US-3322` |
| **Référence inventaire** | `FNP-322` |
| **Domaine** | 28. Procédures d'urgence |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (annuaire) |
...
La fonctionnalité « Ressources crise mentale » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Ressources crise mentale » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Ressources crise mentale » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Ressources crise mentale) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Ressources crise mentale »
...
```gherkin
Étant donné La fonctionnalité « Ressources crise mentale » est déclenchée (auto ou manuel)
...
Quand un événement Ressources crise mentale se produit
