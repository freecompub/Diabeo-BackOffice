# US-3318 — Procédure réaction allergique insuline
...
La fonctionnalité « Procédure réaction allergique insuline » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Procédure réaction allergique insuline » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Procédure réaction allergique insuline » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Procédure réaction allergique insuline) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Procédure réaction allergique insuline »
...
```gherkin
Étant donné La fonctionnalité « Procédure réaction allergique insuline » est déclenchée (auto ou manuel)
...
Quand un événement Procédure réaction allergique insuline se produit
...
Quand elle utilise « Procédure réaction allergique insuline »
