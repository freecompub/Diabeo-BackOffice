# US-3304 — Procédure hyper inexpliquée
...
Checklist matériel (cathéter, insuline)
...
La fonctionnalité « Procédure hyper inexpliquée » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Procédure hyper inexpliquée » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Procédure hyper inexpliquée » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Procédure hyper inexpliquée) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Procédure hyper inexpliquée »
...
```gherkin
Étant donné La fonctionnalité « Procédure hyper inexpliquée » est déclenchée (auto ou manuel)
...
Quand un événement Procédure hyper inexpliquée se produit
...
Quand elle utilise « Procédure hyper inexpliquée »
