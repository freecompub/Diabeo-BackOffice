...
La fonctionnalité « Multi-aidants » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Multi-aidants » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Multi-aidants » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Multi-aidants) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Multi-aidants »
...
Quand un événement Multi-aidants se produit
