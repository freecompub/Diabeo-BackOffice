# US-3091 — Saisie structurée par ingrédient

> 📌 **6. Repas & glucides** · Priorité **V1** · Plateforme **📱🖥️**

> 💬 **Note inventaire** : Web plus confortable
...
La fonctionnalité « Saisie structurée par ingrédient » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Saisie structurée par ingrédient » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Saisie structurée par ingrédient » est optimisée pour :
...
Quand il accède à la fonctionnalité « Saisie structurée par ingrédient »
