# US-3099 — Repas favori/récurrent
...
La fonctionnalité « Repas favori/récurrent » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Repas favori/récurrent » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Repas favori/récurrent » est optimisée pour :
...
Quand il accède à la fonctionnalité « Repas favori/récurrent »
