...
La fonctionnalité « Recherche par nom » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Recherche par nom » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Recherche par nom » est optimisée pour :
...
Quand il accède à la fonctionnalité « Recherche par nom »
