...
|---|---|
| **ID** | `US-3103` |
| **Référence inventaire** | `FNP-103` |
| **Domaine** | 6. Repas & glucides |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | Caméra OS + stockage S3 |
...
La fonctionnalité « Photo du repas » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Photo du repas » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Photo du repas » est optimisée pour :
...
Quand il accède à la fonctionnalité « Photo du repas »
...
```gherkin
Étant donné Le service « Caméra OS + stockage S3 » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Caméra OS + stockage S3 » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Caméra OS + stockage S3** (à valider en kick-off)
