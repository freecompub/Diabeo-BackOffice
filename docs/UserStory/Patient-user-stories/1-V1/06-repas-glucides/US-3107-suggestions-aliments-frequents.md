# US-3107 — Suggestions aliments fréquents
...
|---|---|
| **ID** | `US-3107` |
| **Référence inventaire** | `FNP-107` |
| **Domaine** | 6. Repas & glucides |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (heuristique) |
...
La fonctionnalité « Suggestions aliments fréquents » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Suggestions aliments fréquents » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Suggestions aliments fréquents » est optimisée pour :
...
Quand il accède à la fonctionnalité « Suggestions aliments fréquents »
