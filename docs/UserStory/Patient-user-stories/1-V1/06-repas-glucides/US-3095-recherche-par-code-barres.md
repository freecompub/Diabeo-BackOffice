# US-3095 — Recherche par code-barres

> 📌 **6. Repas & glucides** · Priorité **V1** · Plateforme **📱**

> 💬 **Note inventaire** : OFF couvre FR; DZ partiel
...
|---|---|
| **ID** | `US-3095` |
| **Référence inventaire** | `FNP-095` |
| **Domaine** | 6. Repas & glucides |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | Open Food Facts API + caméra OS |
| **Modèle économique** | Gratuit (OFF) + SDK natif |
| **Coût estimé** | Gratuit |
...
- **Langage** : Swift 5.9+
- **Frameworks** : `SwiftUI`, `Combine`, `AVFoundation`, `Vision (détection EAN/UPC native)`
...
La fonctionnalité « Recherche par code-barres » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Recherche par code-barres » suit les Material Design 3 guidelines :
...
- **Scan code-barres limité** : `BarcodeDetector` API non supportée par Safari/Firefox

### Stratégies de fallback
- Saisie manuelle ou recherche dans la bibliothèque d'aliments

### Comportement utilisateur
La version web de « Recherche par code-barres » est optimisée pour :
...
Quand il accède à la fonctionnalité « Recherche par code-barres »
...
```gherkin
Étant donné Le service « Open Food Facts API + caméra OS » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Open Food Facts API + caméra OS » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Open Food Facts API + caméra OS** (à valider en kick-off)
