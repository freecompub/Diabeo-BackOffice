# US-3092 — Bibliothèque aliments France

> 📌 **6. Repas & glucides** · Priorité **V1** · Plateforme **📱🖥️**
...
La fonctionnalité « Bibliothèque aliments France » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Bibliothèque aliments France » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Bibliothèque aliments France » est optimisée pour :
...
```gherkin
Étant donné Le service « CIQUAL (ANSES) / Open Food Facts » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « CIQUAL (ANSES) / Open Food Facts » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **CIQUAL (ANSES) / Open Food Facts** (à valider en kick-off)
