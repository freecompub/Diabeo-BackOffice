# US-3174 — Compatibility matrix

> 📌 **12. Dispositifs & connectivité** · Priorité **V1** · Plateforme **📱🖥️**
...
La fonctionnalité « Compatibility matrix » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Compatibility matrix » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Compatibility matrix » est optimisée pour :
...
Quand il accède à la fonctionnalité « Compatibility matrix »
