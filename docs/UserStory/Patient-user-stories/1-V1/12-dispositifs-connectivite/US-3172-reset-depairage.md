...
La fonctionnalité « Reset / dépairage » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Reset / dépairage » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Reset / dépairage » est optimisée pour :
...
Quand il accède à la fonctionnalité « Reset / dépairage »
