# US-3166 — Pairing lecteur glycémique connecté

> 📌 **12. Dispositifs & connectivité** · Priorité **V1** · Plateforme **📱**
...
|---|---|
| **ID** | `US-3166` |
| **Référence inventaire** | `FNP-166` |
| **Domaine** | 12. Dispositifs & connectivité |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | FORA / Roche / Accu-Chek SDK |
| **Modèle économique** | Selon fabricant |
...
La fonctionnalité « Pairing lecteur glycémique connecté » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Pairing lecteur glycémique connecté » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Pairing lecteur glycémique connecté » est optimisée pour :
...
Quand il accède à la fonctionnalité « Pairing lecteur glycémique connecté »
...
```gherkin
Étant donné Le service « FORA / Roche / Accu-Chek SDK » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « FORA / Roche / Accu-Chek SDK » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **FORA / Roche / Accu-Chek SDK** (à valider en kick-off)
