# US-3167 — Pairing pompe à insuline
...
|---|---|
| **ID** | `US-3167` |
| **Référence inventaire** | `FNP-167` |
| **Domaine** | 12. Dispositifs & connectivité |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | API fabricant |
| **Modèle économique** | Partenariat |
| **Coût estimé** | Négocié |
| **Faisabilité France** | Avec partenaire |
...
La fonctionnalité « Pairing pompe à insuline » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Pairing pompe à insuline » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Pairing pompe à insuline » est optimisée pour :
...
Quand il accède à la fonctionnalité « Pairing pompe à insuline »
...
```gherkin
Étant donné Le service « API fabricant » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « API fabricant » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **API fabricant** (à valider en kick-off)
