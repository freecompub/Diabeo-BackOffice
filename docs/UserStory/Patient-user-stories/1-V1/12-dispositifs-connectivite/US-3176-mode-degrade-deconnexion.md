# US-3176 — Mode dégradé déconnexion
...
La fonctionnalité « Mode dégradé déconnexion » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Mode dégradé déconnexion » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Mode dégradé déconnexion » est optimisée pour :
...
Quand il accède à la fonctionnalité « Mode dégradé déconnexion »
