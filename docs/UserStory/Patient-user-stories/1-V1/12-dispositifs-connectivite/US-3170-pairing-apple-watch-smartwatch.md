# US-3170 — Pairing Apple Watch / smartwatch
...
|---|---|
| **ID** | `US-3170` |
| **Référence inventaire** | `FNP-170` |
| **Domaine** | 12. Dispositifs & connectivité |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | WatchKit / Wear OS |
...
- **Langage** : Swift 5.9+
- **Frameworks** : `SwiftUI`, `Combine`, `CoreBluetooth`, `WatchKit + watchOS app companion`
...
La fonctionnalité « Pairing Apple Watch / smartwatch » est exposée selon les conventions iOS :
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, `Nordic BLE Library (recommandé) ou Android BluetoothLE`, `Wear OS Compose`
...
### Comportement utilisateur
La fonctionnalité « Pairing Apple Watch / smartwatch » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Pairing Apple Watch / smartwatch » est optimisée pour :
...
Quand il accède à la fonctionnalité « Pairing Apple Watch / smartwatch »
...
```gherkin
Étant donné Le service « WatchKit / Wear OS » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « WatchKit / Wear OS » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **WatchKit / Wear OS** (à valider en kick-off)
