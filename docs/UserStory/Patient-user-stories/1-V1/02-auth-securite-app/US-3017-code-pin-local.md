...
La fonctionnalité « Code PIN local » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Code PIN local » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Code PIN local » est optimisée pour :
...
Quand il accède à la fonctionnalité « Code PIN local »
