# US-3024 — Liste appareils connectés + révocation

> 📌 **2. Auth & sécurité app** · Priorité **V1** · Plateforme **📱🖥️**
...
La fonctionnalité « Liste appareils connectés + révocation » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Liste appareils connectés + révocation » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Liste appareils connectés + révocation » est optimisée pour :
...
Quand il accède à la fonctionnalité « Liste appareils connectés + révocation »
