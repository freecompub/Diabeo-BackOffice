# US-3018 — Verrouillage automatique inactivité

> 📌 **2. Auth & sécurité app** · Priorité **V1** · Plateforme **📱**
...
La fonctionnalité « Verrouillage automatique inactivité » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Verrouillage automatique inactivité » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Verrouillage automatique inactivité » est optimisée pour :
...
Quand il accède à la fonctionnalité « Verrouillage automatique inactivité »
