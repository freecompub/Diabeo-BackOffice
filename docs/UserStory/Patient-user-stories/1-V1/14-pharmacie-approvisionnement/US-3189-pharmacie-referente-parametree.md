# US-3189 — Pharmacie référente paramétrée

> 📌 **14. Pharmacie & approvisionnement** · Priorité **V1** · Plateforme **📱🖥️**
...
|---|---|
| **ID** | `US-3189` |
| **Référence inventaire** | `FNP-189` |
| **Domaine** | 14. Pharmacie & approvisionnement |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Partiel |
| **Service / Standard** | Annuaire CnamTS / manuel |
| **Modèle économique** | Gratuit / Interne |
| **Coût estimé** | — |
...
La fonctionnalité « Pharmacie référente paramétrée » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Pharmacie référente paramétrée » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Pharmacie référente paramétrée » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Pharmacie référente paramétrée) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Pharmacie référente paramétrée »
...
```gherkin
Étant donné Le service « Annuaire CnamTS / manuel » est indisponible
...
Quand un événement Pharmacie référente paramétrée se produit
...
- **RM-6 : Aucun secret du fournisseur « Annuaire CnamTS / manuel » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Annuaire CnamTS / manuel** (à valider en kick-off)
