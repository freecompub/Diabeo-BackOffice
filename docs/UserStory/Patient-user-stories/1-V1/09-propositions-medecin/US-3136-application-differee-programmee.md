# US-3136 — Application différée programmée

> 📌 **9. Propositions médecin** · Priorité **V1** · Plateforme **📱🖥️**
...
La fonctionnalité « Application différée programmée » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Application différée programmée » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Application différée programmée » est optimisée pour :
...
Quand il accède à la fonctionnalité « Application différée programmée »
