...
La fonctionnalité « Demande de précision » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Demande de précision » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Demande de précision » est optimisée pour :
...
Quand il accède à la fonctionnalité « Demande de précision »
