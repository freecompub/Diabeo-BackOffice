# US-3200 — Comparaison à l'objectif

> 📌 **15. Suivi & objectifs** · Priorité **V1** · Plateforme **📱🖥️**
...
La fonctionnalité « Comparaison à l'objectif » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Comparaison à l'objectif » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Comparaison à l'objectif » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Comparaison à l'objectif) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Comparaison à l'objectif »
...
Quand un événement Comparaison à l'objectif se produit
