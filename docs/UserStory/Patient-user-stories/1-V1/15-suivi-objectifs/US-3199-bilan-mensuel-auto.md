...
La fonctionnalité « Bilan mensuel auto » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Bilan mensuel auto » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Bilan mensuel auto » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Bilan mensuel auto) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Bilan mensuel auto »
...
Quand un événement Bilan mensuel auto se produit
