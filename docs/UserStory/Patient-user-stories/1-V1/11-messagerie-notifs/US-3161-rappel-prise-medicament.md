# US-3161 — Rappel prise médicament
...
|---|---|
| **ID** | `US-3161` |
| **Référence inventaire** | `FNP-161` |
| **Domaine** | 11. Messagerie & notifs |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | FCM / APNs + Calendar |
...
La fonctionnalité « Rappel prise médicament » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Rappel prise médicament » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Rappel prise médicament » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Rappel prise médicament) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Rappel prise médicament »
...
```gherkin
Étant donné Le service « FCM / APNs + Calendar » est indisponible
...
Quand un événement Rappel prise médicament se produit
...
- **RM-6 : Aucun secret du fournisseur « FCM / APNs + Calendar » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **FCM / APNs + Calendar** (à valider en kick-off)
