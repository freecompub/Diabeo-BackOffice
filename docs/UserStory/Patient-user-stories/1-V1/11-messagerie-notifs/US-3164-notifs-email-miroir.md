...
|---|---|
| **ID** | `US-3164` |
| **Référence inventaire** | `FNP-164` |
| **Domaine** | 11. Messagerie & notifs |
| **Priorité** | **V1** |
| **Plateforme cible** | 🖥️ |
| **Intégration externe** | Oui |
| **Service / Standard** | Email provider |
...
La fonctionnalité « Notifs email miroir » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Notifs email miroir » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Notifs email miroir » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Notifs email miroir) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Notifs email miroir »
...
```gherkin
Étant donné Le service « Email provider » est indisponible
...
Quand un événement Notifs email miroir se produit
...
- **RM-6 : Aucun secret du fournisseur « Email provider » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Email provider** (à valider en kick-off)
