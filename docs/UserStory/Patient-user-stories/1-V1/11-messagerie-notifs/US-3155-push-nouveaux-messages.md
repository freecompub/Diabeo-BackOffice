# US-3155 — Push nouveaux messages
...
La fonctionnalité « Push nouveaux messages » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Push nouveaux messages » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Push nouveaux messages » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Push nouveaux messages) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Push nouveaux messages »
...
Quand un événement Push nouveaux messages se produit
