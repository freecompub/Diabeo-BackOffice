...
La fonctionnalité « Indicateurs vu/lu » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Indicateurs vu/lu » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Indicateurs vu/lu » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Indicateurs vu/lu) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Indicateurs vu/lu »
...
Quand un événement Indicateurs vu/lu se produit
