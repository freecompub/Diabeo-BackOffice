# US-3153 — Pièces jointes (photo, PDF, audio)

> 📌 **11. Messagerie & notifs** · Priorité **V1** · Plateforme **📱🖥️**
...
|---|---|
| **ID** | `US-3153` |
| **Référence inventaire** | `FNP-153` |
| **Domaine** | 11. Messagerie & notifs |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Oui |
| **Service / Standard** | OVH Object Storage / MinIO |
| **Modèle économique** | Variable |
| **Coût estimé** | ~0.01€/Go/mois |
| **Faisabilité France** | Direct |
| **Faisabilité Algérie** | Direct |
| **Story points (3 plateformes)** | iOS 5 · Android 5 · Web 3 |
| **Statut** | 🆕 À démarrer |
...
La fonctionnalité « Pièces jointes (photo, PDF, audio) » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Pièces jointes (photo, PDF, audio) » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Pièces jointes (photo, PDF, audio) » est optimisée pour :
...
### Effort estimé
**3 story points** (Fibonacci) sur la plateforme Web
...
- **Notifications doublées** : toute alerte critique (Pièces jointes (photo, PDF, audio)) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Pièces jointes (photo, PDF, audio) »
...
```gherkin
Étant donné Le service « OVH Object Storage / MinIO » est indisponible
...
Quand un événement Pièces jointes (photo, PDF, audio) se produit
...
- **RM-6 : Aucun secret du fournisseur « OVH Object Storage / MinIO » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **OVH Object Storage / MinIO** (à valider en kick-off)
