...
La fonctionnalité « Mode Ne pas déranger » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Mode Ne pas déranger » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Mode Ne pas déranger » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Mode Ne pas déranger) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Mode Ne pas déranger »
...
Quand un événement Mode Ne pas déranger se produit
