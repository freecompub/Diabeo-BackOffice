# US-3162 — Rappel changement capteur

> 📌 **11. Messagerie & notifs** · Priorité **V1** · Plateforme **📱**
...
La fonctionnalité « Rappel changement capteur » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Rappel changement capteur » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Rappel changement capteur » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Rappel changement capteur) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Rappel changement capteur »
...
Quand un événement Rappel changement capteur se produit
