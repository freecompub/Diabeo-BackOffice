...
|---|---|
| **ID** | `US-3057` |
| **Référence inventaire** | `FNP-057` |
| **Domaine** | 4. Glycémie & CGM |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (algo IDC) |
...
La fonctionnalité « Profil AGP perso » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Profil AGP perso » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Profil AGP perso » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Profil AGP perso) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Profil AGP perso »
...
Quand un événement Profil AGP perso se produit
