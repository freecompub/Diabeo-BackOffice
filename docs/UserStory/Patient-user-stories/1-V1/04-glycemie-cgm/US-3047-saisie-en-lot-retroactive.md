# US-3047 — Saisie en lot rétroactive
...
La fonctionnalité « Saisie en lot rétroactive » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Saisie en lot rétroactive » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Saisie en lot rétroactive » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Saisie en lot rétroactive) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Saisie en lot rétroactive »
...
Quand un événement Saisie en lot rétroactive se produit
