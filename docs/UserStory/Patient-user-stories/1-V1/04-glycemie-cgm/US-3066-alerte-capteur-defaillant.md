# US-3066 — Alerte capteur défaillant
...
|---|---|
| **ID** | `US-3066` |
| **Référence inventaire** | `FNP-066` |
| **Domaine** | 4. Glycémie & CGM |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (analyse signal) |
...
La fonctionnalité « Alerte capteur défaillant » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Alerte capteur défaillant » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Alerte capteur défaillant » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Alerte capteur défaillant) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Alerte capteur défaillant »
...
Quand un événement Alerte capteur défaillant se produit
...
Quand elle utilise « Alerte capteur défaillant »
...
Quand « Alerte capteur défaillant » s'exécute pendant la journée de jeûne
