# US-3068 — Annotation point glycémique

> 📌 **4. Glycémie & CGM** · Priorité **V1** · Plateforme **📱🖥️**
...
La fonctionnalité « Annotation point glycémique » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Annotation point glycémique » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Annotation point glycémique » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Annotation point glycémique) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Annotation point glycémique »
...
Quand un événement Annotation point glycémique se produit
