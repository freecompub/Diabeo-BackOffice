# US-3050 — Ingestion Medtronic Guardian
...
|---|---|
| **ID** | `US-3050` |
| **Référence inventaire** | `FNP-050` |
| **Domaine** | 4. Glycémie & CGM |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | Medtronic CareLink API |
| **Modèle économique** | Partenariat |
| **Coût estimé** | Négocié Medtronic |
...
La fonctionnalité « Ingestion Medtronic Guardian » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Ingestion Medtronic Guardian » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Ingestion Medtronic Guardian » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Ingestion Medtronic Guardian) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Ingestion Medtronic Guardian »
...
```gherkin
Étant donné Le service « Medtronic CareLink API » est indisponible
...
Quand un événement Ingestion Medtronic Guardian se produit
...
- **RM-6 : Aucun secret du fournisseur « Medtronic CareLink API » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Medtronic CareLink API** (à valider en kick-off)
