# US-3060 — Coefficient de variation
...
La fonctionnalité « Coefficient de variation » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Coefficient de variation » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Coefficient de variation » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Coefficient de variation) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Coefficient de variation »
...
Quand un événement Coefficient de variation se produit
