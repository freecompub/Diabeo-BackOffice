# US-3053 — Affichage temps réel widget
...
|---|---|
| **ID** | `US-3053` |
| **Référence inventaire** | `FNP-053` |
| **Domaine** | 4. Glycémie & CGM |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | iOS WidgetKit / Android Glance |
...
Home Screen widget iOS, Glance Android
...
La fonctionnalité « Affichage temps réel widget » est exposée selon les conventions iOS :
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, `Jetpack Glance (composables widgets)`
...
### Comportement utilisateur
La fonctionnalité « Affichage temps réel widget » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Affichage temps réel widget » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Affichage temps réel widget) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Affichage temps réel widget »
...
```gherkin
Étant donné Le service « iOS WidgetKit / Android Glance » est indisponible
...
Quand un événement Affichage temps réel widget se produit
...
- **RM-6 : Aucun secret du fournisseur « iOS WidgetKit / Android Glance » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **iOS WidgetKit / Android Glance** (à valider en kick-off)
