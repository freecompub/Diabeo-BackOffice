# US-3125 — Note libre journalière
...
|---|---|
| **ID** | `US-3125` |
| **Référence inventaire** | `FNP-125` |
| **Domaine** | 8. Événements & journal |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (chiffré) |
...
La fonctionnalité « Note libre journalière » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Note libre journalière » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Note libre journalière » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Note libre journalière) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Note libre journalière »
...
Quand un événement Note libre journalière se produit
