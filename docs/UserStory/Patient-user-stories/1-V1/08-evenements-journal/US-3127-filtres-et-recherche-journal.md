# US-3127 — Filtres et recherche journal

> 📌 **8. Événements & journal** · Priorité **V1** · Plateforme **📱🖥️**
...
La fonctionnalité « Filtres et recherche journal » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Filtres et recherche journal » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Filtres et recherche journal » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Filtres et recherche journal) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Filtres et recherche journal »
...
Quand un événement Filtres et recherche journal se produit
