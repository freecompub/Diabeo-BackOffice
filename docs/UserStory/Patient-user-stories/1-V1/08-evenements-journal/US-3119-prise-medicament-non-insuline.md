# US-3119 — Prise médicament non insuline

> 📌 **8. Événements & journal** · Priorité **V1** · Plateforme **📱**
...
|---|---|
| **ID** | `US-3119` |
| **Référence inventaire** | `FNP-119` |
| **Domaine** | 8. Événements & journal |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Partiel |
| **Service / Standard** | BdM (cf prescription) |
| **Modèle économique** | Selon source |
...
La fonctionnalité « Prise médicament non insuline » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Prise médicament non insuline » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Prise médicament non insuline » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Prise médicament non insuline) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Prise médicament non insuline »
...
```gherkin
Étant donné Le service « BdM (cf prescription) » est indisponible
...
Quand un événement Prise médicament non insuline se produit
...
Quand elle utilise « Prise médicament non insuline »
...
- **RM-6 : Aucun secret du fournisseur « BdM (cf prescription) » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **BdM (cf prescription)** (à valider en kick-off)
