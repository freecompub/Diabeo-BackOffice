# US-3268 — Bascule auto pays

> 📌 **25. Multi-pays** · Priorité **V1** · Plateforme **📱🖥️**
...
|---|---|
| **ID** | `US-3268` |
| **Référence inventaire** | `FNP-268` |
| **Domaine** | 25. Multi-pays |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Oui |
| **Service / Standard** | GeoIP / settings OS |
...
- **Langage** : Swift 5.9+
- **Frameworks** : `SwiftUI`, `Combine`, `CoreData (cache local chiffré)`
...
La fonctionnalité « Bascule auto pays » est exposée selon les conventions iOS :
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, `Room (cache chiffré via SQLCipher) + WorkManager pour sync différée`
...
### Comportement utilisateur
La fonctionnalité « Bascule auto pays » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Bascule auto pays » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Bascule auto pays) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Bascule auto pays »
...
```gherkin
Étant donné Le service « GeoIP / settings OS » est indisponible
...
Quand un événement Bascule auto pays se produit
...
- **RM-6 : Aucun secret du fournisseur « GeoIP / settings OS » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **GeoIP / settings OS** (à valider en kick-off)
