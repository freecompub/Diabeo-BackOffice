# US-3266 — Version Algérie complète

> 📌 **25. Multi-pays** · Priorité **V1** · Plateforme **📱🖥️**

> 💬 **Note inventaire** : Plusieurs partenariats locaux nécessaires
...
|---|---|
| **ID** | `US-3266` |
| **Référence inventaire** | `FNP-266` |
| **Domaine** | 25. Multi-pays |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Partiel |
| **Service / Standard** | Référentiels DZ à constituer |
...
La fonctionnalité « Version Algérie complète » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Version Algérie complète » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Version Algérie complète » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Version Algérie complète) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Version Algérie complète »
...
```gherkin
Étant donné Le service « Référentiels DZ à constituer » est indisponible
...
Quand un événement Version Algérie complète se produit
...
- **RM-6 : Aucun secret du fournisseur « Référentiels DZ à constituer » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Référentiels DZ à constituer** (à valider en kick-off)
