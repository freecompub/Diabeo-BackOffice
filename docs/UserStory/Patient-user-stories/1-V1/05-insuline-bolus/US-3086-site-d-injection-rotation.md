# US-3086 — Site d'injection (rotation)

> 📌 **5. Insuline & bolus** · Priorité **V1** · Plateforme **📱**

> 💬 **Note inventaire** : Prévention lipodystrophies
...
La fonctionnalité « Site d'injection (rotation) » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Site d'injection (rotation) » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Site d'injection (rotation) » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Site d'injection (rotation)) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Site d'injection (rotation) »
...
Quand un événement Site d'injection (rotation) se produit
