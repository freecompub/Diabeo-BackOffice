...
|---|---|
| **ID** | `US-3083` |
| **Référence inventaire** | `FNP-083` |
| **Domaine** | 5. Insuline & bolus |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (cron + heuristique) |
...
La fonctionnalité « Alerte oubli de bolus » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Alerte oubli de bolus » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Alerte oubli de bolus » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Alerte oubli de bolus) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Alerte oubli de bolus »
...
Quand un événement Alerte oubli de bolus se produit
...
Quand elle utilise « Alerte oubli de bolus »
...
Quand « Alerte oubli de bolus » s'exécute pendant la journée de jeûne
