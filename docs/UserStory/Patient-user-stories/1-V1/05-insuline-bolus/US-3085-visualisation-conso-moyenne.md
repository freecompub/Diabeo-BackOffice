# US-3085 — Visualisation conso moyenne

> 📌 **5. Insuline & bolus** · Priorité **V1** · Plateforme **📱🖥️**
...
La fonctionnalité « Visualisation conso moyenne » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Visualisation conso moyenne » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Visualisation conso moyenne » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Visualisation conso moyenne) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Visualisation conso moyenne »
...
Quand un événement Visualisation conso moyenne se produit
