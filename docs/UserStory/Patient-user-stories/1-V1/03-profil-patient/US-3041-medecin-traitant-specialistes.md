# US-3041 — Médecin traitant + spécialistes
...
|---|---|
| **ID** | `US-3041` |
| **Référence inventaire** | `FNP-041` |
| **Domaine** | 3. Profil patient |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Partiel |
| **Service / Standard** | Annuaire Santé ANS (FR) |
| **Modèle économique** | Gratuit (ROR) |
| **Coût estimé** | — |
...
La fonctionnalité « Médecin traitant + spécialistes » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Médecin traitant + spécialistes » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Médecin traitant + spécialistes » est optimisée pour :
...
Quand il accède à la fonctionnalité « Médecin traitant + spécialistes »
...
```gherkin
Étant donné Le service « Annuaire Santé ANS (FR) » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Annuaire Santé ANS (FR) » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Annuaire Santé ANS (FR)** (à valider en kick-off)
