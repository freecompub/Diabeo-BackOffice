# US-3045 — Profil enfant + parent

> 📌 **3. Profil patient** · Priorité **V1** · Plateforme **📱🖥️**

> 💬 **Note inventaire** : Cas d'usage clé Diabeo
...
Mode pédiatrique multi-aidants
...
La fonctionnalité « Profil enfant + parent » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Profil enfant + parent » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Profil enfant + parent » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Profil enfant + parent) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Profil enfant + parent »
...
Quand un événement Profil enfant + parent se produit
