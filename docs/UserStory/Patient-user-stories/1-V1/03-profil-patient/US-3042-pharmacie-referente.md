...
|---|---|
| **ID** | `US-3042` |
| **Référence inventaire** | `FNP-042` |
| **Domaine** | 3. Profil patient |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Partiel |
| **Service / Standard** | Annuaire pharmacies (FR: Cnam) |
...
La fonctionnalité « Pharmacie référente » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Pharmacie référente » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Pharmacie référente » est optimisée pour :
...
Quand il accède à la fonctionnalité « Pharmacie référente »
...
```gherkin
Étant donné Le service « Annuaire pharmacies (FR: Cnam) » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Annuaire pharmacies (FR: Cnam) » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Annuaire pharmacies (FR: Cnam)** (à valider en kick-off)
