# US-3037 — Traitements en cours non insuline

> 📌 **3. Profil patient** · Priorité **V1** · Plateforme **📱🖥️**

> 💬 **Note inventaire** : DZ: référentiel LNCPP
...
|---|---|
| **ID** | `US-3037` |
| **Référence inventaire** | `FNP-037` |
| **Domaine** | 3. Profil patient |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Partiel |
| **Service / Standard** | Référentiel BdM (cf prescription) |
...
La fonctionnalité « Traitements en cours non insuline » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Traitements en cours non insuline » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Traitements en cours non insuline » est optimisée pour :
...
Quand il accède à la fonctionnalité « Traitements en cours non insuline »
...
```gherkin
Étant donné Le service « Référentiel BdM (cf prescription) » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Référentiel BdM (cf prescription) » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Référentiel BdM (cf prescription)** (à valider en kick-off)
