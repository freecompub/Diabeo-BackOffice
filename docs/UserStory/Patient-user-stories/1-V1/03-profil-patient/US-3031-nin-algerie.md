...
Numéro national identification
...
La fonctionnalité « NIN (Algérie) » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « NIN (Algérie) » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « NIN (Algérie) » est optimisée pour :
...
Quand il accède à la fonctionnalité « NIN (Algérie) »
