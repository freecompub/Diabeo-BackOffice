...
|---|---|
| **ID** | `US-3036` |
| **Référence inventaire** | `FNP-036` |
| **Domaine** | 3. Profil patient |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (CIM-10) |
...
La fonctionnalité « Comorbidités » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Comorbidités » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Comorbidités » est optimisée pour :
...
Quand il accède à la fonctionnalité « Comorbidités »
