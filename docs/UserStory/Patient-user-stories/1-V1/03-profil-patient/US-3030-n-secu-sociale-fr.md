...
NIR pour facturation tiers payant
...
La fonctionnalité « N° Sécu sociale (FR) » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « N° Sécu sociale (FR) » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « N° Sécu sociale (FR) » est optimisée pour :
...
Quand il accède à la fonctionnalité « N° Sécu sociale (FR) »
