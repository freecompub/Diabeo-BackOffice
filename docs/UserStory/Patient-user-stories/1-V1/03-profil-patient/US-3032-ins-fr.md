...
La fonctionnalité « INS (FR) » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « INS (FR) » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « INS (FR) » est optimisée pour :
...
Quand il accède à la fonctionnalité « INS (FR) »
...
```gherkin
Étant donné Le service « ANS Téléservice INSi » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « ANS Téléservice INSi » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **ANS Téléservice INSi** (à valider en kick-off)
