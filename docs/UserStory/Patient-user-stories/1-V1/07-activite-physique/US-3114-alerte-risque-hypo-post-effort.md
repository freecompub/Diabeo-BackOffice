# US-3114 — Alerte risque hypo post-effort
...
- **Langage** : Swift 5.9+
- **Frameworks** : `SwiftUI`, `Combine`, `UserNotifications`, `HealthKit`
...
La fonctionnalité « Alerte risque hypo post-effort » est exposée selon les conventions iOS :
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, `Firebase Cloud Messaging (FCM)`, `Health Connect (Android 14+) + Google Fit fallback`
...
### Comportement utilisateur
La fonctionnalité « Alerte risque hypo post-effort » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Alerte risque hypo post-effort » est optimisée pour :
...
Quand il accède à la fonctionnalité « Alerte risque hypo post-effort »
