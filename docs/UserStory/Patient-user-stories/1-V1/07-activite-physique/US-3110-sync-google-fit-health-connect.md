# US-3110 — Sync Google Fit / Health Connect
...
|---|---|
| **ID** | `US-3110` |
| **Référence inventaire** | `FNP-110` |
| **Domaine** | 7. Activité physique |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | Google Fit / Health Connect |
...
La fonctionnalité « Sync Google Fit / Health Connect » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Sync Google Fit / Health Connect » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Sync Google Fit / Health Connect » est optimisée pour :
...
Quand il accède à la fonctionnalité « Sync Google Fit / Health Connect »
...
```gherkin
Étant donné Le service « Google Fit / Health Connect » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Google Fit / Health Connect » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Google Fit / Health Connect** (à valider en kick-off)
