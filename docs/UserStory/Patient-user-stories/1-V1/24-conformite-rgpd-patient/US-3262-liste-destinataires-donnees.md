# US-3262 — Liste destinataires données
...
La fonctionnalité « Liste destinataires données » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Liste destinataires données » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Liste destinataires données » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Liste destinataires données) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Liste destinataires données »
...
Quand un événement Liste destinataires données se produit
