# US-3243 — Support technique chat/email

> 📌 **22. Communauté & support** · Priorité **V1** · Plateforme **📱🖥️**
...
|---|---|
| **ID** | `US-3243` |
| **Référence inventaire** | `FNP-243` |
| **Domaine** | 22. Communauté & support |
| **Priorité** | **V1** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Oui |
| **Service / Standard** | Crisp / Intercom / Zendesk |
...
La fonctionnalité « Support technique chat/email » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Support technique chat/email » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Support technique chat/email » est optimisée pour :
...
Quand il accède à la fonctionnalité « Support technique chat/email »
...
```gherkin
Étant donné Le service « Crisp / Intercom / Zendesk » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Crisp / Intercom / Zendesk » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Crisp / Intercom / Zendesk** (à valider en kick-off)
