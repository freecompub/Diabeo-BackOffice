...
La fonctionnalité « FAQ produit + maladie » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « FAQ produit + maladie » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « FAQ produit + maladie » est optimisée pour :
...
Quand il accède à la fonctionnalité « FAQ produit + maladie »
