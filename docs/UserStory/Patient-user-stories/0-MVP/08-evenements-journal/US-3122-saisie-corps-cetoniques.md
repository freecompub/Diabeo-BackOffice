# US-3122 — Saisie corps cétoniques

> 📌 **8. Événements & journal** · Priorité **MVP** · Plateforme **📱**

> 💬 **Note inventaire** : Critique T1
...
La fonctionnalité « Saisie corps cétoniques » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Saisie corps cétoniques » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Saisie corps cétoniques » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Saisie corps cétoniques) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Saisie corps cétoniques »
...
Quand un événement Saisie corps cétoniques se produit
