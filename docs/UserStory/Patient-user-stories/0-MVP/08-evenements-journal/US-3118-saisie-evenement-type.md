...
Maladie, stress, règles, voyage, alcool
...
La fonctionnalité « Saisie événement type » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Saisie événement type » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Saisie événement type » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Saisie événement type) est envoyée simultanément au parent administrateur ET au parent secondaire
...
- **Lettre médicale multilingue** disponible avec la fonctionnalité (Saisie événement type) si pertinent (douanes, urgences à l'étranger)
...
Quand il accède à la fonctionnalité « Saisie événement type »
...
Quand un événement Saisie événement type se produit
