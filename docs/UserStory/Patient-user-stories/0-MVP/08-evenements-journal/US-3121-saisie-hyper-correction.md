# US-3121 — Saisie hyper + correction

> 📌 **8. Événements & journal** · Priorité **MVP** · Plateforme **📱**
...
La fonctionnalité « Saisie hyper + correction » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Saisie hyper + correction » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Saisie hyper + correction » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Saisie hyper + correction) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Saisie hyper + correction »
...
Quand un événement Saisie hyper + correction se produit
...
Quand elle utilise « Saisie hyper + correction »
