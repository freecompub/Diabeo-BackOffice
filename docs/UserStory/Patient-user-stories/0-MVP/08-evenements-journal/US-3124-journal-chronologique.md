# US-3124 — Journal chronologique

> 📌 **8. Événements & journal** · Priorité **MVP** · Plateforme **📱🖥️**
...
La fonctionnalité « Journal chronologique » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Journal chronologique » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Journal chronologique » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Journal chronologique) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Journal chronologique »
...
Quand un événement Journal chronologique se produit
