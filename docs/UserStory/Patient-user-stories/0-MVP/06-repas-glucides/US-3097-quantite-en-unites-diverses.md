# US-3097 — Quantité en unités diverses

> 📌 **6. Repas & glucides** · Priorité **MVP** · Plateforme **📱🖥️**
...
Grammes/portions/unités ménagères
...
La fonctionnalité « Quantité en unités diverses » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Quantité en unités diverses » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Quantité en unités diverses » est optimisée pour :
...
Quand il accède à la fonctionnalité « Quantité en unités diverses »
