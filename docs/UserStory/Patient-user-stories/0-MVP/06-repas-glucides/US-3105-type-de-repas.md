...
La fonctionnalité « Type de repas » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Type de repas » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Type de repas » est optimisée pour :
...
Quand il accède à la fonctionnalité « Type de repas »
