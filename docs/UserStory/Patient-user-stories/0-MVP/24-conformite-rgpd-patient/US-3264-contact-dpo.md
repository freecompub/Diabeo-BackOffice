...
La fonctionnalité « Contact DPO » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Contact DPO » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Contact DPO » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Contact DPO) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Contact DPO »
...
Quand un événement Contact DPO se produit
