# US-3260 — Export données perso (Art. 15)

> 📌 **24. Conformité & RGPD patient** · Priorité **MVP** · Plateforme **📱🖥️**
...
La fonctionnalité « Export données perso (Art. 15) » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Export données perso (Art. 15) » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Export données perso (Art. 15) » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Export données perso (Art. 15)) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Export données perso (Art. 15) »
...
Quand un événement Export données perso (Art. 15) se produit
