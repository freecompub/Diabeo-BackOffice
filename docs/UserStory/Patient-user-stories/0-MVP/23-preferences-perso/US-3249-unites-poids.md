...
La fonctionnalité « Unités poids » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Unités poids » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Unités poids » est optimisée pour :
...
Quand il accède à la fonctionnalité « Unités poids »
