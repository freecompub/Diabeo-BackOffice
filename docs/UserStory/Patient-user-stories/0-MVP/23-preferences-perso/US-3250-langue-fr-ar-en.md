# US-3250 — Langue FR/AR/EN

> 📌 **23. Préférences & perso** · Priorité **MVP** · Plateforme **📱🖥️**

> 💬 **Note inventaire** : RTL critique pour DZ
...
|---|---|
| **ID** | `US-3250` |
| **Référence inventaire** | `FNP-250` |
| **Domaine** | 23. Préférences & perso |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (next-intl/iOS Localization) |
...
La fonctionnalité « Langue FR/AR/EN » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Langue FR/AR/EN » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Langue FR/AR/EN » est optimisée pour :
...
Quand il accède à la fonctionnalité « Langue FR/AR/EN »
