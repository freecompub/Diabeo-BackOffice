# US-3257 — Format date/heure

> 📌 **23. Préférences & perso** · Priorité **MVP** · Plateforme **📱🖥️**
...
|---|---|
| **ID** | `US-3257` |
| **Référence inventaire** | `FNP-257` |
| **Domaine** | 23. Préférences & perso |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (Intl) |
...
La fonctionnalité « Format date/heure » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Format date/heure » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Format date/heure » est optimisée pour :
...
Quand il accède à la fonctionnalité « Format date/heure »
