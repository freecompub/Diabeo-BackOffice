# US-3165 — Pairing CGM Bluetooth

> 📌 **12. Dispositifs & connectivité** · Priorité **MVP** · Plateforme **📱**
...
|---|---|
| **ID** | `US-3165` |
| **Référence inventaire** | `FNP-165` |
| **Domaine** | 12. Dispositifs & connectivité |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | Apple CoreBluetooth / Android BluetoothLE |
...
La fonctionnalité « Pairing CGM Bluetooth » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Pairing CGM Bluetooth » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Pairing CGM Bluetooth » est optimisée pour :
...
Quand il accède à la fonctionnalité « Pairing CGM Bluetooth »
...
```gherkin
Étant donné Le service « Apple CoreBluetooth / Android BluetoothLE » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Apple CoreBluetooth / Android BluetoothLE » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Apple CoreBluetooth / Android BluetoothLE** (à valider en kick-off)
