...
La fonctionnalité « Calcul bolus mixte » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Calcul bolus mixte » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Calcul bolus mixte » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Calcul bolus mixte) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Calcul bolus mixte »
...
Quand un événement Calcul bolus mixte se produit
...
Quand elle utilise « Calcul bolus mixte »
...
Quand « Calcul bolus mixte » s'exécute pendant la journée de jeûne
