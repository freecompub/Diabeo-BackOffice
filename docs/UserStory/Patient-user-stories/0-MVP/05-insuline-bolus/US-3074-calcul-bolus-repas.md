# US-3074 — Calcul bolus repas

> 📌 **5. Insuline & bolus** · Priorité **MVP** · Plateforme **📱**

> 💬 **Note inventaire** : Cœur métier
...
|---|---|
| **ID** | `US-3074` |
| **Référence inventaire** | `FNP-074` |
| **Domaine** | 5. Insuline & bolus |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (validé iOS) |
...
La fonctionnalité « Calcul bolus repas » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Calcul bolus repas » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Calcul bolus repas » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Calcul bolus repas) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Calcul bolus repas »
...
Quand un événement Calcul bolus repas se produit
...
Quand elle utilise « Calcul bolus repas »
...
Quand « Calcul bolus repas » s'exécute pendant la journée de jeûne
