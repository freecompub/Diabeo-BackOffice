# US-3073 — Visualisation schéma insuline
...
La fonctionnalité « Visualisation schéma insuline » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Visualisation schéma insuline » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Visualisation schéma insuline » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Visualisation schéma insuline) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Visualisation schéma insuline »
...
Quand un événement Visualisation schéma insuline se produit
...
Quand elle utilise « Visualisation schéma insuline »
