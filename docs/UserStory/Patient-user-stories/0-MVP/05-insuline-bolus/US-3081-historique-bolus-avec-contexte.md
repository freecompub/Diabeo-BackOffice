# US-3081 — Historique bolus avec contexte

> 📌 **5. Insuline & bolus** · Priorité **MVP** · Plateforme **📱🖥️**
...
|---|---|
| **ID** | `US-3081` |
| **Référence inventaire** | `FNP-081` |
| **Domaine** | 5. Insuline & bolus |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱🖥️ |
...
La fonctionnalité « Historique bolus avec contexte » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Historique bolus avec contexte » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Historique bolus avec contexte » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Historique bolus avec contexte) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Historique bolus avec contexte »
...
Quand un événement Historique bolus avec contexte se produit
...
Quand elle utilise « Historique bolus avec contexte »
...
Quand « Historique bolus avec contexte » s'exécute pendant la journée de jeûne
