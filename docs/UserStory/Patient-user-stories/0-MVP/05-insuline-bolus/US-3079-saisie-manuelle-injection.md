# US-3079 — Saisie manuelle injection
...
La fonctionnalité « Saisie manuelle injection » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Saisie manuelle injection » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Saisie manuelle injection » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Saisie manuelle injection) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Saisie manuelle injection »
...
Quand un événement Saisie manuelle injection se produit
...
Quand elle utilise « Saisie manuelle injection »
