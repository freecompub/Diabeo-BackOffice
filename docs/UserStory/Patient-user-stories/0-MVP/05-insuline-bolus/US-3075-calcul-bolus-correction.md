# US-3075 — Calcul bolus correction
...
La fonctionnalité « Calcul bolus correction » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Calcul bolus correction » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Calcul bolus correction » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Calcul bolus correction) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Calcul bolus correction »
...
Quand un événement Calcul bolus correction se produit
...
Quand elle utilise « Calcul bolus correction »
