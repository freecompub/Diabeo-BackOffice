# US-3290 — Procédure injection glucagon

> 📌 **28. Procédures d'urgence** · Priorité **MVP** · Plateforme **📱**

> 💬 **Note inventaire** : Vital T1
...
|---|---|
| **ID** | `US-3290` |
| **Référence inventaire** | `FNP-290` |
| **Domaine** | 28. Procédures d'urgence |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (vidéos) |
...
La fonctionnalité « Procédure injection glucagon » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Procédure injection glucagon » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Procédure injection glucagon » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Procédure injection glucagon) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Procédure injection glucagon »
...
```gherkin
Étant donné La fonctionnalité « Procédure injection glucagon » est déclenchée (auto ou manuel)
...
Quand un événement Procédure injection glucagon se produit
