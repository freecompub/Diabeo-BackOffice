# US-3305 — Détection cétones positives
...
La fonctionnalité « Détection cétones positives » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Détection cétones positives » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Détection cétones positives » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Détection cétones positives) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Détection cétones positives »
...
```gherkin
Étant donné La fonctionnalité « Détection cétones positives » est déclenchée (auto ou manuel)
...
Quand un événement Détection cétones positives se produit
