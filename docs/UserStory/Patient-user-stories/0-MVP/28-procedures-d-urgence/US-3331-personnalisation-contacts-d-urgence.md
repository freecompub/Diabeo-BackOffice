# US-3331 — Personnalisation contacts d'urgence

> 📌 **28. Procédures d'urgence** · Priorité **MVP** · Plateforme **📱🖥️**
...
- **Langage** : Swift 5.9+
- **Frameworks** : `SwiftUI`, `Combine`, `CoreLocation`
...
La fonctionnalité « Personnalisation contacts d'urgence » est exposée selon les conventions iOS :
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, `FusedLocationProviderClient`
...
### Comportement utilisateur
La fonctionnalité « Personnalisation contacts d'urgence » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Personnalisation contacts d'urgence » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Personnalisation contacts d'urgence) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Personnalisation contacts d'urgence »
...
```gherkin
Étant donné La fonctionnalité « Personnalisation contacts d'urgence » est déclenchée (auto ou manuel)
...
Quand un événement Personnalisation contacts d'urgence se produit
