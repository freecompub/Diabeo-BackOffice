# US-3299 — Vérification IOB avant nouveau bolus

> 📌 **28. Procédures d'urgence** · Priorité **MVP** · Plateforme **📱**

> 💬 **Note inventaire** : Sécurité
...
La fonctionnalité « Vérification IOB avant nouveau bolus » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Vérification IOB avant nouveau bolus » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Vérification IOB avant nouveau bolus » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Vérification IOB avant nouveau bolus) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Vérification IOB avant nouveau bolus »
...
```gherkin
Étant donné La fonctionnalité « Vérification IOB avant nouveau bolus » est déclenchée (auto ou manuel)
...
Quand un événement Vérification IOB avant nouveau bolus se produit
...
Quand elle utilise « Vérification IOB avant nouveau bolus »
