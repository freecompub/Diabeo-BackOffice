# US-3329 — Personnalisation seuils par patient
...
La fonctionnalité « Personnalisation seuils par patient » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Personnalisation seuils par patient » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Personnalisation seuils par patient » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Personnalisation seuils par patient) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Personnalisation seuils par patient »
...
```gherkin
Étant donné La fonctionnalité « Personnalisation seuils par patient » est déclenchée (auto ou manuel)
...
Quand un événement Personnalisation seuils par patient se produit
...
Quand elle utilise « Personnalisation seuils par patient »
...
Quand « Personnalisation seuils par patient » s'exécute pendant la journée de jeûne
