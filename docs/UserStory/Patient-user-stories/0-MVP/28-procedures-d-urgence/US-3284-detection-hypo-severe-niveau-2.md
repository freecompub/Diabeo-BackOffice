# US-3284 — Détection hypo sévère niveau 2
...
La fonctionnalité « Détection hypo sévère niveau 2 » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Détection hypo sévère niveau 2 » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Détection hypo sévère niveau 2 » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Détection hypo sévère niveau 2) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Détection hypo sévère niveau 2 »
...
```gherkin
Étant donné La fonctionnalité « Détection hypo sévère niveau 2 » est déclenchée (auto ou manuel)
...
Quand un événement Détection hypo sévère niveau 2 se produit
...
Quand elle utilise « Détection hypo sévère niveau 2 »
