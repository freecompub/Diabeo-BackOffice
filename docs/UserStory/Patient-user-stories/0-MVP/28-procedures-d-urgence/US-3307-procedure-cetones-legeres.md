# US-3307 — Procédure cétones légères
...
La fonctionnalité « Procédure cétones légères » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Procédure cétones légères » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Procédure cétones légères » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Procédure cétones légères) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Procédure cétones légères »
...
```gherkin
Étant donné La fonctionnalité « Procédure cétones légères » est déclenchée (auto ou manuel)
...
Quand un événement Procédure cétones légères se produit
...
Quand elle utilise « Procédure cétones légères »
