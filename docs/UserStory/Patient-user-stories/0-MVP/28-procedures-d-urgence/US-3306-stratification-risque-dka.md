# US-3306 — Stratification risque DKA
...
|---|---|
| **ID** | `US-3306` |
| **Référence inventaire** | `FNP-306` |
| **Domaine** | 28. Procédures d'urgence |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (algo clinique) |
...
La fonctionnalité « Stratification risque DKA » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Stratification risque DKA » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Stratification risque DKA » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Stratification risque DKA) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Stratification risque DKA »
...
```gherkin
Étant donné La fonctionnalité « Stratification risque DKA » est déclenchée (auto ou manuel)
...
Quand un événement Stratification risque DKA se produit
