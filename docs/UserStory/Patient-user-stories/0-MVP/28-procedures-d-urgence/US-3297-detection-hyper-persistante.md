# US-3297 — Détection hyper persistante
...
La fonctionnalité « Détection hyper persistante » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Détection hyper persistante » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Détection hyper persistante » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Détection hyper persistante) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Détection hyper persistante »
...
```gherkin
Étant donné La fonctionnalité « Détection hyper persistante » est déclenchée (auto ou manuel)
...
Quand un événement Détection hyper persistante se produit
...
Quand elle utilise « Détection hyper persistante »
