# US-3310 — Vérification dispositifs DKA
...
|---|---|
| **ID** | `US-3310` |
| **Référence inventaire** | `FNP-310` |
| **Domaine** | 28. Procédures d'urgence |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (checklist) |
...
- **Langage** : Swift 5.9+
- **Frameworks** : `SwiftUI`, `Combine`, `CoreBluetooth`
...
La fonctionnalité « Vérification dispositifs DKA » est exposée selon les conventions iOS :
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, `Nordic BLE Library (recommandé) ou Android BluetoothLE`
...
### Comportement utilisateur
La fonctionnalité « Vérification dispositifs DKA » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Vérification dispositifs DKA » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Vérification dispositifs DKA) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Vérification dispositifs DKA »
...
```gherkin
Étant donné La fonctionnalité « Vérification dispositifs DKA » est déclenchée (auto ou manuel)
...
Quand un événement Vérification dispositifs DKA se produit
...
Quand elle utilise « Vérification dispositifs DKA »
