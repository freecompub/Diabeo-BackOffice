# US-3296 — Détection seuil hyper personnalisé
...
La fonctionnalité « Détection seuil hyper personnalisé » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Détection seuil hyper personnalisé » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Détection seuil hyper personnalisé » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Détection seuil hyper personnalisé) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Détection seuil hyper personnalisé »
...
```gherkin
Étant donné La fonctionnalité « Détection seuil hyper personnalisé » est déclenchée (auto ou manuel)
...
Quand un événement Détection seuil hyper personnalisé se produit
...
Quand elle utilise « Détection seuil hyper personnalisé »
...
Quand « Détection seuil hyper personnalisé » s'exécute pendant la journée de jeûne
