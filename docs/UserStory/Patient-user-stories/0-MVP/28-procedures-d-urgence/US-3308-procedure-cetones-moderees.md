# US-3308 — Procédure cétones modérées
...
Bolus correctif renforcé + vigilance
...
La fonctionnalité « Procédure cétones modérées » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Procédure cétones modérées » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Procédure cétones modérées » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Procédure cétones modérées) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Procédure cétones modérées »
...
```gherkin
Étant donné La fonctionnalité « Procédure cétones modérées » est déclenchée (auto ou manuel)
...
Quand un événement Procédure cétones modérées se produit
...
Quand elle utilise « Procédure cétones modérées »
