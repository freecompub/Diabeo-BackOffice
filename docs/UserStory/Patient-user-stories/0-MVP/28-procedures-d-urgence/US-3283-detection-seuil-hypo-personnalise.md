# US-3283 — Détection seuil hypo personnalisé

> 📌 **28. Procédures d'urgence** · Priorité **MVP** · Plateforme **📱**

> 💬 **Note inventaire** : Critique
...
|---|---|
| **ID** | `US-3283` |
| **Référence inventaire** | `FNP-283` |
| **Domaine** | 28. Procédures d'urgence |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (engine) |
...
La fonctionnalité « Détection seuil hypo personnalisé » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Détection seuil hypo personnalisé » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Détection seuil hypo personnalisé » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Détection seuil hypo personnalisé) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Détection seuil hypo personnalisé »
...
```gherkin
Étant donné La fonctionnalité « Détection seuil hypo personnalisé » est déclenchée (auto ou manuel)
...
Quand un événement Détection seuil hypo personnalisé se produit
...
Quand elle utilise « Détection seuil hypo personnalisé »
...
Quand « Détection seuil hypo personnalisé » s'exécute pendant la journée de jeûne
