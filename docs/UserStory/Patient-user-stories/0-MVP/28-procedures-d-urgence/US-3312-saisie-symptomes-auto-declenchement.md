# US-3312 — Saisie symptômes auto-déclenchement
...
La fonctionnalité « Saisie symptômes auto-déclenchement » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Saisie symptômes auto-déclenchement » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Saisie symptômes auto-déclenchement » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Saisie symptômes auto-déclenchement) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Saisie symptômes auto-déclenchement »
...
```gherkin
Étant donné La fonctionnalité « Saisie symptômes auto-déclenchement » est déclenchée (auto ou manuel)
...
Quand un événement Saisie symptômes auto-déclenchement se produit
