# US-3302 — Programmation contrôle glycémie/cétones
...
La fonctionnalité « Programmation contrôle glycémie/cétones » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Programmation contrôle glycémie/cétones » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Programmation contrôle glycémie/cétones » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Programmation contrôle glycémie/cétones) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Programmation contrôle glycémie/cétones »
...
```gherkin
Étant donné La fonctionnalité « Programmation contrôle glycémie/cétones » est déclenchée (auto ou manuel)
