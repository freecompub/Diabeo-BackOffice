# US-3287 — Reco quantité glucides
...
La fonctionnalité « Reco quantité glucides » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Reco quantité glucides » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Reco quantité glucides » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Reco quantité glucides) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Reco quantité glucides »
...
```gherkin
Étant donné La fonctionnalité « Reco quantité glucides » est déclenchée (auto ou manuel)
...
Quand un événement Reco quantité glucides se produit
...
Quand elle utilise « Reco quantité glucides »
...
Quand « Reco quantité glucides » s'exécute pendant la journée de jeûne
