# US-3285 — Détection hypo nocturne renforcée
...
|---|---|
| **ID** | `US-3285` |
| **Référence inventaire** | `FNP-285` |
| **Domaine** | 28. Procédures d'urgence |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | FCM / APNs Critical Alerts |
...
La fonctionnalité « Détection hypo nocturne renforcée » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Détection hypo nocturne renforcée » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Détection hypo nocturne renforcée » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Détection hypo nocturne renforcée) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Détection hypo nocturne renforcée »
...
```gherkin
Étant donné Le service « FCM / APNs Critical Alerts » est indisponible
...
```gherkin
Étant donné La fonctionnalité « Détection hypo nocturne renforcée » est déclenchée (auto ou manuel)
...
Quand un événement Détection hypo nocturne renforcée se produit
...
Quand elle utilise « Détection hypo nocturne renforcée »
...
- **RM-6 : Aucun secret du fournisseur « FCM / APNs Critical Alerts » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **FCM / APNs Critical Alerts** (à valider en kick-off)
