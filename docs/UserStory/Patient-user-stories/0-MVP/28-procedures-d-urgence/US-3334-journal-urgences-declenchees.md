# US-3334 — Journal urgences déclenchées
...
|---|---|
| **ID** | `US-3334` |
| **Référence inventaire** | `FNP-334` |
| **Domaine** | 28. Procédures d'urgence |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (AuditLog dédié) |
...
La fonctionnalité « Journal urgences déclenchées » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Journal urgences déclenchées » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Journal urgences déclenchées » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Journal urgences déclenchées) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Journal urgences déclenchées »
...
```gherkin
Étant donné La fonctionnalité « Journal urgences déclenchées » est déclenchée (auto ou manuel)
...
Quand un événement Journal urgences déclenchées se produit
