# US-3197 — Tableau de bord journalier

> 📌 **15. Suivi & objectifs** · Priorité **MVP** · Plateforme **📱**
...
La fonctionnalité « Tableau de bord journalier » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Tableau de bord journalier » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Tableau de bord journalier » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Tableau de bord journalier) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Tableau de bord journalier »
...
Quand un événement Tableau de bord journalier se produit
