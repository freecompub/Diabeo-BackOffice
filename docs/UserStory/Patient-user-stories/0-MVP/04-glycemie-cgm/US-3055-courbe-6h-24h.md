# US-3055 — Courbe 6h/24h

> 📌 **4. Glycémie & CGM** · Priorité **MVP** · Plateforme **📱🖥️**
...
|---|---|
| **ID** | `US-3055` |
| **Référence inventaire** | `FNP-055` |
| **Domaine** | 4. Glycémie & CGM |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (graphes) |
...
La fonctionnalité « Courbe 6h/24h » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Courbe 6h/24h » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Courbe 6h/24h » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Courbe 6h/24h) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Courbe 6h/24h »
...
Quand un événement Courbe 6h/24h se produit
