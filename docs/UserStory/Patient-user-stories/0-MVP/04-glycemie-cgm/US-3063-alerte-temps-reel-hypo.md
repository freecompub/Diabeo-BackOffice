# US-3063 — Alerte temps réel hypo
...
|---|---|
| **ID** | `US-3063` |
| **Référence inventaire** | `FNP-063` |
| **Domaine** | 4. Glycémie & CGM |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | FCM / APNs + interne |
| **Modèle économique** | Gratuit (volumes std) |
| **Coût estimé** | — |
...
La fonctionnalité « Alerte temps réel hypo » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Alerte temps réel hypo » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Alerte temps réel hypo » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Alerte temps réel hypo) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Alerte temps réel hypo »
...
```gherkin
Étant donné Le service « FCM / APNs + interne » est indisponible
...
Quand un événement Alerte temps réel hypo se produit
...
Quand elle utilise « Alerte temps réel hypo »
...
Quand « Alerte temps réel hypo » s'exécute pendant la journée de jeûne
...
- **RM-6 : Aucun secret du fournisseur « FCM / APNs + interne » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **FCM / APNs + interne** (à valider en kick-off)
