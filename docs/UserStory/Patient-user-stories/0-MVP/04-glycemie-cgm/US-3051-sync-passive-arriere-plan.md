# US-3051 — Sync passive arrière-plan
...
|---|---|
| **ID** | `US-3051` |
| **Référence inventaire** | `FNP-051` |
| **Domaine** | 4. Glycémie & CGM |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (BGTask) |
...
La fonctionnalité « Sync passive arrière-plan » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Sync passive arrière-plan » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Sync passive arrière-plan » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Sync passive arrière-plan) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Sync passive arrière-plan »
...
Quand un événement Sync passive arrière-plan se produit
