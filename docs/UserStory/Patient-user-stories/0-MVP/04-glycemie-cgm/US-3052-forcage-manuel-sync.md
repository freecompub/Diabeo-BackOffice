...
La fonctionnalité « Forçage manuel sync » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Forçage manuel sync » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Forçage manuel sync » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Forçage manuel sync) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Forçage manuel sync »
...
Quand un événement Forçage manuel sync se produit
