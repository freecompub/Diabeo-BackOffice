# US-3065 — Alerte hypo nocturne

> 📌 **4. Glycémie & CGM** · Priorité **MVP** · Plateforme **📱**

> 💬 **Note inventaire** : Critique pour T1
...
La fonctionnalité « Alerte hypo nocturne » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Alerte hypo nocturne » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Alerte hypo nocturne » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Alerte hypo nocturne) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Alerte hypo nocturne »
...
Quand un événement Alerte hypo nocturne se produit
...
Quand elle utilise « Alerte hypo nocturne »
...
Quand « Alerte hypo nocturne » s'exécute pendant la journée de jeûne
