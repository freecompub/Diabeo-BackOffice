# US-3062 — Détection auto hypo/hyper
...
|---|---|
| **ID** | `US-3062` |
| **Référence inventaire** | `FNP-062` |
| **Domaine** | 4. Glycémie & CGM |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (jobs scheduled) |
...
La fonctionnalité « Détection auto hypo/hyper » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Détection auto hypo/hyper » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Détection auto hypo/hyper » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Détection auto hypo/hyper) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Détection auto hypo/hyper »
...
Quand un événement Détection auto hypo/hyper se produit
...
Quand elle utilise « Détection auto hypo/hyper »
...
Quand « Détection auto hypo/hyper » s'exécute pendant la journée de jeûne
