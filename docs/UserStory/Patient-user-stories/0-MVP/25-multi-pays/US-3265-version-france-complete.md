# US-3265 — Version France complète

> 📌 **25. Multi-pays** · Priorité **MVP** · Plateforme **📱🖥️**
...
|---|---|
| **ID** | `US-3265` |
| **Référence inventaire** | `FNP-265` |
| **Domaine** | 25. Multi-pays |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Oui |
| **Service / Standard** | Écosystème ANS |
| **Modèle économique** | Voir détails |
| **Coût estimé** | Voir détails |
| **Faisabilité France** | Direct |
| **Faisabilité Algérie** | N/A |
...
La fonctionnalité « Version France complète » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Version France complète » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Version France complète » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Version France complète) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Version France complète »
...
```gherkin
Étant donné Le service « Écosystème ANS » est indisponible
...
Quand un événement Version France complète se produit
...
- **RM-6 : Aucun secret du fournisseur « Écosystème ANS » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Écosystème ANS** (à valider en kick-off)
