# US-3214 — Cibles glycémiques adaptées
...
La fonctionnalité « Cibles glycémiques adaptées » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Cibles glycémiques adaptées » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Cibles glycémiques adaptées » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Cibles glycémiques adaptées) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Cibles glycémiques adaptées »
...
Quand un événement Cibles glycémiques adaptées se produit
...
Quand elle utilise « Cibles glycémiques adaptées »
