# US-3212 — Configuration mode grossesse

> 📌 **17. Mode grossesse** · Priorité **MVP** · Plateforme **📱🖥️**

> 💬 **Note inventaire** : Marché clé
...
|---|---|
| **ID** | `US-3212` |
| **Référence inventaire** | `FNP-212` |
| **Domaine** | 17. Mode grossesse |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱🖥️ |
...
La fonctionnalité « Configuration mode grossesse » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Configuration mode grossesse » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Configuration mode grossesse » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Configuration mode grossesse) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Configuration mode grossesse »
...
Quand un événement Configuration mode grossesse se produit
...
Quand elle utilise « Configuration mode grossesse »
