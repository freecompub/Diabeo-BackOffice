...
La fonctionnalité « Refus avec motif » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Refus avec motif » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Refus avec motif » est optimisée pour :
...
Quand il accède à la fonctionnalité « Refus avec motif »
