# US-3129 — Notif push nouvelle proposition

> 📌 **9. Propositions médecin** · Priorité **MVP** · Plateforme **📱**
...
|---|---|
| **ID** | `US-3129` |
| **Référence inventaire** | `FNP-129` |
| **Domaine** | 9. Propositions médecin |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱 |
...
La fonctionnalité « Notif push nouvelle proposition » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Notif push nouvelle proposition » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Notif push nouvelle proposition » est optimisée pour :
...
Quand il accède à la fonctionnalité « Notif push nouvelle proposition »
...
Quand elle utilise « Notif push nouvelle proposition »
