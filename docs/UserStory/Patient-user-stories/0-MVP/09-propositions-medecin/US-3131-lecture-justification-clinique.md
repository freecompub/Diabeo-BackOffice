# US-3131 — Lecture justification clinique

> 📌 **9. Propositions médecin** · Priorité **MVP** · Plateforme **📱🖥️**
...
La fonctionnalité « Lecture justification clinique » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Lecture justification clinique » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Lecture justification clinique » est optimisée pour :
...
Quand il accède à la fonctionnalité « Lecture justification clinique »
