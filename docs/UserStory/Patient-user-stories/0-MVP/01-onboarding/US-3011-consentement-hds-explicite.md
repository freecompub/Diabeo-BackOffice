# US-3011 — Consentement HDS explicite

> 📌 **1. Onboarding** · Priorité **MVP** · Plateforme **📱🖥️**

> 💬 **Note inventaire** : Pas de cadre HDS en DZ — adapter
...
La fonctionnalité « Consentement HDS explicite » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Consentement HDS explicite » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Consentement HDS explicite » est optimisée pour :
...
Quand il accède à la fonctionnalité « Consentement HDS explicite »
