# US-3006 — Sélection type de diabète
...
La fonctionnalité « Sélection type de diabète » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Sélection type de diabète » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Sélection type de diabète » est optimisée pour :
...
Quand il accède à la fonctionnalité « Sélection type de diabète »
...
### AC-3 — Mode grossesse : cibles strictes appliquées

```gherkin
Étant donné Une patiente est en mode grossesse activé
Quand elle utilise « Sélection type de diabète »
