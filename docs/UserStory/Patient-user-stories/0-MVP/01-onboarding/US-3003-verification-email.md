# US-3003 — Vérification email

> 📌 **1. Onboarding** · Priorité **MVP** · Plateforme **📱🖥️**
...
|---|---|
| **ID** | `US-3003` |
| **Référence inventaire** | `FNP-003` |
| **Domaine** | 1. Onboarding |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Oui |
| **Service / Standard** | OVH MX / Mailjet / SendGrid |
...
La fonctionnalité « Vérification email » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Vérification email » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Vérification email » est optimisée pour :
...
Quand il accède à la fonctionnalité « Vérification email »
...
```gherkin
Étant donné Le service « OVH MX / Mailjet / SendGrid » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « OVH MX / Mailjet / SendGrid » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **OVH MX / Mailjet / SendGrid** (à valider en kick-off)
