# US-3001 — Auto-inscription email + mdp
...
La fonctionnalité « Auto-inscription email + mdp » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Auto-inscription email + mdp » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Auto-inscription email + mdp » est optimisée pour :
...
Quand il accède à la fonctionnalité « Auto-inscription email + mdp »
