# US-3002 — Inscription par invitation médecin

> 📌 **1. Onboarding** · Priorité **MVP** · Plateforme **📱🖥️**

> 💬 **Note inventaire** : Workflow privilégié pour Diabeo
...
|---|---|
| **ID** | `US-3002` |
| **Référence inventaire** | `FNP-002` |
| **Domaine** | 1. Onboarding |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (deeplink + token) |
...
La fonctionnalité « Inscription par invitation médecin » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Inscription par invitation médecin » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Inscription par invitation médecin » est optimisée pour :
...
Quand il accède à la fonctionnalité « Inscription par invitation médecin »
