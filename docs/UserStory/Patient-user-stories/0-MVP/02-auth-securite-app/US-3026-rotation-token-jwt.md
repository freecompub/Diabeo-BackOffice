...
La fonctionnalité « Rotation token JWT » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Rotation token JWT » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Rotation token JWT » est optimisée pour :
...
Quand il accède à la fonctionnalité « Rotation token JWT »
