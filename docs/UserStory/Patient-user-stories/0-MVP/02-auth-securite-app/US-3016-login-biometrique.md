# US-3016 — Login biométrique

> 📌 **2. Auth & sécurité app** · Priorité **MVP** · Plateforme **📱**

> 💬 **Note inventaire** : Côté OS, pas de coût
...
|---|---|
| **ID** | `US-3016` |
| **Référence inventaire** | `FNP-016` |
| **Domaine** | 2. Auth & sécurité app |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | Apple LocalAuthentication / Android BiometricPrompt |
...
Face ID, Touch ID, empreinte Android
...
- **Langage** : Swift 5.9+
- **Frameworks** : `SwiftUI`, `Combine`, `LocalAuthentication`
...
- `NSFaceIDUsageDescription` — sécuriser les actions sensibles

### Comportement utilisateur
La fonctionnalité « Login biométrique » est exposée selon les conventions iOS :
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, ``androidx.biometric:biometric` + `BiometricPrompt``
...
### Comportement utilisateur
La fonctionnalité « Login biométrique » suit les Material Design 3 guidelines :
...
### APIs web utilisées
- **WebAuthn** : Touch ID (Mac), Windows Hello, clés FIDO2, passkeys
...
### Comportement utilisateur
La version web de « Login biométrique » est optimisée pour :
...
Quand il accède à la fonctionnalité « Login biométrique »
...
```gherkin
Étant donné Le service « Apple LocalAuthentication / Android BiometricPrompt » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Apple LocalAuthentication / Android BiometricPrompt » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Apple LocalAuthentication / Android BiometricPrompt** (à valider en kick-off)
