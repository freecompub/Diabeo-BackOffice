...
La fonctionnalité « Login email + mdp » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Login email + mdp » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Login email + mdp » est optimisée pour :
...
Quand il accède à la fonctionnalité « Login email + mdp »
