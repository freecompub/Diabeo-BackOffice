# US-3020 — Récupération mdp email

> 📌 **2. Auth & sécurité app** · Priorité **MVP** · Plateforme **📱🖥️**
...
La fonctionnalité « Récupération mdp email » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Récupération mdp email » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Récupération mdp email » est optimisée pour :
...
Quand il accède à la fonctionnalité « Récupération mdp email »
