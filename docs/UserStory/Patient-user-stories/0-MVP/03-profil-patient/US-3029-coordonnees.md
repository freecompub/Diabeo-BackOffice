...
La fonctionnalité « Coordonnées » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Coordonnées » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Coordonnées » est optimisée pour :
...
Quand il accède à la fonctionnalité « Coordonnées »
