# US-3027 — Données démographiques
...
|---|---|
| **ID** | `US-3027` |
| **Référence inventaire** | `FNP-027` |
| **Domaine** | 3. Profil patient |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (chiffré AES) |
...
La fonctionnalité « Données démographiques » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Données démographiques » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Données démographiques » est optimisée pour :
...
Quand il accède à la fonctionnalité « Données démographiques »
