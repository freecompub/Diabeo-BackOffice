# US-3342 — Procédures urgence offline

> 📌 **29. Hors-ligne & sync** · Priorité **MVP** · Plateforme **📱**

> 💬 **Note inventaire** : Vital
...
|---|---|
| **ID** | `US-3342` |
| **Référence inventaire** | `FNP-342` |
| **Domaine** | 29. Hors-ligne & sync |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (assets embarqués) |
...
- **Langage** : Swift 5.9+
- **Frameworks** : `SwiftUI`, `Combine`, `CoreLocation`, `CoreData (cache local chiffré)`
...
La fonctionnalité « Procédures urgence offline » est exposée selon les conventions iOS :
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, `FusedLocationProviderClient`, `Room (cache chiffré via SQLCipher) + WorkManager pour sync différée`
...
### Comportement utilisateur
La fonctionnalité « Procédures urgence offline » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Procédures urgence offline » est optimisée pour :
...
Quand il accède à la fonctionnalité « Procédures urgence offline »
...
### AC-3 — Fonctionnement hors-ligne complet

```gherkin
Étant donné Le patient n'a pas de réseau (avion, métro, zone blanche)
Quand il utilise « Procédures urgence offline »
Alors l'expérience est complète sur les fonctions vitales, et la sync se fait à reconnexion
```
