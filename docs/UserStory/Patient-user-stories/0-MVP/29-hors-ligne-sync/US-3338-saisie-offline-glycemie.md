# US-3338 — Saisie offline glycémie
...
|---|---|
| **ID** | `US-3338` |
| **Référence inventaire** | `FNP-338` |
| **Domaine** | 29. Hors-ligne & sync |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (CoreData / Room + sync queue) |
...
La fonctionnalité « Saisie offline glycémie » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Saisie offline glycémie » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Saisie offline glycémie » est optimisée pour :
...
Quand il accède à la fonctionnalité « Saisie offline glycémie »
...
Quand il utilise « Saisie offline glycémie »
...
Quand elle utilise « Saisie offline glycémie »
