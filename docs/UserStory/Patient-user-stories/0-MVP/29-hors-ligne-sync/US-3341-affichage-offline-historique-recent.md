# US-3341 — Affichage offline historique récent
...
La fonctionnalité « Affichage offline historique récent » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Affichage offline historique récent » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Affichage offline historique récent » est optimisée pour :
...
Quand il accède à la fonctionnalité « Affichage offline historique récent »
...
Quand il utilise « Affichage offline historique récent »
