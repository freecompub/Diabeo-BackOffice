...
La fonctionnalité « Saisie offline repas » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Saisie offline repas » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Saisie offline repas » est optimisée pour :
...
Quand il accède à la fonctionnalité « Saisie offline repas »
...
Quand il utilise « Saisie offline repas »
...
Quand elle utilise « Saisie offline repas »
