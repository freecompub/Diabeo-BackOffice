# US-3343 — File de synchronisation
...
|---|---|
| **ID** | `US-3343` |
| **Référence inventaire** | `FNP-343` |
| **Domaine** | 29. Hors-ligne & sync |
| **Priorité** | **MVP** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Non |
| **Service / Standard** | Interne (BGTask iOS / WorkManager) |
...
- **Langage** : Swift 5.9+
- **Frameworks** : `SwiftUI`, `Combine`, `UserNotifications`, `CoreData (cache local chiffré)`
...
La fonctionnalité « File de synchronisation » est exposée selon les conventions iOS :
...
- **Langage** : Kotlin 1.9+
- **Dépendances** : `Jetpack Compose`, `Coroutines + Flow`, `Firebase Cloud Messaging (FCM)`, `Room (cache chiffré via SQLCipher) + WorkManager pour sync différée`
...
### Comportement utilisateur
La fonctionnalité « File de synchronisation » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « File de synchronisation » est optimisée pour :
...
Quand il accède à la fonctionnalité « File de synchronisation »
...
Quand il utilise « File de synchronisation »
