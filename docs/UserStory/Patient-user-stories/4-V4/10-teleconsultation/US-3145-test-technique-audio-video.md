# US-3145 — Test technique audio/vidéo
...
|---|---|
| **ID** | `US-3145` |
| **Référence inventaire** | `FNP-145` |
| **Domaine** | 10. Téléconsultation |
| **Priorité** | **V4** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Oui |
| **Service / Standard** | SDK visio fournisseur |
| **Modèle économique** | Inclus |
| **Coût estimé** | — |
...
La fonctionnalité « Test technique audio/vidéo » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Test technique audio/vidéo » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Test technique audio/vidéo » est optimisée pour :
...
Quand il accède à la fonctionnalité « Test technique audio/vidéo »
...
```gherkin
Étant donné Le service « SDK visio fournisseur » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « SDK visio fournisseur » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **SDK visio fournisseur** (à valider en kick-off)
