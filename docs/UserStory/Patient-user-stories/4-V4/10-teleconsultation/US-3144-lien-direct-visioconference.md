# US-3144 — Lien direct visioconférence

> 📌 **10. Téléconsultation** · Priorité **V4** · Plateforme **📱🖥️**

> 💬 **Note inventaire** : Reporté V4 selon arbitrage
...
|---|---|
| **ID** | `US-3144` |
| **Référence inventaire** | `FNP-144` |
| **Domaine** | 10. Téléconsultation |
| **Priorité** | **V4** |
| **Plateforme cible** | 📱🖥️ |
...
La fonctionnalité « Lien direct visioconférence » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Lien direct visioconférence » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Lien direct visioconférence » est optimisée pour :
...
Quand il accède à la fonctionnalité « Lien direct visioconférence »
...
```gherkin
Étant donné Le service « Daily.co / Twilio Video / Whereby / Jitsi » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Daily.co / Twilio Video / Whereby / Jitsi » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Daily.co / Twilio Video / Whereby / Jitsi** (à valider en kick-off)
