# US-3190 — Suivi délivrance ordonnances

> 📌 **14. Pharmacie & approvisionnement** · Priorité **V4** · Plateforme **📱🖥️**
...
|---|---|
| **ID** | `US-3190` |
| **Référence inventaire** | `FNP-190` |
| **Domaine** | 14. Pharmacie & approvisionnement |
| **Priorité** | **V4** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Oui |
| **Service / Standard** | Service e-Prescription retour ANS |
| **Modèle économique** | Gratuit + agrément |
| **Coût estimé** | — |
...
La fonctionnalité « Suivi délivrance ordonnances » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Suivi délivrance ordonnances » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Suivi délivrance ordonnances » est optimisée pour :
...
- **Notifications doublées** : toute alerte critique (Suivi délivrance ordonnances) est envoyée simultanément au parent administrateur ET au parent secondaire
...
Quand il accède à la fonctionnalité « Suivi délivrance ordonnances »
...
```gherkin
Étant donné Le service « Service e-Prescription retour ANS » est indisponible
...
Quand un événement Suivi délivrance ordonnances se produit
...
- **RM-6 : Aucun secret du fournisseur « Service e-Prescription retour ANS » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Service e-Prescription retour ANS** (à valider en kick-off)
