# US-3180 — QR / 2D-Doc pour pharmacie

> 📌 **13. Documents & ordonnances** · Priorité **V4** · Plateforme **📱**

> 💬 **Note inventaire** : DZ: norme à définir localement
...
|---|---|
| **ID** | `US-3180` |
| **Référence inventaire** | `FNP-180` |
| **Domaine** | 13. Documents & ordonnances |
| **Priorité** | **V4** |
| **Plateforme cible** | 📱 |
| **Intégration externe** | Oui |
| **Service / Standard** | Norme ANTS 2D-Doc |
...
La fonctionnalité « QR / 2D-Doc pour pharmacie » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « QR / 2D-Doc pour pharmacie » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « QR / 2D-Doc pour pharmacie » est optimisée pour :
...
Quand il accède à la fonctionnalité « QR / 2D-Doc pour pharmacie »
...
```gherkin
Étant donné Le service « Norme ANTS 2D-Doc » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Norme ANTS 2D-Doc » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Norme ANTS 2D-Doc** (à valider en kick-off)
