# US-3183 — Envoi à pharmacie référente

> 📌 **13. Documents & ordonnances** · Priorité **V4** · Plateforme **📱🖥️**

> 💬 **Note inventaire** : DZ: équivalent inexistant
...
La fonctionnalité « Envoi à pharmacie référente » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Envoi à pharmacie référente » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Envoi à pharmacie référente » est optimisée pour :
...
Quand il accède à la fonctionnalité « Envoi à pharmacie référente »
...
```gherkin
Étant donné Le service « Mailiz / Apicrypt » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Mailiz / Apicrypt » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Mailiz / Apicrypt** (à valider en kick-off)
