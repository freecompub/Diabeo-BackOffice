# US-3177 — Réception ordonnance numérique

> 📌 **13. Documents & ordonnances** · Priorité **V4** · Plateforme **📱🖥️**

> 💬 **Note inventaire** : DZ: pas de e-prescription nationale
...
|---|---|
| **ID** | `US-3177` |
| **Référence inventaire** | `FNP-177` |
| **Domaine** | 13. Documents & ordonnances |
| **Priorité** | **V4** |
| **Plateforme cible** | 📱🖥️ |
| **Intégration externe** | Oui |
| **Service / Standard** | Service e-Prescription ANS |
...
La fonctionnalité « Réception ordonnance numérique » est exposée selon les conventions iOS :
...
### Comportement utilisateur
La fonctionnalité « Réception ordonnance numérique » suit les Material Design 3 guidelines :
...
### Comportement utilisateur
La version web de « Réception ordonnance numérique » est optimisée pour :
...
Quand il accède à la fonctionnalité « Réception ordonnance numérique »
...
```gherkin
Étant donné Le service « Service e-Prescription ANS » est indisponible
...
- **RM-6 : Aucun secret du fournisseur « Service e-Prescription ANS » n'est embarqué dans les binaires mobiles ni exposé côté client web. Tous les appels passent par le backend Diabeo.**
...
- Documentation officielle **Service e-Prescription ANS** (à valider en kick-off)
