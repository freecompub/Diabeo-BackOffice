# SCR-262 — Table de données (avec tri/pagination)
...
| **Nom** | Table de données (avec tri/pagination) |
| **Type** | COMPONENT |
| **Priorité** | **MVP** |
| **Story points** | 8 |
...
Listes patients, factures, audit, etc.
...
Tri colonnes, pagination, filtres, sélection multi, bulk actions, export
...
```
DataTable, TableHeader, Pagination
```
