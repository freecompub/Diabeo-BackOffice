# SCR-277 — Audit log entry display
...
Audit log global, Tab audit fiche patient
...
Action, resource, user, timestamp, expand pour détails, badge intégrité
