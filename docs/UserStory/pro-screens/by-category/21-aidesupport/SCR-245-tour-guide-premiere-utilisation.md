# SCR-245 — Tour guidé première utilisation
...
| **Nom** | Tour guidé première utilisation |
| **Type** | MODAL |
| **Priorité** | **V1** |
| **Story points** | 5 |
| **Route Next.js** | `(overlay)` |

---

## 🎭 Personas concernés

DOCTOR, NURSE (1ère connexion)
...
Onboarding interactif overlay, conseils contextuels
