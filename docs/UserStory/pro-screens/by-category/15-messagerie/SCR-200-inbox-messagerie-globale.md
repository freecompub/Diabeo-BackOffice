# SCR-200 — Inbox messagerie globale
...
| **Nom** | Inbox messagerie globale |
| **Type** | PAGE |
| **Priorité** | **V1** |
| **Story points** | 5 |
| **Route Next.js** | `/messages` |
...
Threads tous patients, filtres (urgents, non lus), recherche
...
```
MessagesInbox, ThreadList, FilterBar
```
