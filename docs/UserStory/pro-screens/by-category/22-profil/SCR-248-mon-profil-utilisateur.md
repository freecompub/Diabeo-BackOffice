# SCR-248 — Mon profil utilisateur
...
| **ID** | `SCR-248` |
| **Catégorie** | 22-Profil |
| **Nom** | Mon profil utilisateur |
| **Type** | PAGE |
| **Priorité** | **MVP** |
| **Story points** | 3 |
| **Route Next.js** | `/account/profile` |
...
Identité, contact, signature email, photo, RPPS (DOCTOR)
...
```
UserProfileForm, SignatureEditor
```
