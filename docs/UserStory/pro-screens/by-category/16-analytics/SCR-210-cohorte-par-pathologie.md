# SCR-210 — Cohorte par pathologie
...
| **Nom** | Cohorte par pathologie |
| **Type** | PAGE |
| **Priorité** | **V1** |
| **Story points** | 5 |
| **Route Next.js** | `/analytics/cohort` |
...
Vue groupée T1/T2/gestationnel, comparaison performance
...
```
CohortBreakdown, GroupComparison
```
