# SCR-117 — Card 'Urgences en cours'
...
Liste max 5 urgences, criticité visuelle, action rapide 'voir détail'
...
```
EmergencyCard, UrgencyBadge, QuickAction
```
