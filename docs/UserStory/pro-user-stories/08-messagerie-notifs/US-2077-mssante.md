...
> 📌 **8. Messagerie & notifs** · Priorité **V1** · Pays **FR**
> 
> 💬 **Note inventaire** : Mailiz = gratuit ANS
...
|---|---|
| **ID** | `US-2077` |
| **Référence inventaire** | `FN-077` |
| **Domaine** | 8. Messagerie & notifs |
| **Priorité** | **V1** |
| **Pays cible** | FR |
| **Intégration externe** | Oui |
| **Service / Standard** | Mailiz (ANS) / Apicrypt / opérateur agréé |
| **Modèle économique** | Selon opérateur |
| **Coût estimé** | 0–10€/mois/PS |
| **Statut** | 🆕 À démarrer |
...
Messagerie inter-PS officielle
...
### 🌐 Intégration externe — Mailiz (ANS) / Apicrypt / opérateur agréé
...
```gherkin
Étant donné Le service externe « Mailiz (ANS) / Apicrypt / opérateur agréé » est indisponible
...
- **RM-7 : Aucun secret du fournisseur « Mailiz (ANS) / Apicrypt / opérateur agréé » n'est exposé côté client. Tous les appels passent par le backend.**
...
- [ ] Un appel à « Mailiz (ANS) / Apicrypt / opérateur agréé » avec mock retourne le résultat attendu
...
- Documentation officielle de **Mailiz (ANS) / Apicrypt / opérateur agréé** (à vérifier au démarrage)
