...
| A3b | `/insulin-therapy` | ⚠️ **Suivi [#498](https://github.com/freecompub/Diabeo-BackOffice/issues/498)** — la validation **UI** des slots ISF rejette `< 0.20` g/L/U alors que le code autorise `0.10` (divergence comportementale UI vs bornes). Arbitrage `medical-domain-validator`. |
