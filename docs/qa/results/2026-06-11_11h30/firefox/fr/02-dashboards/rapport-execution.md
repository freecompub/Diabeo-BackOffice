# Rapport d'exécution QA — 02-dashboards.md — NON EXÉCUTÉ

**Date** : 2026-06-11 11h30 · **Navigateur** : firefox · **Langue** : fr · **Référence** : `02-dashboards.md`
...
- Rejouer manuellement les scénarios de `02-dashboards.md` dans le navigateur cible, **ou**
