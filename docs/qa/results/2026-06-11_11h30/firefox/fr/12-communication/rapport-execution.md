# Rapport d'exécution QA — 12-communication.md — NON EXÉCUTÉ

**Date** : 2026-06-11 11h30 · **Navigateur** : firefox · **Langue** : fr · **Référence** : `12-communication.md`
...
- Rejouer manuellement les scénarios de `12-communication.md` dans le navigateur cible, **ou**
