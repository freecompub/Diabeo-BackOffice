# Rapport d'exécution QA — 01-auth.md — NON EXÉCUTÉ

**Date** : 2026-06-11 11h30 · **Navigateur** : firefox · **Langue** : fr · **Référence** : `01-auth.md`
...
- Rejouer manuellement les scénarios de `01-auth.md` dans le navigateur cible, **ou**
