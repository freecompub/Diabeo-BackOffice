# Rapport d'exécution QA — 08-admin-ops.md — NON EXÉCUTÉ

**Date** : 2026-06-11 11h30 · **Navigateur** : firefox · **Langue** : fr · **Référence** : `08-admin-ops.md`
...
- Rejouer manuellement les scénarios de `08-admin-ops.md` dans le navigateur cible, **ou**
