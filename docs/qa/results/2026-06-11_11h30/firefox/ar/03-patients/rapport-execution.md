# Rapport d'exécution QA — 03-patients.md — NON EXÉCUTÉ

**Date** : 2026-06-11 11h30 · **Navigateur** : firefox · **Langue** : ar · **Référence** : `03-patients.md`
...
- Rejouer manuellement les scénarios de `03-patients.md` dans le navigateur cible, **ou**
