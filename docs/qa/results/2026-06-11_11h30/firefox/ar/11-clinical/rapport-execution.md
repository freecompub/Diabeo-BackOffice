# Rapport d'exécution QA — 11-clinical.md — NON EXÉCUTÉ

**Date** : 2026-06-11 11h30 · **Navigateur** : firefox · **Langue** : ar · **Référence** : `11-clinical.md`
...
- Rejouer manuellement les scénarios de `11-clinical.md` dans le navigateur cible, **ou**
