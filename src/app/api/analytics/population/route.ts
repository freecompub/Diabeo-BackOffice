 ...
 *
 * Returns aggregated KPIs across every patient the caller is allowed to read:
 * total/active/inTarget/criticalHypo counts and average TIR/GMI over a window.
 *
 * Scope: NURSE+ (DOCTOR/ADMIN canonical consumers; NURSE granted because the
 * dashboard sidekick views also surface these numbers).
 */
