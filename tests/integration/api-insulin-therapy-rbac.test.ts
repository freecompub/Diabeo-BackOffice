 ...
 *   sont rejetés 403 ; ils passent par une proposition GROUPÉE validée (NURSE → POST /api/slot-set-proposals ;
 *   voie par-valeur POST /api/adjustment-proposals retirée en US-2663 S5) ou, pour le patient CONFIRME,
 *   la soumission groupée self-service (PUT /api/patient/insulin-slot-set).
