...
*Dernière mise à jour : 2026-05-14 — Groupe 8 RDV Batch 1 livré (PR #392 : US-2500/2501/2503/2504/2505, 36 SP). Groupe 8 i18n & Interopérabilité Batch 1 livré (PR #393 : US-2113/2114/2116/2123, 6 SP) — CountryCurrency + CountryTaxRule + HealthcareRegulation référentiels ADMIN ; FHIR R4 scaffold avec FhirAllowedSystem allowlist DPA + kill-switch + SSRF guard + retry queue MAX_RETRIES=5 backoff exponentiel + AES-256-GCM payload + Zod schema validation. 1504/1504 tests verts. RDV Batch 2 (US-2502/2506 SMS rappels, 13 SP) + i18n Batch 2 (US-2124 DMP, US-2125 MSSanté, US-2126 INSi, US-2127 PSC, 27 SP) bloqués procurement habilitations ANS. Total 268 US.*
