...
*Dernière révision : 2026-07-13 — ADR #31 (US-2663 : proposition groupée intégrale — S4 voie manuelle groupée patient/pro + garde clinique + retrait `InsulinProposalDialog` ; contrat iOS retiré du périmètre). Historique des PRs : `git log`.*